...
namespace eidss.model.Model.FlexibleForms.Helpers
{
    public static class HelperFunctions
    {
        ...
        /// <returns></returns>
        public static string GetParameterKey(long idfObservation, long idfsParameter, long idfRow)
        {
            return String.Format("{0}_p{1}_r{2}", GetParameterKeyObservationPart(idfObservation), idfsParameter, idfRow);
        }
