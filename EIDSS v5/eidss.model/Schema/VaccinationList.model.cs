...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VaccinationListItem : 
        ...
        #if MONO
        protected Int64? idfsVaccinationType_Original { get { return idfsVaccinationType; } }
        protected Int64? idfsVaccinationType_Previous { get { return idfsVaccinationType; } }
        #else
        ...
        #if MONO
        protected Int64? idfsVaccinationRoute_Original { get { return idfsVaccinationRoute; } }
        protected Int64? idfsVaccinationRoute_Previous { get { return idfsVaccinationRoute; } }
        #else
        ...
        #if MONO
        protected DateTime? datVaccinationDate_Original { get { return datVaccinationDate; } }
        protected DateTime? datVaccinationDate_Previous { get { return datVaccinationDate; } }
        #else
        ...
        #if MONO
        protected String strManufacturer_Original { get { return strManufacturer; } }
        protected String strManufacturer_Previous { get { return strManufacturer; } }
        #else
        ...
        #if MONO
        protected String strLotNumber_Original { get { return strLotNumber; } }
        protected String strLotNumber_Previous { get { return strLotNumber; } }
        #else
        ...
        #if MONO
        protected Int32? intNumberVaccinated_Original { get { return intNumberVaccinated; } }
        protected Int32? intNumberVaccinated_Previous { get { return intNumberVaccinated; } }
        #else
        ...
        protected class field_info
        {
            ...
            internal Action<VaccinationListItem, VaccinationListItem, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfVaccination, _type = "Int64",
              _get_func = o => o.idfVaccination,
              _set_func = (o, val) => { o.idfVaccination = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
                if (o.idfVaccination != c.idfVaccination || o.IsRIRPropChanged(_str_idfVaccination, c)) 
                  m.Add(_str_idfVaccination, o.ObjectIdent + _str_idfVaccination, "Int64", o.idfVaccination == null ? "" : o.idfVaccination.ToString(), o.IsReadOnly(_str_idfVaccination), o.IsInvisible(_str_idfVaccination), o.IsRequired(_str_idfVaccination)); }
              }, 
            ...
            new field_info {
              _name = _str_idfsVaccinationType, _type = "Int64?",
              _get_func = o => o.idfsVaccinationType,
              _set_func = (o, val) => { o.idfsVaccinationType = ParsingHelper.ParseInt64Nullable(val); },
              _compare_func = (o, c, m) => {
                if (o.idfsVaccinationType != c.idfsVaccinationType || o.IsRIRPropChanged(_str_idfsVaccinationType, c)) 
                  m.Add(_str_idfsVaccinationType, o.ObjectIdent + _str_idfsVaccinationType, "Int64?", o.idfsVaccinationType == null ? "" : o.idfsVaccinationType.ToString(), o.IsReadOnly(_str_idfsVaccinationType), o.IsInvisible(_str_idfsVaccinationType), o.IsRequired(_str_idfsVaccinationType)); }
              }, 
        
            new field_info {
              _name = _str_idfsVaccinationRoute, _type = "Int64?",
              _get_func = o => o.idfsVaccinationRoute,
              _set_func = (o, val) => { o.idfsVaccinationRoute = ParsingHelper.ParseInt64Nullable(val); },
              _compare_func = (o, c, m) => {
                if (o.idfsVaccinationRoute != c.idfsVaccinationRoute || o.IsRIRPropChanged(_str_idfsVaccinationRoute, c)) 
                  m.Add(_str_idfsVaccinationRoute, o.ObjectIdent + _str_idfsVaccinationRoute, "Int64?", o.idfsVaccinationRoute == null ? "" : o.idfsVaccinationRoute.ToString(), o.IsReadOnly(_str_idfsVaccinationRoute), o.IsInvisible(_str_idfsVaccinationRoute), o.IsRequired(_str_idfsVaccinationRoute)); }
              }, 
            ...
            new field_info {
              _name = _str_datVaccinationDate, _type = "DateTime?",
              _get_func = o => o.datVaccinationDate,
              _set_func = (o, val) => { o.datVaccinationDate = ParsingHelper.ParseDateTimeNullable(val); },
              _compare_func = (o, c, m) => {
                if (o.datVaccinationDate != c.datVaccinationDate || o.IsRIRPropChanged(_str_datVaccinationDate, c)) 
                  m.Add(_str_datVaccinationDate, o.ObjectIdent + _str_datVaccinationDate, "DateTime?", o.datVaccinationDate == null ? "" : o.datVaccinationDate.ToString(), o.IsReadOnly(_str_datVaccinationDate), o.IsInvisible(_str_datVaccinationDate), o.IsRequired(_str_datVaccinationDate)); }
              }, 
        
            new field_info {
              _name = _str_strManufacturer, _type = "String",
              _get_func = o => o.strManufacturer,
              _set_func = (o, val) => { o.strManufacturer = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.strManufacturer != c.strManufacturer || o.IsRIRPropChanged(_str_strManufacturer, c)) 
                  m.Add(_str_strManufacturer, o.ObjectIdent + _str_strManufacturer, "String", o.strManufacturer == null ? "" : o.strManufacturer.ToString(), o.IsReadOnly(_str_strManufacturer), o.IsInvisible(_str_strManufacturer), o.IsRequired(_str_strManufacturer)); }
              }, 
        
            new field_info {
              _name = _str_strLotNumber, _type = "String",
              _get_func = o => o.strLotNumber,
              _set_func = (o, val) => { o.strLotNumber = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.strLotNumber != c.strLotNumber || o.IsRIRPropChanged(_str_strLotNumber, c)) 
                  m.Add(_str_strLotNumber, o.ObjectIdent + _str_strLotNumber, "String", o.strLotNumber == null ? "" : o.strLotNumber.ToString(), o.IsReadOnly(_str_strLotNumber), o.IsInvisible(_str_strLotNumber), o.IsRequired(_str_strLotNumber)); }
              }, 
        
            new field_info {
              _name = _str_intNumberVaccinated, _type = "Int32?",
              _get_func = o => o.intNumberVaccinated,
              _set_func = (o, val) => { o.intNumberVaccinated = ParsingHelper.ParseInt32Nullable(val); },
              _compare_func = (o, c, m) => {
                if (o.intNumberVaccinated != c.intNumberVaccinated || o.IsRIRPropChanged(_str_intNumberVaccinated, c)) 
                  m.Add(_str_intNumberVaccinated, o.ObjectIdent + _str_intNumberVaccinated, "Int32?", o.intNumberVaccinated == null ? "" : o.intNumberVaccinated.ToString(), o.IsReadOnly(_str_intNumberVaccinated), o.IsInvisible(_str_intNumberVaccinated), o.IsRequired(_str_intNumberVaccinated)); }
              }, 
            ...
            new field_info {
              _name = _str__HACode, _type = "int?",
              _get_func = o => o._HACode,
              _set_func = (o, val) => { o._HACode = ParsingHelper.ParseInt32Nullable(val); },
              _compare_func = (o, c, m) => {
              
                if (o._HACode != c._HACode || o.IsRIRPropChanged(_str__HACode, c)) 
                  m.Add(_str__HACode, o.ObjectIdent + _str__HACode, "int?", o._HACode == null ? "" : o._HACode.ToString(), o.IsReadOnly(_str__HACode), o.IsInvisible(_str__HACode), o.IsRequired(_str__HACode));
                 }
              }, 
            ...
            new field_info {
              _name = _str_strVaccinationRoute, _type = "string",
              ...
              _compare_func = (o, c, m) => { 
                ...
                if (o.strVaccinationRoute != c.strVaccinationRoute || o.IsRIRPropChanged(_str_strVaccinationRoute, c)) 
                  m.Add(_str_strVaccinationRoute, o.ObjectIdent + _str_strVaccinationRoute, "string", o.strVaccinationRoute == null ? "" : o.strVaccinationRoute.ToString(), o.IsReadOnly(_str_strVaccinationRoute), o.IsInvisible(_str_strVaccinationRoute), o.IsRequired(_str_strVaccinationRoute));
                 }
              }, 
        
            new field_info {
              _name = _str_strVaccinationType, _type = "string",
              ...
              _compare_func = (o, c, m) => { 
                ...
                if (o.strVaccinationType != c.strVaccinationType || o.IsRIRPropChanged(_str_strVaccinationType, c)) 
                  m.Add(_str_strVaccinationType, o.ObjectIdent + _str_strVaccinationType, "string", o.strVaccinationType == null ? "" : o.strVaccinationType.ToString(), o.IsReadOnly(_str_strVaccinationType), o.IsInvisible(_str_strVaccinationType), o.IsRequired(_str_strVaccinationType));
                 }
              }, 
            ...
            new field_info {
              _name = _str_VaccinationType, _type = "Lookup",
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsVaccinationType != c.idfsVaccinationType || o.IsRIRPropChanged(_str_VaccinationType, c)) 
                  m.Add(_str_VaccinationType, o.ObjectIdent + _str_VaccinationType, "Lookup", o.idfsVaccinationType == null ? "" : o.idfsVaccinationType.ToString(), o.IsReadOnly(_str_VaccinationType), o.IsInvisible(_str_VaccinationType), o.IsRequired(_str_VaccinationType)); }
              }, 
        
            new field_info {
              _name = _str_VaccinationRoute, _type = "Lookup",
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsVaccinationRoute != c.idfsVaccinationRoute || o.IsRIRPropChanged(_str_VaccinationRoute, c)) 
                  m.Add(_str_VaccinationRoute, o.ObjectIdent + _str_VaccinationRoute, "Lookup", o.idfsVaccinationRoute == null ? "" : o.idfsVaccinationRoute.ToString(), o.IsReadOnly(_str_VaccinationRoute), o.IsInvisible(_str_VaccinationRoute), o.IsRequired(_str_VaccinationRoute)); }
              }, 
        ...
        public BaseReference VaccinationType
        {
            ...
            { 
                ...
                idfsVaccinationType = _VaccinationType == null 
                    ? new Int64?()
                    : _VaccinationType.idfsBaseReference; 
        ...
        public BaseReference VaccinationRoute
        {
            ...
            { 
                ...
                idfsVaccinationRoute = _VaccinationRoute == null 
                    ? new Int64?()
                    : _VaccinationRoute.idfsBaseReference; 
        ...
        {
            get { return m_strSpecies; }
            set { if (m_strSpecies != value) { m_strSpecies = value; OnPropertyChanged(_str_strSpecies); } }
        }
        private string m_strSpecies;
      ...
      private bool IsRIRPropChanged(string fld, VaccinationListItem c)
        ...
        public Dictionary<string, Func<VaccinationListItem, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<VaccinationListItem, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public class VaccinationListItemGridModel : IGridModelItem
        {
            ...
            public DateTime? datVaccinationDate { get; set; }
        ...
        public partial class VaccinationListItemGridModelList : List<VaccinationListItemGridModel>, IGridModelList
        {
            ...
            private void LoadGridModelList(long key, IEnumerable<VaccinationListItem> items, string errMes)
            {
                ...
                Labels = new Dictionary<string, string> {{_str_strDiagnosis, "Vaccination.strDiagnosis"},{_str_datVaccinationDate, _str_datVaccinationDate},{_str_strSpecies, _str_strSpecies},{_str_intNumberVaccinated, _str_intNumberVaccinated},{_str_strVaccinationType, _str_strVaccinationType},{_str_strVaccinationRoute, _str_strVaccinationRoute},{_str_strLotNumber, _str_strLotNumber},{_str_strManufacturer, _str_strManufacturer},{_str_strNote, "Vaccination.strNote"}};
        ...
        {
            private delegate void on_action(VaccinationListItem obj);
            ...
            private List<VaccinationListItem> _SelectList(DbManagerProxy manager
                , Int64? idfCase
            ...
            internal void _SetupLoad(DbManagerProxy manager, VaccinationListItem obj)
            {
                if (obj == null) return;
            ...
            private VaccinationListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    VaccinationListItem obj = VaccinationListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.idfVaccination = (new GetNewIDExtender<VaccinationListItem>()).GetScalar(manager, obj);
                obj._HACode = HACode;
            ...
            public void LoadLookup_Diagnosis(DbManagerProxy manager, VaccinationListItem obj)
            {
                ...
                obj.DiagnosisLookup.AddRange(DiagnosisAccessor.SelectLookupList(manager
                    ...
                    .Where(c => ((c.intHACode & (int)obj._HACode) != 0) || c.idfsDiagnosis == obj.idfsDiagnosis)
            ...
            public void LoadLookup_VaccinationType(DbManagerProxy manager, VaccinationListItem obj)
            {
                ...
                if (obj.idfsVaccinationType != null && obj.idfsVaccinationType != 0)
                {
                    obj.VaccinationType = obj.VaccinationTypeLookup
                        .Where(c => c.idfsBaseReference == obj.idfsVaccinationType)
                        .SingleOrDefault();
                }
              
                
                LookupManager.AddObject("rftVaccinationType", obj, VaccinationTypeAccessor.GetType(), "rftVaccinationType_SelectList"
                  , "SelectLookupList");
            }
            ...
            public void LoadLookup_VaccinationRoute(DbManagerProxy manager, VaccinationListItem obj)
            {
                ...
                if (obj.idfsVaccinationRoute != null && obj.idfsVaccinationRoute != 0)
                {
                    obj.VaccinationRoute = obj.VaccinationRouteLookup
                        .Where(c => c.idfsBaseReference == obj.idfsVaccinationRoute)
                        .SingleOrDefault();
                }
              
                
                LookupManager.AddObject("rftVaccinationRoute", obj, VaccinationRouteAccessor.GetType(), "rftVaccinationRoute_SelectList"
                  , "SelectLookupList");
            }
            

            private void _LoadLookups(DbManagerProxy manager, VaccinationListItem obj)
            {
            ...
            public bool Validate(DbManagerProxy manager, VaccinationListItem obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
                ...
                (new PredicateValidator("Vaccination_AtLeastOneFieldHasToBeFilled", "", "", "",
              new object[] {
              },
                        false
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfVaccination,
                    _str_idfVaccination, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfSpecies,
                    _str_idfSpecies, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strDiagnosis,
                    "Vaccination.strDiagnosis", null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datVaccinationDate,
                    _str_datVaccinationDate, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSpecies,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_intNumberVaccinated, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strVaccinationType,
                    _str_strVaccinationType, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strVaccinationRoute,
                    _str_strVaccinationRoute, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strLotNumber,
                    _str_strLotNumber, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strManufacturer,
                    _str_strManufacturer, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strNote,
                    "Vaccination.strNote", null, true, true, null
                    ));
