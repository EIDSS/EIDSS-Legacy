...
namespace eidss.model.Schema
{
    ...
    public abstract partial class AggregateSettings : 
        ...
        protected class field_info
        {
            ...
            internal Action<AggregateSettings, AggregateSettings, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, AggregateSettings c)
        ...
        public Dictionary<string, Func<AggregateSettings, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<AggregateSettings, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(AggregateSettings obj);
            ...
            internal void _SetupLoad(DbManagerProxy manager, AggregateSettings obj)
            {
                if (obj == null) return;
            ...
            private AggregateSettings _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    AggregateSettings obj = AggregateSettings.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, AggregateSettings obj)
            {
