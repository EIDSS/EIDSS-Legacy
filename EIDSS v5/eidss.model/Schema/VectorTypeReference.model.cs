...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VectorTypeReference : 
        ...
        protected class field_info
        {
            ...
            internal Action<VectorTypeReference, VectorTypeReference, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, VectorTypeReference c)
        ...
        public Dictionary<string, Func<VectorTypeReference, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<VectorTypeReference, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public partial class VectorTypeReferenceGridModelList : List<VectorTypeReferenceGridModel>, IGridModelList
        {
        ...
        {
            private delegate void on_action(VectorTypeReference obj);
            ...
            private List<VectorTypeReference> _SelectList(DbManagerProxy manager
            ...
            internal void _SetupLoad(DbManagerProxy manager, VectorTypeReference obj)
            {
                if (obj == null) return;
            ...
            private VectorTypeReference _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    VectorTypeReference obj = VectorTypeReference.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.idfsBaseReference = (new GetNewIDExtender<VectorTypeReference>()).GetScalar(manager, obj);
            ...
            private void _LoadLookups(DbManagerProxy manager, VectorTypeReference obj)
            {
            ...
            public bool ValidateCanDelete(DbManagerProxy manager, VectorTypeReference obj)
            {
                ...
                try
                {
                    if (!obj.IsForcedToDelete)
                    {
                        ...
                        if (!result) 
                        {
                            throw new ValidationModelException("msgCantDelete", "_on_delete", "_on_delete", null, null, true);
                        }
                     }
                }
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfsBaseReference, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strDefaultName,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_bitCollectionByPool, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intOrder,
