...
namespace eidss.model.Schema
{
    ...
    public abstract partial class DiagnosisAgeGroupLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<DiagnosisAgeGroupLookup, DiagnosisAgeGroupLookup, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, DiagnosisAgeGroupLookup c)
        ...
        {
            return new Func<DiagnosisAgeGroupLookup, string>(c => c.DiagnosisAgeGroupNameTranslated)(this);
        }
        ...
        public Dictionary<string, Func<DiagnosisAgeGroupLookup, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<DiagnosisAgeGroupLookup, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(DiagnosisAgeGroupLookup obj);
            ...
            private List<DiagnosisAgeGroupLookup> _SelectList(DbManagerProxy manager
            ...
            internal void _SetupLoad(DbManagerProxy manager, DiagnosisAgeGroupLookup obj)
            {
                if (obj == null) return;
            ...
            private DiagnosisAgeGroupLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    DiagnosisAgeGroupLookup obj = DiagnosisAgeGroupLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, DiagnosisAgeGroupLookup obj)
            {
