...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VectorTypeLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<VectorTypeLookup, VectorTypeLookup, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, VectorTypeLookup c)
        ...
        public Dictionary<string, Func<VectorTypeLookup, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<VectorTypeLookup, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(VectorTypeLookup obj);
            ...
            private List<VectorTypeLookup> _SelectList(DbManagerProxy manager
            ...
            internal void _SetupLoad(DbManagerProxy manager, VectorTypeLookup obj)
            {
                if (obj == null) return;
            ...
            private VectorTypeLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    VectorTypeLookup obj = VectorTypeLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, VectorTypeLookup obj)
            {
