...
namespace eidss.model.Schema
{
    ...
    public abstract partial class DataArchiveSettings : 
        ...
        #if MONO
        protected String strSchedule_Original { get { return strSchedule; } }
        protected String strSchedule_Previous { get { return strSchedule; } }
        #else
        ...
        #if MONO
        protected String strDataRelevanceInterval_Original { get { return strDataRelevanceInterval; } }
        protected String strDataRelevanceInterval_Previous { get { return strDataRelevanceInterval; } }
        #else
        ...
        protected class field_info
        {
            ...
            internal Action<DataArchiveSettings, DataArchiveSettings, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_strSchedule, _type = "String",
              _get_func = o => o.strSchedule,
              _set_func = (o, val) => { o.strSchedule = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.strSchedule != c.strSchedule || o.IsRIRPropChanged(_str_strSchedule, c)) 
                  m.Add(_str_strSchedule, o.ObjectIdent + _str_strSchedule, "String", o.strSchedule == null ? "" : o.strSchedule.ToString(), o.IsReadOnly(_str_strSchedule), o.IsInvisible(_str_strSchedule), o.IsRequired(_str_strSchedule)); }
              }, 
        
            new field_info {
              _name = _str_strDataRelevanceInterval, _type = "String",
              _get_func = o => o.strDataRelevanceInterval,
              _set_func = (o, val) => { o.strDataRelevanceInterval = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.strDataRelevanceInterval != c.strDataRelevanceInterval || o.IsRIRPropChanged(_str_strDataRelevanceInterval, c)) 
                  m.Add(_str_strDataRelevanceInterval, o.ObjectIdent + _str_strDataRelevanceInterval, "String", o.strDataRelevanceInterval == null ? "" : o.strDataRelevanceInterval.ToString(), o.IsReadOnly(_str_strDataRelevanceInterval), o.IsInvisible(_str_strDataRelevanceInterval), o.IsRequired(_str_strDataRelevanceInterval)); }
              }, 
      ...
      private bool IsRIRPropChanged(string fld, DataArchiveSettings c)
        ...
        public Dictionary<string, Func<DataArchiveSettings, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<DataArchiveSettings, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(DataArchiveSettings obj);
                ...
                )
            {
                ...
                try
                {
                    ...
                    DataArchiveSettings obj = objs[0];
                    obj.m_CS = m_CS;
            ...
            internal void _SetupLoad(DbManagerProxy manager, DataArchiveSettings obj)
            {
                if (obj == null) return;
            ...
            private DataArchiveSettings _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    DataArchiveSettings obj = DataArchiveSettings.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, DataArchiveSettings obj)
            {
