...
namespace eidss.model.Schema
{
    ...
    public abstract partial class StatisticListItem : 
        ...
        #if MONO
        protected String strStatisticalAgeGroup_Original { get { return strStatisticalAgeGroup; } }
        protected String strStatisticalAgeGroup_Previous { get { return strStatisticalAgeGroup; } }
        #else
        ...
        #if MONO
        protected String defDataTypeName_Original { get { return defDataTypeName; } }
        protected String defDataTypeName_Previous { get { return defDataTypeName; } }
        #else
        ...
        #if MONO
        protected Double? varValue_Original { get { return varValue; } }
        protected Double? varValue_Previous { get { return varValue; } }
        #else
        ...
        #if MONO
        protected String setnDataTypeName_Original { get { return setnDataTypeName; } }
        protected String setnDataTypeName_Previous { get { return setnDataTypeName; } }
        #else
        ...
        #if MONO
        protected String ParameterType_Original { get { return ParameterType; } }
        protected String ParameterType_Previous { get { return ParameterType; } }
        #else
        ...
        #if MONO
        protected String defParameterName_Original { get { return defParameterName; } }
        protected String defParameterName_Previous { get { return defParameterName; } }
        #else
        ...
        #if MONO
        protected String setnParameterName_Original { get { return setnParameterName; } }
        protected String setnParameterName_Previous { get { return setnParameterName; } }
        #else
        ...
        #if MONO
        protected Int64? idfsParameterName_Original { get { return idfsParameterName; } }
        protected Int64? idfsParameterName_Previous { get { return idfsParameterName; } }
        #else
        ...
        #if MONO
        protected String defAreaTypeName_Original { get { return defAreaTypeName; } }
        protected String defAreaTypeName_Previous { get { return defAreaTypeName; } }
        #else
        ...
        #if MONO
        protected String setnAreaTypeName_Original { get { return setnAreaTypeName; } }
        protected String setnAreaTypeName_Previous { get { return setnAreaTypeName; } }
        #else
        ...
        #if MONO
        protected String defPeriodTypeName_Original { get { return defPeriodTypeName; } }
        protected String defPeriodTypeName_Previous { get { return defPeriodTypeName; } }
        #else
        ...
        #if MONO
        protected String setnPeriodTypeName_Original { get { return setnPeriodTypeName; } }
        protected String setnPeriodTypeName_Previous { get { return setnPeriodTypeName; } }
        #else
        ...
        #if MONO
        protected String setnArea_Original { get { return setnArea; } }
        protected String setnArea_Previous { get { return setnArea; } }
        #else
        ...
        protected class field_info
        {
            ...
            internal Action<StatisticListItem, StatisticListItem, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_strStatisticalAgeGroup, _type = "String",
              _get_func = o => o.strStatisticalAgeGroup,
              _set_func = (o, val) => { o.strStatisticalAgeGroup = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.strStatisticalAgeGroup != c.strStatisticalAgeGroup || o.IsRIRPropChanged(_str_strStatisticalAgeGroup, c)) 
                  m.Add(_str_strStatisticalAgeGroup, o.ObjectIdent + _str_strStatisticalAgeGroup, "String", o.strStatisticalAgeGroup == null ? "" : o.strStatisticalAgeGroup.ToString(), o.IsReadOnly(_str_strStatisticalAgeGroup), o.IsInvisible(_str_strStatisticalAgeGroup), o.IsRequired(_str_strStatisticalAgeGroup)); }
              }, 
        
            new field_info {
              _name = _str_defDataTypeName, _type = "String",
              _get_func = o => o.defDataTypeName,
              _set_func = (o, val) => { o.defDataTypeName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.defDataTypeName != c.defDataTypeName || o.IsRIRPropChanged(_str_defDataTypeName, c)) 
                  m.Add(_str_defDataTypeName, o.ObjectIdent + _str_defDataTypeName, "String", o.defDataTypeName == null ? "" : o.defDataTypeName.ToString(), o.IsReadOnly(_str_defDataTypeName), o.IsInvisible(_str_defDataTypeName), o.IsRequired(_str_defDataTypeName)); }
              }, 
        
            new field_info {
              _name = _str_varValue, _type = "Double?",
              _get_func = o => o.varValue,
              _set_func = (o, val) => { o.varValue = ParsingHelper.ParseDoubleNullable(val); },
              _compare_func = (o, c, m) => {
                if (o.varValue != c.varValue || o.IsRIRPropChanged(_str_varValue, c)) 
                  m.Add(_str_varValue, o.ObjectIdent + _str_varValue, "Double?", o.varValue == null ? "" : o.varValue.ToString(), o.IsReadOnly(_str_varValue), o.IsInvisible(_str_varValue), o.IsRequired(_str_varValue)); }
              }, 
            ...
            new field_info {
              _name = _str_setnDataTypeName, _type = "String",
              _get_func = o => o.setnDataTypeName,
              _set_func = (o, val) => { o.setnDataTypeName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.setnDataTypeName != c.setnDataTypeName || o.IsRIRPropChanged(_str_setnDataTypeName, c)) 
                  m.Add(_str_setnDataTypeName, o.ObjectIdent + _str_setnDataTypeName, "String", o.setnDataTypeName == null ? "" : o.setnDataTypeName.ToString(), o.IsReadOnly(_str_setnDataTypeName), o.IsInvisible(_str_setnDataTypeName), o.IsRequired(_str_setnDataTypeName)); }
              }, 
        
            new field_info {
              _name = _str_ParameterType, _type = "String",
              _get_func = o => o.ParameterType,
              _set_func = (o, val) => { o.ParameterType = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.ParameterType != c.ParameterType || o.IsRIRPropChanged(_str_ParameterType, c)) 
                  m.Add(_str_ParameterType, o.ObjectIdent + _str_ParameterType, "String", o.ParameterType == null ? "" : o.ParameterType.ToString(), o.IsReadOnly(_str_ParameterType), o.IsInvisible(_str_ParameterType), o.IsRequired(_str_ParameterType)); }
              }, 
            ...
            new field_info {
              _name = _str_defParameterName, _type = "String",
              _get_func = o => o.defParameterName,
              _set_func = (o, val) => { o.defParameterName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.defParameterName != c.defParameterName || o.IsRIRPropChanged(_str_defParameterName, c)) 
                  m.Add(_str_defParameterName, o.ObjectIdent + _str_defParameterName, "String", o.defParameterName == null ? "" : o.defParameterName.ToString(), o.IsReadOnly(_str_defParameterName), o.IsInvisible(_str_defParameterName), o.IsRequired(_str_defParameterName)); }
              }, 
        
            new field_info {
              _name = _str_setnParameterName, _type = "String",
              _get_func = o => o.setnParameterName,
              _set_func = (o, val) => { o.setnParameterName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.setnParameterName != c.setnParameterName || o.IsRIRPropChanged(_str_setnParameterName, c)) 
                  m.Add(_str_setnParameterName, o.ObjectIdent + _str_setnParameterName, "String", o.setnParameterName == null ? "" : o.setnParameterName.ToString(), o.IsReadOnly(_str_setnParameterName), o.IsInvisible(_str_setnParameterName), o.IsRequired(_str_setnParameterName)); }
              }, 
        
            new field_info {
              _name = _str_idfsParameterName, _type = "Int64?",
              _get_func = o => o.idfsParameterName,
              _set_func = (o, val) => { o.idfsParameterName = ParsingHelper.ParseInt64Nullable(val); },
              _compare_func = (o, c, m) => {
                if (o.idfsParameterName != c.idfsParameterName || o.IsRIRPropChanged(_str_idfsParameterName, c)) 
                  m.Add(_str_idfsParameterName, o.ObjectIdent + _str_idfsParameterName, "Int64?", o.idfsParameterName == null ? "" : o.idfsParameterName.ToString(), o.IsReadOnly(_str_idfsParameterName), o.IsInvisible(_str_idfsParameterName), o.IsRequired(_str_idfsParameterName)); }
              }, 
        
            new field_info {
              _name = _str_defAreaTypeName, _type = "String",
              _get_func = o => o.defAreaTypeName,
              _set_func = (o, val) => { o.defAreaTypeName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.defAreaTypeName != c.defAreaTypeName || o.IsRIRPropChanged(_str_defAreaTypeName, c)) 
                  m.Add(_str_defAreaTypeName, o.ObjectIdent + _str_defAreaTypeName, "String", o.defAreaTypeName == null ? "" : o.defAreaTypeName.ToString(), o.IsReadOnly(_str_defAreaTypeName), o.IsInvisible(_str_defAreaTypeName), o.IsRequired(_str_defAreaTypeName)); }
              }, 
        
            new field_info {
              _name = _str_setnAreaTypeName, _type = "String",
              _get_func = o => o.setnAreaTypeName,
              _set_func = (o, val) => { o.setnAreaTypeName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.setnAreaTypeName != c.setnAreaTypeName || o.IsRIRPropChanged(_str_setnAreaTypeName, c)) 
                  m.Add(_str_setnAreaTypeName, o.ObjectIdent + _str_setnAreaTypeName, "String", o.setnAreaTypeName == null ? "" : o.setnAreaTypeName.ToString(), o.IsReadOnly(_str_setnAreaTypeName), o.IsInvisible(_str_setnAreaTypeName), o.IsRequired(_str_setnAreaTypeName)); }
              }, 
        
            new field_info {
              _name = _str_defPeriodTypeName, _type = "String",
              _get_func = o => o.defPeriodTypeName,
              _set_func = (o, val) => { o.defPeriodTypeName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.defPeriodTypeName != c.defPeriodTypeName || o.IsRIRPropChanged(_str_defPeriodTypeName, c)) 
                  m.Add(_str_defPeriodTypeName, o.ObjectIdent + _str_defPeriodTypeName, "String", o.defPeriodTypeName == null ? "" : o.defPeriodTypeName.ToString(), o.IsReadOnly(_str_defPeriodTypeName), o.IsInvisible(_str_defPeriodTypeName), o.IsRequired(_str_defPeriodTypeName)); }
              }, 
        
            new field_info {
              _name = _str_setnPeriodTypeName, _type = "String",
              _get_func = o => o.setnPeriodTypeName,
              _set_func = (o, val) => { o.setnPeriodTypeName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.setnPeriodTypeName != c.setnPeriodTypeName || o.IsRIRPropChanged(_str_setnPeriodTypeName, c)) 
                  m.Add(_str_setnPeriodTypeName, o.ObjectIdent + _str_setnPeriodTypeName, "String", o.setnPeriodTypeName == null ? "" : o.setnPeriodTypeName.ToString(), o.IsReadOnly(_str_setnPeriodTypeName), o.IsInvisible(_str_setnPeriodTypeName), o.IsRequired(_str_setnPeriodTypeName)); }
              }, 
        
            new field_info {
              _name = _str_setnArea, _type = "String",
              _get_func = o => o.setnArea,
              _set_func = (o, val) => { o.setnArea = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.setnArea != c.setnArea || o.IsRIRPropChanged(_str_setnArea, c)) 
                  m.Add(_str_setnArea, o.ObjectIdent + _str_setnArea, "String", o.setnArea == null ? "" : o.setnArea.ToString(), o.IsReadOnly(_str_setnArea), o.IsInvisible(_str_setnArea), o.IsRequired(_str_setnArea)); }
              }, 
            ...
            new field_info {
              _name = _str_StatisticDataType, _type = "Lookup",
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsStatisticDataType != c.idfsStatisticDataType || o.IsRIRPropChanged(_str_StatisticDataType, c)) 
                  m.Add(_str_StatisticDataType, o.ObjectIdent + _str_StatisticDataType, "Lookup", o.idfsStatisticDataType == null ? "" : o.idfsStatisticDataType.ToString(), o.IsReadOnly(_str_StatisticDataType), o.IsInvisible(_str_StatisticDataType), o.IsRequired(_str_StatisticDataType)); }
              }, 
        ...
        public StatisticTypeLookup StatisticDataType
        {
            ...
            { 
                ...
                idfsStatisticDataType = _StatisticDataType == null 
                    ? new Int64()
                    : _StatisticDataType.idfsBaseReference; 
      ...
      private bool IsRIRPropChanged(string fld, StatisticListItem c)
        ...
        public Dictionary<string, Func<StatisticListItem, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<StatisticListItem, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public partial class StatisticListItemGridModelList : List<StatisticListItemGridModel>, IGridModelList
        {
        ...
        {
            private delegate void on_action(StatisticListItem obj);
            ...
            private List<StatisticListItem> _SelectList(DbManagerProxy manager
                ...
                )
            {
                ...
                if (filters.Contains("idfsStatisticDataType") || filters.Contains("idfsRegion") || filters.Contains("idfsRayon") || filters.Contains("idfsSettlement"))
                {
                ...
                if (filters.Contains("idfsStatisticDataType"))
                    sql.AppendFormat(" and " + new Func<string>(() => "Area.idfsCountry = " + eidss.model.Core.EidssSiteContext.Instance.CountryID)());
            ...
            internal void _SetupLoad(DbManagerProxy manager, StatisticListItem obj)
            {
                if (obj == null) return;
            ...
            private StatisticListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    StatisticListItem obj = StatisticListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public void LoadLookup_StatisticDataType(DbManagerProxy manager, StatisticListItem obj)
            {
                ...
                if (obj.idfsStatisticDataType != 0)
                {
                    obj.StatisticDataType = obj.StatisticDataTypeLookup
                        .Where(c => c.idfsBaseReference == obj.idfsStatisticDataType)
                        .SingleOrDefault();
                }
              
                
                LookupManager.AddObject("StatisticTypeLookup", obj, StatisticDataTypeAccessor.GetType(), "SelectLookupList");
            }
            ...
            private void _LoadLookups(DbManagerProxy manager, StatisticListItem obj)
            {
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                SearchPanelMeta.Add(new SearchPanelMetaItem(
                    ...
                    false, false, 
                    "idfsStatisticDataType",
                    null, null, false, false, SearchPanelLocation.Main, false, null, "StatisticDataTypeLookup", typeof(StatisticTypeLookup), (o) => { var c = (StatisticTypeLookup)o; return c.idfsBaseReference; }, (o) => { var c = (StatisticTypeLookup)o; return c.name; }
                    ));
                SearchPanelMeta.Add(new SearchPanelMetaItem(
                    ...
                    true, false, 
                    "datStatisticStartDate",
                    () => new DateTime(DateTime.Now.Year - 1, 01, 01), null, true, false, SearchPanelLocation.Main, false, null, null, null, null, null
                    ));
                SearchPanelMeta.Add(new SearchPanelMetaItem(
                    "idfsRegion",
                    EditorType.Lookup,
                    false, false, 
                    "idfsRegion",
                    null, null, false, false, SearchPanelLocation.Main, true, "idfsRayon", "RegionLookup", typeof(RegionLookup), (o) => { var c = (RegionLookup)o; return c.idfsRegion; }, (o) => { var c = (RegionLookup)o; return c.strRegionName; }
                    ));
                SearchPanelMeta.Add(new SearchPanelMetaItem(
                    "idfsRayon",
                    EditorType.Lookup,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfStatistic,
                    _str_idfStatistic, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_varValue,
                    _str_varValue, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strStatisticalAgeGroup,
                    _str_strStatisticalAgeGroup, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_ParameterType,
                    _str_ParameterType, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_setnParameterName,
                    _str_setnParameterName, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_setnPeriodTypeName,
                    _str_setnPeriodTypeName, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datStatisticStartDate,
                    _str_datStatisticStartDate, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_setnAreaTypeName,
                    _str_setnAreaTypeName, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_setnArea,
                    _str_setnArea, null, true, true, null
                    ));
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(true, ObjectAccessor.CreatorInterface<Statistic>().CreateNew(manager, null, pars == null ? null : (int?)pars[0])),
                    null,
                    new ActionMetaItem.VisualItem(
