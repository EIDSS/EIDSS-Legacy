...
namespace eidss.model.Schema
{
    ...
    public abstract partial class SiteActivationServer : 
        ...
        protected class field_info
        {
            ...
            internal Action<SiteActivationServer, SiteActivationServer, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, SiteActivationServer c)
        ...
        public Dictionary<string, Func<SiteActivationServer, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<SiteActivationServer, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(SiteActivationServer obj);
                ...
                )
            {
                ...
                try
                {
                    ...
                    SiteActivationServer obj = objs[0];
                    obj.m_CS = m_CS;
            ...
            internal void _SetupLoad(DbManagerProxy manager, SiteActivationServer obj)
            {
                if (obj == null) return;
            ...
            private SiteActivationServer _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    SiteActivationServer obj = SiteActivationServer.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, SiteActivationServer obj)
            {
