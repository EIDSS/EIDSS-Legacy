...
namespace eidss.model.Schema
{
    ...
    public abstract partial class Label : 
        ...
        #if MONO
        protected Int32? intFontStyle_Original { get { return intFontStyle; } }
        protected Int32? intFontStyle_Previous { get { return intFontStyle; } }
        #else
        ...
        #if MONO
        protected Int32? intFontSize_Original { get { return intFontSize; } }
        protected Int32? intFontSize_Previous { get { return intFontSize; } }
        #else
        ...
        #if MONO
        protected String DefaultText_Original { get { return DefaultText; } }
        protected String DefaultText_Previous { get { return DefaultText; } }
        #else
        ...
        #if MONO
        protected String NationalText_Original { get { return NationalText; } }
        protected String NationalText_Previous { get { return NationalText; } }
        #else
        ...
        protected class field_info
        {
            ...
            internal Action<Label, Label, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _set_func = (o, val) => { o.idfsBaseReference = ParsingHelper.ParseInt64Nullable(val); },
              _compare_func = (o, c, m) => {
            ...
            new field_info {
              _name = _str_intFontStyle, _type = "Int32?",
              _get_func = o => o.intFontStyle,
              _set_func = (o, val) => { o.intFontStyle = ParsingHelper.ParseInt32Nullable(val); },
              _compare_func = (o, c, m) => {
                if (o.intFontStyle != c.intFontStyle || o.IsRIRPropChanged(_str_intFontStyle, c)) 
                  m.Add(_str_intFontStyle, o.ObjectIdent + _str_intFontStyle, "Int32?", o.intFontStyle == null ? "" : o.intFontStyle.ToString(), o.IsReadOnly(_str_intFontStyle), o.IsInvisible(_str_intFontStyle), o.IsRequired(_str_intFontStyle)); }
              }, 
        
            new field_info {
              _name = _str_intFontSize, _type = "Int32?",
              _get_func = o => o.intFontSize,
              _set_func = (o, val) => { o.intFontSize = ParsingHelper.ParseInt32Nullable(val); },
              _compare_func = (o, c, m) => {
                if (o.intFontSize != c.intFontSize || o.IsRIRPropChanged(_str_intFontSize, c)) 
                  m.Add(_str_intFontSize, o.ObjectIdent + _str_intFontSize, "Int32?", o.intFontSize == null ? "" : o.intFontSize.ToString(), o.IsReadOnly(_str_intFontSize), o.IsInvisible(_str_intFontSize), o.IsRequired(_str_intFontSize)); }
              }, 
            ...
            new field_info {
              _name = _str_DefaultText, _type = "String",
              _get_func = o => o.DefaultText,
              _set_func = (o, val) => { o.DefaultText = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.DefaultText != c.DefaultText || o.IsRIRPropChanged(_str_DefaultText, c)) 
                  m.Add(_str_DefaultText, o.ObjectIdent + _str_DefaultText, "String", o.DefaultText == null ? "" : o.DefaultText.ToString(), o.IsReadOnly(_str_DefaultText), o.IsInvisible(_str_DefaultText), o.IsRequired(_str_DefaultText)); }
              }, 
        
            new field_info {
              _name = _str_NationalText, _type = "String",
              _get_func = o => o.NationalText,
              _set_func = (o, val) => { o.NationalText = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.NationalText != c.NationalText || o.IsRIRPropChanged(_str_NationalText, c)) 
                  m.Add(_str_NationalText, o.ObjectIdent + _str_NationalText, "String", o.NationalText == null ? "" : o.NationalText.ToString(), o.IsReadOnly(_str_NationalText), o.IsInvisible(_str_NationalText), o.IsRequired(_str_NationalText)); }
              }, 
      ...
      private bool IsRIRPropChanged(string fld, Label c)
        ...
        public Dictionary<string, Func<Label, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<Label, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(Label obj);
            ...
            public List<Label> SelectDetailListT(DbManagerProxy manager, List<object> pars)
            {
            ...
            public List<Label> SelectDetailList(DbManagerProxy manager, List<object> pars)
            {
                return SelectDetailListT(manager, pars);
            }
            public virtual List<Label> SelectDetailList(DbManagerProxy manager
                , Int64? idfsFormTemplate
                )
            {
                return _SelectList(manager
            ...
            private List<Label> _SelectList(DbManagerProxy manager
                , Int64? idfsFormTemplate
            ...
            internal void _SetupLoad(DbManagerProxy manager, Label obj)
            {
                if (obj == null) return;
            ...
            private Label _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    Label obj = Label.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, Label obj)
            {
