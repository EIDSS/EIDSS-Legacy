...
namespace eidss.model.Schema
{
    ...
    public abstract partial class Parameter : 
        ...
        #if MONO
        protected String ParameterTypeName_Original { get { return ParameterTypeName; } }
        protected String ParameterTypeName_Previous { get { return ParameterTypeName; } }
        #else
        ...
        #if MONO
        protected Int64? idfsParameterCaption_Original { get { return idfsParameterCaption; } }
        protected Int64? idfsParameterCaption_Previous { get { return idfsParameterCaption; } }
        #else
        ...
        #if MONO
        protected String DefaultLongName_Original { get { return DefaultLongName; } }
        protected String DefaultLongName_Previous { get { return DefaultLongName; } }
        #else
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_ParameterTypeName, _type = "String",
              _get_func = o => o.ParameterTypeName,
              _set_func = (o, val) => { o.ParameterTypeName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.ParameterTypeName != c.ParameterTypeName || o.IsRIRPropChanged(_str_ParameterTypeName, c)) 
                  m.Add(_str_ParameterTypeName, o.ObjectIdent + _str_ParameterTypeName, "String", o.ParameterTypeName == null ? "" : o.ParameterTypeName.ToString(), o.IsReadOnly(_str_ParameterTypeName), o.IsInvisible(_str_ParameterTypeName), o.IsRequired(_str_ParameterTypeName)); }
              }, 
            ...
            new field_info {
              _name = _str_idfsParameterCaption, _type = "Int64?",
              _get_func = o => o.idfsParameterCaption,
              _set_func = (o, val) => { o.idfsParameterCaption = ParsingHelper.ParseInt64Nullable(val); },
              _compare_func = (o, c, m) => {
                if (o.idfsParameterCaption != c.idfsParameterCaption || o.IsRIRPropChanged(_str_idfsParameterCaption, c)) 
                  m.Add(_str_idfsParameterCaption, o.ObjectIdent + _str_idfsParameterCaption, "Int64?", o.idfsParameterCaption == null ? "" : o.idfsParameterCaption.ToString(), o.IsReadOnly(_str_idfsParameterCaption), o.IsInvisible(_str_idfsParameterCaption), o.IsRequired(_str_idfsParameterCaption)); }
              }, 
            ...
            new field_info {
              _name = _str_DefaultLongName, _type = "String",
              _get_func = o => o.DefaultLongName,
              _set_func = (o, val) => { o.DefaultLongName = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.DefaultLongName != c.DefaultLongName || o.IsRIRPropChanged(_str_DefaultLongName, c)) 
                  m.Add(_str_DefaultLongName, o.ObjectIdent + _str_DefaultLongName, "String", o.DefaultLongName == null ? "" : o.DefaultLongName.ToString(), o.IsReadOnly(_str_DefaultLongName), o.IsInvisible(_str_DefaultLongName), o.IsRequired(_str_DefaultLongName)); }
              }, 
      ...
      private bool IsRIRPropChanged(string fld, Parameter c)
        ...
        public Dictionary<string, Func<Parameter, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<Parameter, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
                    ...
                    
        {
            ...
            internal void _SetupLoad(DbManagerProxy manager, Parameter obj)
            {
                if (obj == null) return;
            ...
            private Parameter _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
