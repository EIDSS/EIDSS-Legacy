...
namespace eidss.model.Schema
{
    ...
    public abstract partial class LabSampleTransfer : 
        ...
        #if MONO
        protected Int64 idfsTransferStatus_Original { get { return idfsTransferStatus; } }
        protected Int64 idfsTransferStatus_Previous { get { return idfsTransferStatus; } }
        #else
        ...
        #if MONO
        protected Int64? idfSendByPerson_Original { get { return idfSendByPerson; } }
        protected Int64? idfSendByPerson_Previous { get { return idfSendByPerson; } }
        #else
        ...
        #if MONO
        protected DateTime? datSendDate_Original { get { return datSendDate; } }
        protected DateTime? datSendDate_Previous { get { return datSendDate; } }
        #else
        ...
        protected class field_info
        {
            ...
            internal Action<LabSampleTransfer, LabSampleTransfer, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfsTransferStatus, _type = "Int64",
              _get_func = o => o.idfsTransferStatus,
              _set_func = (o, val) => { o.idfsTransferStatus = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
                if (o.idfsTransferStatus != c.idfsTransferStatus || o.IsRIRPropChanged(_str_idfsTransferStatus, c)) 
                  m.Add(_str_idfsTransferStatus, o.ObjectIdent + _str_idfsTransferStatus, "Int64", o.idfsTransferStatus == null ? "" : o.idfsTransferStatus.ToString(), o.IsReadOnly(_str_idfsTransferStatus), o.IsInvisible(_str_idfsTransferStatus), o.IsRequired(_str_idfsTransferStatus)); }
              }, 
            ...
            new field_info {
              _name = _str_idfSendByPerson, _type = "Int64?",
              _get_func = o => o.idfSendByPerson,
              _set_func = (o, val) => { o.idfSendByPerson = ParsingHelper.ParseInt64Nullable(val); },
              _compare_func = (o, c, m) => {
                if (o.idfSendByPerson != c.idfSendByPerson || o.IsRIRPropChanged(_str_idfSendByPerson, c)) 
                  m.Add(_str_idfSendByPerson, o.ObjectIdent + _str_idfSendByPerson, "Int64?", o.idfSendByPerson == null ? "" : o.idfSendByPerson.ToString(), o.IsReadOnly(_str_idfSendByPerson), o.IsInvisible(_str_idfSendByPerson), o.IsRequired(_str_idfSendByPerson)); }
              }, 
        
            new field_info {
              _name = _str_datSendDate, _type = "DateTime?",
              _get_func = o => o.datSendDate,
              _set_func = (o, val) => { o.datSendDate = ParsingHelper.ParseDateTimeNullable(val); },
              _compare_func = (o, c, m) => {
                if (o.datSendDate != c.datSendDate || o.IsRIRPropChanged(_str_datSendDate, c)) 
                  m.Add(_str_datSendDate, o.ObjectIdent + _str_datSendDate, "DateTime?", o.datSendDate == null ? "" : o.datSendDate.ToString(), o.IsReadOnly(_str_datSendDate), o.IsInvisible(_str_datSendDate), o.IsRequired(_str_datSendDate)); }
              }, 
      ...
      private bool IsRIRPropChanged(string fld, LabSampleTransfer c)
        ...
        public Dictionary<string, Func<LabSampleTransfer, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<LabSampleTransfer, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(LabSampleTransfer obj);
            ...
            internal void _SetupLoad(DbManagerProxy manager, LabSampleTransfer obj)
            {
                if (obj == null) return;
            ...
            private LabSampleTransfer _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    LabSampleTransfer obj = LabSampleTransfer.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, LabSampleTransfer obj)
            {
