...
namespace eidss.model.Schema
{
    ...
    public abstract partial class DepartmentLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<DepartmentLookup, DepartmentLookup, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _set_func = (o, val) => { o.idfDepartment = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
      ...
      private bool IsRIRPropChanged(string fld, DepartmentLookup c)
        ...
        public Dictionary<string, Func<DepartmentLookup, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<DepartmentLookup, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(DepartmentLookup obj);
            ...
            private List<DepartmentLookup> _SelectList(DbManagerProxy manager
                , Int64? OrganizationID
                , Int64? ID
            ...
            internal void _SetupLoad(DbManagerProxy manager, DepartmentLookup obj)
            {
                if (obj == null) return;
            ...
            private DepartmentLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    DepartmentLookup obj = DepartmentLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, DepartmentLookup obj)
            {
