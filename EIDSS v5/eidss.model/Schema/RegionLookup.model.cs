...
namespace eidss.model.Schema
{
    ...
    public abstract partial class RegionLookup : 
      ...
      private bool IsRIRPropChanged(string fld, RegionLookup c)
        ...
        public Dictionary<string, Func<RegionLookup, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<RegionLookup, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
            ...
            
        {
            ...
            internal void _SetupLoad(DbManagerProxy manager, RegionLookup obj)
            {
                if (obj == null) return;
            ...
            private RegionLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
