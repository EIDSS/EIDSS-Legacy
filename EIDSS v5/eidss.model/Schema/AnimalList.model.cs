...
namespace eidss.model.Schema
{
    ...
    public abstract partial class AnimalListItem : 
        ...
        #if MONO
        protected Int64? idfsAnimalCondition_Original { get { return idfsAnimalCondition; } }
        protected Int64? idfsAnimalCondition_Previous { get { return idfsAnimalCondition; } }
        #else
        ...
        protected class field_info
        {
            ...
            internal Action<AnimalListItem, AnimalListItem, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _set_func = (o, val) => { o.idfHerd = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
            ...
            new field_info {
              _name = _str_idfsAnimalCondition, _type = "Int64?",
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsAnimalCondition != c.idfsAnimalCondition || o.IsRIRPropChanged(_str_idfsAnimalCondition, c)) 
                  m.Add(_str_idfsAnimalCondition, o.ObjectIdent + _str_idfsAnimalCondition, "Int64?", o.idfsAnimalCondition == null ? "" : o.idfsAnimalCondition.ToString(), o.IsReadOnly(_str_idfsAnimalCondition), o.IsInvisible(_str_idfsAnimalCondition), o.IsRequired(_str_idfsAnimalCondition)); }
              }, 
            ...
            new field_info {
              _name = _str_idfsDiagnosisForCs, _type = "long?",
              _get_func = o => o.idfsDiagnosisForCs,
              _set_func = (o, val) => { o.idfsDiagnosisForCs = ParsingHelper.ParseInt64Nullable(val); },
              _compare_func = (o, c, m) => {
              
                if (o.idfsDiagnosisForCs != c.idfsDiagnosisForCs || o.IsRIRPropChanged(_str_idfsDiagnosisForCs, c)) 
                  m.Add(_str_idfsDiagnosisForCs, o.ObjectIdent + _str_idfsDiagnosisForCs, "long?", o.idfsDiagnosisForCs == null ? "" : o.idfsDiagnosisForCs.ToString(), o.IsReadOnly(_str_idfsDiagnosisForCs), o.IsInvisible(_str_idfsDiagnosisForCs), o.IsRequired(_str_idfsDiagnosisForCs));
                 }
              }, 
        
            new field_info {
              _name = _str_strClinicalSigns, _type = "string",
              _get_func = o => o.strClinicalSigns,
              _set_func = (o, val) => { o.strClinicalSigns = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
              
                if (o.strClinicalSigns != c.strClinicalSigns || o.IsRIRPropChanged(_str_strClinicalSigns, c)) 
                  m.Add(_str_strClinicalSigns, o.ObjectIdent + _str_strClinicalSigns, "string", o.strClinicalSigns == null ? "" : o.strClinicalSigns.ToString(), o.IsReadOnly(_str_strClinicalSigns), o.IsInvisible(_str_strClinicalSigns), o.IsRequired(_str_strClinicalSigns));
                 }
              }, 
        
            new field_info {
              _name = _str_strHerdSpecies, _type = "string",
              _get_func = o => o.strHerdSpecies,
              _set_func = (o, val) => {},
              _compare_func = (o, c, m) => { 
              
                if (o.strHerdSpecies != c.strHerdSpecies || o.IsRIRPropChanged(_str_strHerdSpecies, c)) 
                  m.Add(_str_strHerdSpecies, o.ObjectIdent + _str_strHerdSpecies, "string", o.strHerdSpecies == null ? "" : o.strHerdSpecies.ToString(), o.IsReadOnly(_str_strHerdSpecies), o.IsInvisible(_str_strHerdSpecies), o.IsRequired(_str_strHerdSpecies));
                 }
              }, 
            ...
            new field_info {
              _name = _str_strAnimalCondition, _type = "string",
              ...
              _compare_func = (o, c, m) => { 
                ...
                if (o.strAnimalCondition != c.strAnimalCondition || o.IsRIRPropChanged(_str_strAnimalCondition, c)) 
                  m.Add(_str_strAnimalCondition, o.ObjectIdent + _str_strAnimalCondition, "string", o.strAnimalCondition == null ? "" : o.strAnimalCondition.ToString(), o.IsReadOnly(_str_strAnimalCondition), o.IsInvisible(_str_strAnimalCondition), o.IsRequired(_str_strAnimalCondition));
                 }
              }, 
      ...
      private bool IsRIRPropChanged(string fld, AnimalListItem c)
        ...
        {
            return new Func<AnimalListItem, string>(c => string.IsNullOrEmpty(c.strAnimalCode) ? "" : c.strAnimalCode + " / " + c.strSpecies + " / " + c.strAnimalGender)(this);
        }
        ...
        public Dictionary<string, Func<AnimalListItem, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<AnimalListItem, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public partial class AnimalListItemGridModelList : List<AnimalListItemGridModel>, IGridModelList
        {
        ...
        {
            private delegate void on_action(AnimalListItem obj);
            ...
            private List<AnimalListItem> _SelectList(DbManagerProxy manager
                , Int64? idfCase
            ...
            internal void _SetupLoad(DbManagerProxy manager, AnimalListItem obj)
            {
                if (obj == null) return;
              ...
              obj.FFPresenterCs.SetProperties(EidssSiteContext.Instance.CountryID, obj.idfsDiagnosisForCs, FFTypeEnum.LivestockAnimalCS, obj.idfObservation.Value);
            ...
            private AnimalListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    AnimalListItem obj = AnimalListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.idfAnimal = (new GetNewIDExtender<AnimalListItem>()).GetScalar(manager, obj);
            ...
            private void _SetupHandlers(AnimalListItem obj)
            {
                ...
                obj.idfsSpeciesType = new Func<AnimalListItem, long>(c=>c.idfSpecies.HasValue && (c.Parent as VetCase != null) ? (c.Parent as VetCase).Farm.FarmTree.Single(i=>i.idfParty == c.idfSpecies).idfsSpeciesTypeReference.Value : default(long))(obj);
                        }
            ...
            private void _LoadLookups(DbManagerProxy manager, AnimalListItem obj)
            {
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfAnimal,
                    _str_idfAnimal, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strHerdSpecies,
                    _str_strHerdSpecies, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strAnimalCode,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_strClinicalSigns, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strAnimalCondition,
                    _str_strAnimalCondition, null, true, true, null
                    ));
