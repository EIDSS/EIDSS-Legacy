...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetFarmTree : 
        ...
        #if MONO
        protected Int64? idfsPartyType_Original { get { return idfsPartyType; } }
        protected Int64? idfsPartyType_Previous { get { return idfsPartyType; } }
        #else
        ...
        protected class field_info
        {
            ...
            internal Action<VetFarmTree, VetFarmTree, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfsPartyType, _type = "Int64?",
              _get_func = o => o.idfsPartyType,
              _set_func = (o, val) => { o.idfsPartyType = ParsingHelper.ParseInt64Nullable(val); },
              _compare_func = (o, c, m) => {
                if (o.idfsPartyType != c.idfsPartyType || o.IsRIRPropChanged(_str_idfsPartyType, c)) 
                  m.Add(_str_idfsPartyType, o.ObjectIdent + _str_idfsPartyType, "Int64?", o.idfsPartyType == null ? "" : o.idfsPartyType.ToString(), o.IsReadOnly(_str_idfsPartyType), o.IsInvisible(_str_idfsPartyType), o.IsRequired(_str_idfsPartyType)); }
              }, 
            ...
            new field_info {
              _name = _str_VetFarmTreeList, _type = "WeakReference",
            ...
            new field_info {
              _name = _str_VetFarmPanel, _type = "FarmPanel",
            ...
            new field_info {
              _name = _str_strFlockName, _type = "string",
              _get_func = o => o.strFlockName,
              _set_func = (o, val) => {},
              _compare_func = (o, c, m) => { 
              
                if (o.strFlockName != c.strFlockName || o.IsRIRPropChanged(_str_strFlockName, c)) 
                  m.Add(_str_strFlockName, o.ObjectIdent + _str_strFlockName, "string", o.strFlockName == null ? "" : o.strFlockName.ToString(), o.IsReadOnly(_str_strFlockName), o.IsInvisible(_str_strFlockName), o.IsRequired(_str_strFlockName));
                 }
              }, 
        ...
        {
            get { return new Func<VetFarmTree, string>(c=>c.idfsPartyType == (long)PartyTypeEnum.Species && c.idfsSpeciesTypeReference.HasValue ? SpeciesType.name : "")(this); }
      ...
      private bool IsRIRPropChanged(string fld, VetFarmTree c)
        ...
        {
            return new Func<VetFarmTree, string>(c => c.idfsPartyType == (long)PartyTypeEnum.Species ? c.strFlockName + " / " + c.strSpeciesName : c.strFlockName)(this);
        }
        ...
        public Dictionary<string, Func<VetFarmTree, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<VetFarmTree, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public partial class VetFarmTreeGridModelList : List<VetFarmTreeGridModel>, IGridModelList
        {
        ...
        {
            private delegate void on_action(VetFarmTree obj);
            ...
            private List<VetFarmTree> _SelectList(DbManagerProxy manager
                , Int64? idfFarm
                , int? HACode
            ...
            internal void _SetupLoad(DbManagerProxy manager, VetFarmTree obj)
            {
                if (obj == null) return;
            ...
            private VetFarmTree _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    VetFarmTree obj = VetFarmTree.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                )
            {
                ...
                obj.strName = new Func<VetFarmTree, string>(c => String.Format("(new {0})", 1 + parent.VetFarmPanel.FarmTree.Count(x => x.idfsPartyType == (long)PartyTypeEnum.Herd && !x.IsMarkedToDelete)))(obj);
                ...
                )
            {
                ...
                obj.strName = new Func<VetFarmTree, string>(c => "947220000000")(obj);
                obj.idfObservation = (new GetNewIDExtender<VetFarmTree>()).GetScalar(manager, obj);
            ...
            private void _LoadLookups(DbManagerProxy manager, VetFarmTree obj)
            {
    ...
    private void _SetupPersonalDataRestrictions(VetFarmTree obj)
    {
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strAverageAge,
                    _str_strAverageAge, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfParentParty,
                    _str_idfParentParty, null, false, true, null
                    ));
