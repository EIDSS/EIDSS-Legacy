...
namespace eidss.model.Schema
{
    ...
    public abstract partial class TypeFieldTestToResultMatrixLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<TypeFieldTestToResultMatrixLookup, TypeFieldTestToResultMatrixLookup, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _set_func = (o, val) => { o.idfsPensideTestResult = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
      ...
      private bool IsRIRPropChanged(string fld, TypeFieldTestToResultMatrixLookup c)
        ...
        {
            return new Func<TypeFieldTestToResultMatrixLookup, string>(c => c.strPensideTestTypeName)(this);
        }
        ...
        public Dictionary<string, Func<TypeFieldTestToResultMatrixLookup, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<TypeFieldTestToResultMatrixLookup, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(TypeFieldTestToResultMatrixLookup obj);
            ...
            private List<TypeFieldTestToResultMatrixLookup> _SelectList(DbManagerProxy manager
            ...
            internal void _SetupLoad(DbManagerProxy manager, TypeFieldTestToResultMatrixLookup obj)
            {
                if (obj == null) return;
            ...
            private TypeFieldTestToResultMatrixLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    TypeFieldTestToResultMatrixLookup obj = TypeFieldTestToResultMatrixLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, TypeFieldTestToResultMatrixLookup obj)
            {
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => ((TypeFieldTestToResultMatrixLookup)c).MarkToDelete(),
                    null,
                    new ActionMetaItem.VisualItem(
