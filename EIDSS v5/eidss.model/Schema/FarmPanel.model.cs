...
namespace eidss.model.Schema
{
    ...
    public abstract partial class FarmPanel : 
        ...
        protected class field_info
        {
            ...
            internal Action<FarmPanel, FarmPanel, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_Case, _type = "WeakReference",
              _get_func = o => o.Case,
              _set_func = (o, val) => { ; },
              _compare_func = (o, c, m) => {
               }
            ...
            new field_info {
              _name = _str_FarmTree, _type = "Child",
              _get_func = o => null,
              _set_func = (o, val) => {},
              _compare_func = (o, c, m) => {
                if (o.FarmTree.Count != c.FarmTree.Count || o.IsReadOnly(_str_FarmTree) != c.IsReadOnly(_str_FarmTree) || o.IsInvisible(_str_FarmTree) != c.IsInvisible(_str_FarmTree) || o.IsRequired(_str_FarmTree) != c.IsRequired(_str_FarmTree)) 
                  m.Add(_str_FarmTree, o.ObjectIdent + _str_FarmTree, "Child", o.idfFarm == null ? "" : o.idfFarm.ToString(), o.IsReadOnly(_str_FarmTree), o.IsInvisible(_str_FarmTree), o.IsRequired(_str_FarmTree)); }
              }, 
        ...
        {
            get { return new Func<FarmPanel, bool>(c => c.VCase == null ? false : c.VCase.IsClosed || c.VCase.ReadOnly)(this); }
      ...
      private bool IsRIRPropChanged(string fld, FarmPanel c)
        ...
        private bool _isReadOnly(string name)
        {
            ...
            return ReadOnly || new Func<FarmPanel, bool>(c => c.IsReadOnlyParent)(this);
        ...
        public Dictionary<string, Func<FarmPanel, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<FarmPanel, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(FarmPanel obj);
            ...
            internal void _LoadLocation(FarmPanel obj)
            {
                using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
                {
            ...
            internal void _LoadLocation(DbManagerProxy manager, FarmPanel obj)
            {
            ...
            internal void _SetupLoad(DbManagerProxy manager, FarmPanel obj)
            {
                if (obj == null) return;
                ...
                obj._blnAllowFarmReload = true;
                  ...
                  {
                  obj.FFPresenterEpi.SetProperties(obj.idfsFormTemplate.Value);
                  }
                  else
                  {
                  ...
                  obj.FFPresenterEpi.SetProperties(EidssSiteContext.Instance.CountryID, null, (obj.blnIsLivestock ?? true) ? FFTypeEnum.LivestockFarmEPI : FFTypeEnum.AvianFarmEPI, obj.idfObservation.Value);
            ...
            private FarmPanel _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    FarmPanel obj = FarmPanel.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.idfFarm = (new GetNewIDExtender<FarmPanel>()).GetScalar(manager, obj);
                obj.strFarmCode = new Func<FarmPanel, string>(c => "(new farm)")(obj);
                ...
                obj.Location = new Func<FarmPanel, GeoLocation>(c => LocationAccessor.CreateWithCountry(manager, c))(obj);
                obj.FarmTree.Add(new Func<FarmPanel, VetFarmTree>(c => FarmTreeAccessor.CreateFarm(manager, c, c))(obj));
                obj.blnIsLivestock = new Func<FarmPanel, bool?>(c=> obj._HACode == (int)eidss.model.Enums.HACode.Livestock )(obj);
                obj.blnIsAvian = new Func<FarmPanel, bool?>(c=> obj._HACode == (int)eidss.model.Enums.HACode.Avian)(obj);
                obj._blnAllowFarmReload = true;
                obj.idfObservation = (new GetNewIDExtender<FarmPanel>()).GetScalar(manager, obj);
                obj.FFPresenterEpi = new Func<FarmPanel, FFPresenterModel>(c => FFPresenterModel.Accessor.Instance(null).SelectByKey(manager, obj.idfObservation))(obj);
                ...
                obj.Location.blnGeoLocationShared = false;                  
                  obj.FFPresenterEpi.SetProperties(EidssSiteContext.Instance.CountryID, null, obj._HACode.Value == (int)eidss.model.Enums.HACode.Livestock ? FFTypeEnum.LivestockFarmEPI : FFTypeEnum.AvianFarmEPI, obj.idfObservation.Value);
                ...
                )
            {
                ...
                if (obj != null && !obj.GetPermissions().CanExecute("CreateHerd"))
                    throw new PermissionException("VetCase", "CreateHerd");
                ...
                )
            {
                ...
                if (obj != null && !obj.GetPermissions().CanExecute("CreateSpecies"))
                    throw new PermissionException("VetCase", "CreateSpecies");
            ...
            public void LoadLookup_LivestockProductionType(DbManagerProxy manager, FarmPanel obj)
            {
            ...
            public void LoadLookup_MovementPattern(DbManagerProxy manager, FarmPanel obj)
            {
            ...
            public void LoadLookup_GrazingPattern(DbManagerProxy manager, FarmPanel obj)
            {
            ...
            public void LoadLookup_AvianFarmProductionType(DbManagerProxy manager, FarmPanel obj)
            {
            ...
            public void LoadLookup_FarmIntendedUse(DbManagerProxy manager, FarmPanel obj)
            {
            ...
            private void _LoadLookups(DbManagerProxy manager, FarmPanel obj)
            {
            ...
            protected abstract void _post(DbManagerProxy manager, int Action, 
                [Direction.InputOutput("idfRootFarm", "strFarmCode", "idfRootOwner")] FarmPanel obj);
                ...
                false
                    ...
                    if (bDeepValidation)
                    {
                        ...
                        if (obj.FarmTree != null)
                            foreach (var i in obj.FarmTree.Where(c => !c.IsMarkedToDelete))
