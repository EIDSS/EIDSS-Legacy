...
namespace eidss.model.Schema
{
    ...
    public abstract partial class DiagnosisAgeGroupToDiagnosis : 
        ...
        protected class field_info
        {
            ...
            internal Action<DiagnosisAgeGroupToDiagnosis, DiagnosisAgeGroupToDiagnosis, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfDiagnosisAgeGroupToDiagnosis, _type = "Int64",
              _get_func = o => o.idfDiagnosisAgeGroupToDiagnosis,
              _set_func = (o, val) => { o.idfDiagnosisAgeGroupToDiagnosis = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
                if (o.idfDiagnosisAgeGroupToDiagnosis != c.idfDiagnosisAgeGroupToDiagnosis || o.IsRIRPropChanged(_str_idfDiagnosisAgeGroupToDiagnosis, c)) 
                  m.Add(_str_idfDiagnosisAgeGroupToDiagnosis, o.ObjectIdent + _str_idfDiagnosisAgeGroupToDiagnosis, "Int64", o.idfDiagnosisAgeGroupToDiagnosis == null ? "" : o.idfDiagnosisAgeGroupToDiagnosis.ToString(), o.IsReadOnly(_str_idfDiagnosisAgeGroupToDiagnosis), o.IsInvisible(_str_idfDiagnosisAgeGroupToDiagnosis), o.IsRequired(_str_idfDiagnosisAgeGroupToDiagnosis)); }
              }, 
            ...
            new field_info {
              ...
              _set_func = (o, val) => { o.idfsDiagnosisAgeGroup = ParsingHelper.ParseInt64Nullable(val); },
              _compare_func = (o, c, m) => {
      ...
      private bool IsRIRPropChanged(string fld, DiagnosisAgeGroupToDiagnosis c)
        ...
        public Dictionary<string, Func<DiagnosisAgeGroupToDiagnosis, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<DiagnosisAgeGroupToDiagnosis, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public partial class DiagnosisAgeGroupToDiagnosisGridModelList : List<DiagnosisAgeGroupToDiagnosisGridModel>, IGridModelList
        {
        ...
        {
            private delegate void on_action(DiagnosisAgeGroupToDiagnosis obj);
            ...
            private List<DiagnosisAgeGroupToDiagnosis> _SelectList(DbManagerProxy manager
            ...
            internal void _SetupLoad(DbManagerProxy manager, DiagnosisAgeGroupToDiagnosis obj)
            {
                if (obj == null) return;
            ...
            private DiagnosisAgeGroupToDiagnosis _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    DiagnosisAgeGroupToDiagnosis obj = DiagnosisAgeGroupToDiagnosis.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.idfDiagnosisAgeGroupToDiagnosis = (new GetNewIDExtender<DiagnosisAgeGroupToDiagnosis>()).GetScalar(manager, obj);
            ...
            private void _LoadLookups(DbManagerProxy manager, DiagnosisAgeGroupToDiagnosis obj)
            {
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfDiagnosisAgeGroupToDiagnosis, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsDiagnosisAgeGroup,
                    "strAgeGroups", null, true, true, null
                    ));
