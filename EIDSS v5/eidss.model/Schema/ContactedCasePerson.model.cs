...
namespace eidss.model.Schema
{
    ...
    public abstract partial class ContactedCasePerson : 
        ...
        #if MONO
        protected Int64 idfsPersonContactType_Original { get { return idfsPersonContactType; } }
        protected Int64 idfsPersonContactType_Previous { get { return idfsPersonContactType; } }
        #else
        ...
        #if MONO
        protected DateTime? datDateOfLastContact_Original { get { return datDateOfLastContact; } }
        protected DateTime? datDateOfLastContact_Previous { get { return datDateOfLastContact; } }
        #else
        ...
        #if MONO
        protected String strPlaceInfo_Original { get { return strPlaceInfo; } }
        protected String strPlaceInfo_Previous { get { return strPlaceInfo; } }
        #else
        ...
        #if MONO
        protected String strPersonContactType_Original { get { return strPersonContactType; } }
        protected String strPersonContactType_Previous { get { return strPersonContactType; } }
        #else
        ...
        #if MONO
        protected String strPatientInformation_Original { get { return strPatientInformation; } }
        protected String strPatientInformation_Previous { get { return strPatientInformation; } }
        #else
        ...
        #if MONO
        protected Byte? bitIsRootMain_Original { get { return bitIsRootMain; } }
        protected Byte? bitIsRootMain_Previous { get { return bitIsRootMain; } }
        #else
        ...
        #if MONO
        protected String strPatientAddressString_Original { get { return strPatientAddressString; } }
        protected String strPatientAddressString_Previous { get { return strPatientAddressString; } }
        #else
        ...
        protected class field_info
        {
            ...
            internal Action<ContactedCasePerson, ContactedCasePerson, CompareModel> _compare_func;
        }
        ...
        internal const string _str_strRegistrationAddress = "strRegistrationAddress";
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfContactedCasePerson, _type = "Int64",
              _get_func = o => o.idfContactedCasePerson,
              _set_func = (o, val) => { o.idfContactedCasePerson = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
                if (o.idfContactedCasePerson != c.idfContactedCasePerson || o.IsRIRPropChanged(_str_idfContactedCasePerson, c)) 
                  m.Add(_str_idfContactedCasePerson, o.ObjectIdent + _str_idfContactedCasePerson, "Int64", o.idfContactedCasePerson == null ? "" : o.idfContactedCasePerson.ToString(), o.IsReadOnly(_str_idfContactedCasePerson), o.IsInvisible(_str_idfContactedCasePerson), o.IsRequired(_str_idfContactedCasePerson)); }
              }, 
            ...
            new field_info {
              _name = _str_idfsPersonContactType, _type = "Int64",
              _get_func = o => o.idfsPersonContactType,
              _set_func = (o, val) => { o.idfsPersonContactType = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
                if (o.idfsPersonContactType != c.idfsPersonContactType || o.IsRIRPropChanged(_str_idfsPersonContactType, c)) 
                  m.Add(_str_idfsPersonContactType, o.ObjectIdent + _str_idfsPersonContactType, "Int64", o.idfsPersonContactType == null ? "" : o.idfsPersonContactType.ToString(), o.IsReadOnly(_str_idfsPersonContactType), o.IsInvisible(_str_idfsPersonContactType), o.IsRequired(_str_idfsPersonContactType)); }
              }, 
        
            new field_info {
              _name = _str_datDateOfLastContact, _type = "DateTime?",
              _get_func = o => o.datDateOfLastContact,
              _set_func = (o, val) => { o.datDateOfLastContact = ParsingHelper.ParseDateTimeNullable(val); },
              _compare_func = (o, c, m) => {
                if (o.datDateOfLastContact != c.datDateOfLastContact || o.IsRIRPropChanged(_str_datDateOfLastContact, c)) 
                  m.Add(_str_datDateOfLastContact, o.ObjectIdent + _str_datDateOfLastContact, "DateTime?", o.datDateOfLastContact == null ? "" : o.datDateOfLastContact.ToString(), o.IsReadOnly(_str_datDateOfLastContact), o.IsInvisible(_str_datDateOfLastContact), o.IsRequired(_str_datDateOfLastContact)); }
              }, 
        
            new field_info {
              _name = _str_strPlaceInfo, _type = "String",
              _get_func = o => o.strPlaceInfo,
              _set_func = (o, val) => { o.strPlaceInfo = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.strPlaceInfo != c.strPlaceInfo || o.IsRIRPropChanged(_str_strPlaceInfo, c)) 
                  m.Add(_str_strPlaceInfo, o.ObjectIdent + _str_strPlaceInfo, "String", o.strPlaceInfo == null ? "" : o.strPlaceInfo.ToString(), o.IsReadOnly(_str_strPlaceInfo), o.IsInvisible(_str_strPlaceInfo), o.IsRequired(_str_strPlaceInfo)); }
              }, 
            ...
            new field_info {
              _name = _str_strPersonContactType, _type = "String",
              _get_func = o => o.strPersonContactType,
              _set_func = (o, val) => { o.strPersonContactType = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.strPersonContactType != c.strPersonContactType || o.IsRIRPropChanged(_str_strPersonContactType, c)) 
                  m.Add(_str_strPersonContactType, o.ObjectIdent + _str_strPersonContactType, "String", o.strPersonContactType == null ? "" : o.strPersonContactType.ToString(), o.IsReadOnly(_str_strPersonContactType), o.IsInvisible(_str_strPersonContactType), o.IsRequired(_str_strPersonContactType)); }
              }, 
        
            new field_info {
              _name = _str_strPatientInformation, _type = "String",
              _get_func = o => o.strPatientInformation,
              _set_func = (o, val) => { o.strPatientInformation = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.strPatientInformation != c.strPatientInformation || o.IsRIRPropChanged(_str_strPatientInformation, c)) 
                  m.Add(_str_strPatientInformation, o.ObjectIdent + _str_strPatientInformation, "String", o.strPatientInformation == null ? "" : o.strPatientInformation.ToString(), o.IsReadOnly(_str_strPatientInformation), o.IsInvisible(_str_strPatientInformation), o.IsRequired(_str_strPatientInformation)); }
              }, 
        
            new field_info {
              _name = _str_bitIsRootMain, _type = "Byte?",
              _get_func = o => o.bitIsRootMain,
              _set_func = (o, val) => { ; },
              _compare_func = (o, c, m) => {
                if (o.bitIsRootMain != c.bitIsRootMain || o.IsRIRPropChanged(_str_bitIsRootMain, c)) 
                  m.Add(_str_bitIsRootMain, o.ObjectIdent + _str_bitIsRootMain, "Byte?", o.bitIsRootMain == null ? "" : o.bitIsRootMain.ToString(), o.IsReadOnly(_str_bitIsRootMain), o.IsInvisible(_str_bitIsRootMain), o.IsRequired(_str_bitIsRootMain)); }
              }, 
            ...
            new field_info {
              _name = _str_strPatientAddressString, _type = "String",
              _get_func = o => o.strPatientAddressString,
              _set_func = (o, val) => { o.strPatientAddressString = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                if (o.strPatientAddressString != c.strPatientAddressString || o.IsRIRPropChanged(_str_strPatientAddressString, c)) 
                  m.Add(_str_strPatientAddressString, o.ObjectIdent + _str_strPatientAddressString, "String", o.strPatientAddressString == null ? "" : o.strPatientAddressString.ToString(), o.IsReadOnly(_str_strPatientAddressString), o.IsInvisible(_str_strPatientAddressString), o.IsRequired(_str_strPatientAddressString)); }
              }, 
            ...
            new field_info {
              _name = _str_GeoLocationNameWithHiddenPersonalData, _type = "string",
              _get_func = o => o.GeoLocationNameWithHiddenPersonalData,
              _set_func = (o, val) => { o.GeoLocationNameWithHiddenPersonalData = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
                ...
                if (o.GeoLocationNameWithHiddenPersonalData != c.GeoLocationNameWithHiddenPersonalData || o.IsRIRPropChanged(_str_GeoLocationNameWithHiddenPersonalData, c)) 
                  m.Add(_str_GeoLocationNameWithHiddenPersonalData, o.ObjectIdent + _str_GeoLocationNameWithHiddenPersonalData, "string", o.GeoLocationNameWithHiddenPersonalData == null ? "" : o.GeoLocationNameWithHiddenPersonalData.ToString(), o.IsReadOnly(_str_GeoLocationNameWithHiddenPersonalData), o.IsInvisible(_str_GeoLocationNameWithHiddenPersonalData), o.IsRequired(_str_GeoLocationNameWithHiddenPersonalData));
                 }
              }, 
            ...
            new field_info {
              _name = _str_strRegistrationAddress, _type = "string",
              _get_func = o => o.strRegistrationAddress,
              _set_func = (o, val) => {},
              _compare_func = (o, c, m) => { 
              
                if (o.strRegistrationAddress != c.strRegistrationAddress || o.IsRIRPropChanged(_str_strRegistrationAddress, c)) 
                  m.Add(_str_strRegistrationAddress, o.ObjectIdent + _str_strRegistrationAddress, "string", o.strRegistrationAddress == null ? "" : o.strRegistrationAddress.ToString(), o.IsReadOnly(_str_strRegistrationAddress), o.IsInvisible(_str_strRegistrationAddress), o.IsRequired(_str_strRegistrationAddress));
                 }
              }, 
        
            new field_info {
              _name = _str_PersonContactType, _type = "Lookup",
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsPersonContactType != c.idfsPersonContactType || o.IsRIRPropChanged(_str_PersonContactType, c)) 
                  m.Add(_str_PersonContactType, o.ObjectIdent + _str_PersonContactType, "Lookup", o.idfsPersonContactType == null ? "" : o.idfsPersonContactType.ToString(), o.IsReadOnly(_str_PersonContactType), o.IsInvisible(_str_PersonContactType), o.IsRequired(_str_PersonContactType)); }
              }, 
        
            new field_info {
              _name = _str_Person, _type = "Relation",
              _get_func = o => null,
              _set_func = (o, val) => {},
              _compare_func = (o, c, m) => {
        ...
        public BaseReference PersonContactType
        {
            ...
            { 
                ...
                idfsPersonContactType = _PersonContactType == null 
                    ? new Int64()
                    : _PersonContactType.idfsBaseReference; 
        ...
        {
            get { return new Func<ContactedCasePerson, string>(c => c.Person.strLastName + " " + c.Person.strFirstName + " " + c.Person.strSecondName)(this); }
            
        }
        
          [XmlIgnore]
          [LocalizedDisplayName("strRegistrationAddress")]
        public string strRegistrationAddress
        {
            get { return new Func<ContactedCasePerson, string>(c => c._Person == null ? c.strPatientInformation : bv.common.Core.Utils.Join(", ", new List<string>(){ c._Person.RegistrationAddress != null ? c._Person.RegistrationAddress.strReadOnlyAdaptiveFullName : "", c._Person.strHomePhone }))(this); }
        ...
        public IObject CloneWithSetup(DbManagerProxy manager)
        {
            ...
            if (_Person != null)
              ret.Person = _Person.CloneWithSetup(manager) as Patient;
        ...
        public void DeepRejectChanges()
        {
            ...
            if (Person != null) Person.RejectChanges();
        ...
        { 
            ...
            if (_Person != null) _Person.AcceptChanges();
      ...
      private bool IsRIRPropChanged(string fld, ContactedCasePerson c)
        ...
        private void ContactedCasePerson_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == _str_Person)
                OnPropertyChanged(_str_strRegistrationAddress);
        ...
        private static string[] readonly_names1 = "strName,strRegistrationAddress".Split(new char[] { ',' });
        ...
        public Dictionary<string, Func<ContactedCasePerson, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<ContactedCasePerson, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public class ContactedCasePersonGridModel : IGridModelItem
        {
            ...
            public string strRegistrationAddress { get; set; }
        ...
        public partial class ContactedCasePersonGridModelList : List<ContactedCasePersonGridModel>, IGridModelList
        {
            ...
            private void LoadGridModelList(long key, IEnumerable<ContactedCasePerson> items, string errMes)
            {
                ...
                Columns = new List<string> {_str_strFullName,_str_strPersonContactType,_str_datDateOfLastContact,_str_strPlaceInfo,_str_strRegistrationAddress,_str_GeoLocationNameWithHiddenPersonalData};
                ...
                {
                    ItemKey=c.idfContactedCasePerson,idfHuman=c.idfHuman,strFullName=c.strFullName,idfsPersonContactType=c.idfsPersonContactType,strPersonContactType=c.strPersonContactType,datDateOfLastContact=c.datDateOfLastContact,strPlaceInfo=c.strPlaceInfo,strRegistrationAddress=c.strRegistrationAddress,idfsSettlement=c.idfsSettlement,idfsRegion=c.idfsRegion,idfsRayon=c.idfsRayon,GeoLocationNameWithHiddenPersonalData=c.GeoLocationNameWithHiddenPersonalData
                }));
                if (Count > 0)
                {
        ...
        {
            private delegate void on_action(ContactedCasePerson obj);
            ...
            private List<ContactedCasePerson> _SelectList(DbManagerProxy manager
                , Int64? idfCase
            ...
            internal void _SetupLoad(DbManagerProxy manager, ContactedCasePerson obj)
            {
                if (obj == null) return;
            ...
            private ContactedCasePerson _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    ContactedCasePerson obj = ContactedCasePerson.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.idfContactedCasePerson = (new GetNewIDExtender<ContactedCasePerson>()).GetScalar(manager, obj);
                obj.Person = new Func<ContactedCasePerson, Patient>(c => PersonAccessor.Create(manager, c, c.idfHuman))(obj);
                obj.Person.idfRootHuman = (new GetNewIDExtender<ContactedCasePerson>()).GetScalar(manager, obj);
            ...
            public void LoadLookup_PersonContactType(DbManagerProxy manager, ContactedCasePerson obj)
            {
                ...
                if (obj.idfsPersonContactType != 0)
                {
                    obj.PersonContactType = obj.PersonContactTypeLookup
                        .Where(c => c.idfsBaseReference == obj.idfsPersonContactType)
                        .SingleOrDefault();
                }
              
                
                LookupManager.AddObject("rftContact_Type", obj, PersonContactTypeAccessor.GetType(), "rftContact_Type_SelectList"
                  , "SelectLookupList");
            }
            

            private void _LoadLookups(DbManagerProxy manager, ContactedCasePerson obj)
            {
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfContactedCasePerson, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfHuman,
                    _str_idfHuman, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFullName,
                    "strName", null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsPersonContactType,
                    _str_idfsPersonContactType, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strPersonContactType,
                    _str_strPersonContactType, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datDateOfLastContact,
                    _str_datDateOfLastContact, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strPlaceInfo,
                    _str_strPlaceInfo, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strRegistrationAddress,
                    "strRegistrationAddress", null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsSettlement,
