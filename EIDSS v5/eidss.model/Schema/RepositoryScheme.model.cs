...
namespace eidss.model.Schema
{
    ...
    public abstract partial class RepositoryScheme : 
        ...
        protected class field_info
        {
            ...
            internal Action<RepositoryScheme, RepositoryScheme, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, RepositoryScheme c)
        ...
        public Dictionary<string, Func<RepositoryScheme, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<RepositoryScheme, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(RepositoryScheme obj);
            ...
            internal void _SetupLoad(DbManagerProxy manager, RepositoryScheme obj)
            {
                if (obj == null) return;
            ...
            private RepositoryScheme _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    RepositoryScheme obj = RepositoryScheme.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, RepositoryScheme obj)
            {
