...
namespace eidss.model.Schema
{
    ...
    public abstract partial class AsSessionAction : 
        ...
        #if MONO
        protected Int64 idfsMonitoringSessionActionType_Original { get { return idfsMonitoringSessionActionType; } }
        protected Int64 idfsMonitoringSessionActionType_Previous { get { return idfsMonitoringSessionActionType; } }
        #else
        ...
        #if MONO
        protected Int64 idfsMonitoringSessionActionStatus_Original { get { return idfsMonitoringSessionActionStatus; } }
        protected Int64 idfsMonitoringSessionActionStatus_Previous { get { return idfsMonitoringSessionActionStatus; } }
        #else
        ...
        protected class field_info
        {
            ...
            internal Action<AsSessionAction, AsSessionAction, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfMonitoringSessionAction, _type = "Int64",
              _get_func = o => o.idfMonitoringSessionAction,
              _set_func = (o, val) => { o.idfMonitoringSessionAction = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
                if (o.idfMonitoringSessionAction != c.idfMonitoringSessionAction || o.IsRIRPropChanged(_str_idfMonitoringSessionAction, c)) 
                  m.Add(_str_idfMonitoringSessionAction, o.ObjectIdent + _str_idfMonitoringSessionAction, "Int64", o.idfMonitoringSessionAction == null ? "" : o.idfMonitoringSessionAction.ToString(), o.IsReadOnly(_str_idfMonitoringSessionAction), o.IsInvisible(_str_idfMonitoringSessionAction), o.IsRequired(_str_idfMonitoringSessionAction)); }
              }, 
            ...
            new field_info {
              ...
              _set_func = (o, val) => { o.idfPersonEnteredBy = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
            ...
            new field_info {
              _name = _str_idfsMonitoringSessionActionType, _type = "Int64",
              _get_func = o => o.idfsMonitoringSessionActionType,
              _set_func = (o, val) => { o.idfsMonitoringSessionActionType = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
                if (o.idfsMonitoringSessionActionType != c.idfsMonitoringSessionActionType || o.IsRIRPropChanged(_str_idfsMonitoringSessionActionType, c)) 
                  m.Add(_str_idfsMonitoringSessionActionType, o.ObjectIdent + _str_idfsMonitoringSessionActionType, "Int64", o.idfsMonitoringSessionActionType == null ? "" : o.idfsMonitoringSessionActionType.ToString(), o.IsReadOnly(_str_idfsMonitoringSessionActionType), o.IsInvisible(_str_idfsMonitoringSessionActionType), o.IsRequired(_str_idfsMonitoringSessionActionType)); }
              }, 
        
            new field_info {
              _name = _str_idfsMonitoringSessionActionStatus, _type = "Int64",
              _get_func = o => o.idfsMonitoringSessionActionStatus,
              _set_func = (o, val) => { o.idfsMonitoringSessionActionStatus = ParsingHelper.ParseInt64(val); },
              _compare_func = (o, c, m) => {
                if (o.idfsMonitoringSessionActionStatus != c.idfsMonitoringSessionActionStatus || o.IsRIRPropChanged(_str_idfsMonitoringSessionActionStatus, c)) 
                  m.Add(_str_idfsMonitoringSessionActionStatus, o.ObjectIdent + _str_idfsMonitoringSessionActionStatus, "Int64", o.idfsMonitoringSessionActionStatus == null ? "" : o.idfsMonitoringSessionActionStatus.ToString(), o.IsReadOnly(_str_idfsMonitoringSessionActionStatus), o.IsInvisible(_str_idfsMonitoringSessionActionStatus), o.IsRequired(_str_idfsMonitoringSessionActionStatus)); }
              }, 
            ...
            new field_info {
              _name = _str_Action, _type = "int",
              _get_func = o => o.Action,
              _set_func = (o, val) => { o.Action = ParsingHelper.ParseInt32(val); },
              _compare_func = (o, c, m) => {
              
                if (o.Action != c.Action || o.IsRIRPropChanged(_str_Action, c)) 
                  m.Add(_str_Action, o.ObjectIdent + _str_Action, "int", o.Action == null ? "" : o.Action.ToString(), o.IsReadOnly(_str_Action), o.IsInvisible(_str_Action), o.IsRequired(_str_Action));
                 }
              }, 
        
            new field_info {
              _name = _str_strMonitoringSessionActionType, _type = "string",
              ...
              _compare_func = (o, c, m) => { 
                ...
                if (o.strMonitoringSessionActionType != c.strMonitoringSessionActionType || o.IsRIRPropChanged(_str_strMonitoringSessionActionType, c)) 
                  m.Add(_str_strMonitoringSessionActionType, o.ObjectIdent + _str_strMonitoringSessionActionType, "string", o.strMonitoringSessionActionType == null ? "" : o.strMonitoringSessionActionType.ToString(), o.IsReadOnly(_str_strMonitoringSessionActionType), o.IsInvisible(_str_strMonitoringSessionActionType), o.IsRequired(_str_strMonitoringSessionActionType));
                 }
              }, 
        
            new field_info {
              _name = _str_strMonitoringSessionActionStatus, _type = "string",
              ...
              _compare_func = (o, c, m) => { 
                ...
                if (o.strMonitoringSessionActionStatus != c.strMonitoringSessionActionStatus || o.IsRIRPropChanged(_str_strMonitoringSessionActionStatus, c)) 
                  m.Add(_str_strMonitoringSessionActionStatus, o.ObjectIdent + _str_strMonitoringSessionActionStatus, "string", o.strMonitoringSessionActionStatus == null ? "" : o.strMonitoringSessionActionStatus.ToString(), o.IsReadOnly(_str_strMonitoringSessionActionStatus), o.IsInvisible(_str_strMonitoringSessionActionStatus), o.IsRequired(_str_strMonitoringSessionActionStatus));
                 }
              }, 
        
            new field_info {
              _name = _str_MonitoringSessionActionStatus, _type = "Lookup",
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsMonitoringSessionActionStatus != c.idfsMonitoringSessionActionStatus || o.IsRIRPropChanged(_str_MonitoringSessionActionStatus, c)) 
                  m.Add(_str_MonitoringSessionActionStatus, o.ObjectIdent + _str_MonitoringSessionActionStatus, "Lookup", o.idfsMonitoringSessionActionStatus == null ? "" : o.idfsMonitoringSessionActionStatus.ToString(), o.IsReadOnly(_str_MonitoringSessionActionStatus), o.IsInvisible(_str_MonitoringSessionActionStatus), o.IsRequired(_str_MonitoringSessionActionStatus)); }
              }, 
        
            new field_info {
              _name = _str_MonitoringSessionActionType, _type = "Lookup",
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsMonitoringSessionActionType != c.idfsMonitoringSessionActionType || o.IsRIRPropChanged(_str_MonitoringSessionActionType, c)) 
                  m.Add(_str_MonitoringSessionActionType, o.ObjectIdent + _str_MonitoringSessionActionType, "Lookup", o.idfsMonitoringSessionActionType == null ? "" : o.idfsMonitoringSessionActionType.ToString(), o.IsReadOnly(_str_MonitoringSessionActionType), o.IsInvisible(_str_MonitoringSessionActionType), o.IsRequired(_str_MonitoringSessionActionType)); }
              }, 
        ...
        public BaseReference MonitoringSessionActionStatus
        {
            ...
            { 
                ...
                idfsMonitoringSessionActionStatus = _MonitoringSessionActionStatus == null 
                    ? new Int64()
                    : _MonitoringSessionActionStatus.idfsBaseReference; 
        ...
        public BaseReference MonitoringSessionActionType
        {
            ...
            { 
                ...
                idfsMonitoringSessionActionType = _MonitoringSessionActionType == null 
                    ? new Int64()
                    : _MonitoringSessionActionType.idfsBaseReference; 
      ...
      private bool IsRIRPropChanged(string fld, AsSessionAction c)
        ...
        public Dictionary<string, Func<AsSessionAction, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<AsSessionAction, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public partial class AsSessionActionGridModelList : List<AsSessionActionGridModel>, IGridModelList
        {
        ...
        {
            private delegate void on_action(AsSessionAction obj);
            ...
            private List<AsSessionAction> _SelectList(DbManagerProxy manager
                , Int64? idfMonitoringSession
            ...
            internal void _SetupLoad(DbManagerProxy manager, AsSessionAction obj)
            {
                if (obj == null) return;
            ...
            private AsSessionAction _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    AsSessionAction obj = AsSessionAction.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.idfMonitoringSessionAction = (new GetNewIDExtender<AsSessionAction>()).GetScalar(manager, obj);
                obj.Action = 4;
            ...
            public void LoadLookup_MonitoringSessionActionStatus(DbManagerProxy manager, AsSessionAction obj)
            {
                ...
                if (obj.idfsMonitoringSessionActionStatus != 0)
                {
                    obj.MonitoringSessionActionStatus = obj.MonitoringSessionActionStatusLookup
                        .Where(c => c.idfsBaseReference == obj.idfsMonitoringSessionActionStatus)
                        .SingleOrDefault();
                }
              
                
                LookupManager.AddObject("rftMonitoringSessionActionStatus", obj, MonitoringSessionActionStatusAccessor.GetType(), "rftMonitoringSessionActionStatus_SelectList"
                  , "SelectLookupList");
            }
            ...
            public void LoadLookup_MonitoringSessionActionType(DbManagerProxy manager, AsSessionAction obj)
            {
                ...
                if (obj.idfsMonitoringSessionActionType != 0)
                {
                    obj.MonitoringSessionActionType = obj.MonitoringSessionActionTypeLookup
                        .Where(c => c.idfsBaseReference == obj.idfsMonitoringSessionActionType)
                        .SingleOrDefault();
                }
              
                
                LookupManager.AddObject("rftMonitoringSessionActionType", obj, MonitoringSessionActionTypeAccessor.GetType(), "rftMonitoringSessionActionType_SelectList"
                  , "SelectLookupList");
            }
            

            private void _LoadLookups(DbManagerProxy manager, AsSessionAction obj)
            {
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfMonitoringSessionAction, null, false, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strMonitoringSessionActionType,
                    "idfsMonitoringSessionActionType", null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datActionDate,
                    "AsSessionAction.datActionDate", null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strPersonEnteredBy,
                    _str_strPersonEnteredBy, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strComments,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    "idfsMonitoringSessionActionStatus", null, true, true, null
                    ));
