...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VectorType2PensideTestMaster : 
        ...
        protected class field_info
        {
            ...
            internal Action<VectorType2PensideTestMaster, VectorType2PensideTestMaster, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_VectorType2PensideTest, _type = "Child",
              _get_func = o => null,
              _set_func = (o, val) => {},
              _compare_func = (o, c, m) => {
                if (o.VectorType2PensideTest.Count != c.VectorType2PensideTest.Count || o.IsReadOnly(_str_VectorType2PensideTest) != c.IsReadOnly(_str_VectorType2PensideTest) || o.IsInvisible(_str_VectorType2PensideTest) != c.IsInvisible(_str_VectorType2PensideTest) || o.IsRequired(_str_VectorType2PensideTest) != c.IsRequired(_str_VectorType2PensideTest)) 
                  m.Add(_str_VectorType2PensideTest, o.ObjectIdent + _str_VectorType2PensideTest, "Child", o.idfsVectorType == null ? "" : o.idfsVectorType.ToString(), o.IsReadOnly(_str_VectorType2PensideTest), o.IsInvisible(_str_VectorType2PensideTest), o.IsRequired(_str_VectorType2PensideTest)); }
              }, 
        ...
        {
            RejectChanges();
        VectorType2PensideTest.RejectChanges();
                
        }
        public void DeepAcceptChanges()
        { 
            AcceptChanges();
        VectorType2PensideTest.AcceptChanges();
      ...
      private bool IsRIRPropChanged(string fld, VectorType2PensideTestMaster c)
        ...
        public Dictionary<string, Func<VectorType2PensideTestMaster, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<VectorType2PensideTestMaster, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(VectorType2PensideTestMaster obj);
                ...
                )
            {
                ...
                try
                {
                    ...
                    VectorType2PensideTestMaster obj = objs[0];
                    obj.m_CS = m_CS;
            ...
            internal void _SetupLoad(DbManagerProxy manager, VectorType2PensideTestMaster obj)
            {
                if (obj == null) return;
            ...
            private VectorType2PensideTestMaster _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    VectorType2PensideTestMaster obj = VectorType2PensideTestMaster.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                foreach(var o in obj.VectorType2PensideTest.Where(c => true))
                {
                    ...
                    {                    
                        ...
                        o.PropertyChanged += delegate(object sender, PropertyChangedEventArgs e)
                        {
                            try
                            {
                                if (e.PropertyName == "idfsPensideTest")
                                {
                                
                                  (new ReferenceDuplicateValueValidator("idfsPensideTest", "VectorType2PensideTest","idfsPensideTest",
                                  false
                                      )).Validate(obj, item, (master,i) => master.VectorType2PensideTest.Where(c => 
                                                            (long)c.Key != (long)i.Key 
                                                            && c.idfsPensideTestType == i.idfsPensideTestType
                            ...
                            catch(ValidationModelException ex)
                            {
                                if (!obj.OnValidation(ex.MessageId, ex.FieldName, ex.PropertyName, ex.Pars, ex.ValidatorType, ex.ShouldAsk))
                                {
                                    ...
                                    item.CancelMemberLastChanges("idfsPensideTest");
                ...
                foreach(var o in obj.VectorType2PensideTest.Where(c => true))
                {
                    ...
                    {                    
                        ...
                        o.PropertyChanged += delegate(object sender, PropertyChangedEventArgs e)
                        {
                            try
                            {
                                if (e.PropertyName == "idfsPensideTestType")
                                {
                                
                (new RequiredValidator( "idfsPensideTestType", "idfsPensideTestType","",
                false
              )).Validate(c => true, item, item.idfsPensideTestType);
                            ...
                            catch(ValidationModelException ex)
                            {
                                ...
                                {
                                    item.LockNotifyChanges();
                                    item.CancelMemberLastChanges("idfsPensideTestType");
                                    obj.OnValidationEnd(ex.MessageId, ex.FieldName, ex.PropertyName, ex.Pars, ex.ValidatorType, ex.ShouldAsk);
                                    item.UnlockNotifyChanges();
                                }
                            }
            ...
            private void _LoadLookups(DbManagerProxy manager, VectorType2PensideTestMaster obj)
            {
            ...
            public bool Validate(DbManagerProxy manager, VectorType2PensideTestMaster obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
                ...
                false
                    ...
                    if (bDeepValidation)
                    {
                        ...
                        if (obj.VectorType2PensideTest != null)
                            foreach (var i in obj.VectorType2PensideTest.Where(c => !c.IsMarkedToDelete))
