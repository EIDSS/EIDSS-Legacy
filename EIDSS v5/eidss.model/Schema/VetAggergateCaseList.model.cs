...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetAggregateCaseListItem : 
        ...
        protected class field_info
        {
            ...
            internal Action<VetAggregateCaseListItem, VetAggregateCaseListItem, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, VetAggregateCaseListItem c)
        ...
        public Dictionary<string, Func<VetAggregateCaseListItem, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<VetAggregateCaseListItem, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public partial class VetAggregateCaseListItemGridModelList : List<VetAggregateCaseListItemGridModel>, IGridModelList
        {
        ...
        {
            private delegate void on_action(VetAggregateCaseListItem obj);
            ...
            private List<VetAggregateCaseListItem> _SelectList(DbManagerProxy manager
                ...
                )
            {
                ...
                {
                    sql.Append(" " + @"inner join tflAggrCaseFiltered f on f.idfAggrCase = fn_VetAggregateCase_SelectList.idfAggrCase and f.idfsSite = " + EidssSiteContext.Instance.SiteID.ToString());
                }
            ...
            internal void _SetupLoad(DbManagerProxy manager, VetAggregateCaseListItem obj)
            {
                if (obj == null) return;
            ...
            private VetAggregateCaseListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    VetAggregateCaseListItem obj = VetAggregateCaseListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                )
            {
                ...
                if (obj != null && !obj.GetPermissions().CanExecute("ActionEditVetAggregateCase"))
                    throw new PermissionException("VetCase", "ActionEditVetAggregateCase");
            ...
            private void _LoadLookups(DbManagerProxy manager, VetAggregateCaseListItem obj)
            {
    ...
    private void _SetupPersonalDataRestrictions(VetAggregateCaseListItem obj)
    {
            ...
            public string HelpIdWin { get { return "VetCaseAggregateDetailForm"; } }
            public string HelpIdWeb { get { return "web_vac_list"; } }
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(true, ObjectAccessor.CreatorInterface<VetAggregateCase>().CreateNew(manager, null, pars == null ? null : (int?)pars[0])),
                    null,
                    new ActionMetaItem.VisualItem(
