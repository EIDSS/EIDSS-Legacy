...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VectorTypeReferenceMaster : 
        ...
        protected class field_info
        {
            ...
            internal Action<VectorTypeReferenceMaster, VectorTypeReferenceMaster, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_VectorTypes, _type = "Child",
              _get_func = o => null,
              _set_func = (o, val) => {},
              _compare_func = (o, c, m) => {
                if (o.VectorTypes.Count != c.VectorTypes.Count || o.IsReadOnly(_str_VectorTypes) != c.IsReadOnly(_str_VectorTypes) || o.IsInvisible(_str_VectorTypes) != c.IsInvisible(_str_VectorTypes) || o.IsRequired(_str_VectorTypes) != c.IsRequired(_str_VectorTypes)) 
                  m.Add(_str_VectorTypes, o.ObjectIdent + _str_VectorTypes, "Child", o.idfsReferenceType == null ? "" : o.idfsReferenceType.ToString(), o.IsReadOnly(_str_VectorTypes), o.IsInvisible(_str_VectorTypes), o.IsRequired(_str_VectorTypes)); }
              }, 
        ...
        {
            RejectChanges();
        VectorTypes.RejectChanges();
                
        }
        public void DeepAcceptChanges()
        { 
            AcceptChanges();
        VectorTypes.AcceptChanges();
      ...
      private bool IsRIRPropChanged(string fld, VectorTypeReferenceMaster c)
        ...
        public Dictionary<string, Func<VectorTypeReferenceMaster, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<VectorTypeReferenceMaster, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(VectorTypeReferenceMaster obj);
                ...
                )
            {
                ...
                try
                {
                    ...
                    VectorTypeReferenceMaster obj = objs[0];
                    obj.m_CS = m_CS;
            ...
            internal void _SetupLoad(DbManagerProxy manager, VectorTypeReferenceMaster obj)
            {
                if (obj == null) return;
            ...
            private VectorTypeReferenceMaster _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    VectorTypeReferenceMaster obj = VectorTypeReferenceMaster.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                        ...
                        o.PropertyChanged += delegate(object sender, PropertyChangedEventArgs e)
                        {
                            try
                            {
                                if (e.PropertyName == "strDefaultName")
                                {
                                  ...
                                  (new DuplicateValueValidator("strDefaultName", "VectorTypes","strDefaultName",
                                  false
                                      )).Validate(obj, item, 
                                        (master,i) => master.VectorTypes.Where(c => 
                        ...
                        o.PropertyChanged += delegate(object sender, PropertyChangedEventArgs e)
                        {
                            try
                            {
                                if (e.PropertyName == "strTranslatedName")
                                {
                                  ...
                                  (new DuplicateValueValidator("strTranslatedName", "VectorTypes","strTranslatedName",
                                  false
                                      )).Validate(obj, item, 
                                        (master,i) => master.VectorTypes.Where(c => 
                                                            (long)c.Key != (long)i.Key 
            ...
            private void _LoadLookups(DbManagerProxy manager, VectorTypeReferenceMaster obj)
            {
            ...
            public bool Post(DbManagerProxy manager, IObject obj, bool bChildObject = false)
            {
                ...
                try
                {
                    ...
                    if (!manager.IsTransactionStarted)
                    {
                        ...
                        manager.SetEventParams("ReferenceTableChanged", new object[] { eventType, null, "rftVectorType" });
                    ...
                    if (bTransactionStarted)
                    {
                        if (bSuccess)
                        {
                            ...
                            LookupManager.ClearByTable("rftVectorType");
            ...
            public bool Validate(DbManagerProxy manager, VectorTypeReferenceMaster obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
                ...
                false
                    ...
                    if (bDeepValidation)
                    {
                        ...
                        if (obj.VectorTypes != null)
                            foreach (var i in obj.VectorTypes.Where(c => !c.IsMarkedToDelete))
