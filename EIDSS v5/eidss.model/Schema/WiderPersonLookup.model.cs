...
namespace eidss.model.Schema
{
    ...
    public abstract partial class WiderPersonLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<WiderPersonLookup, WiderPersonLookup, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, WiderPersonLookup c)
        ...
        public Dictionary<string, Func<WiderPersonLookup, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<WiderPersonLookup, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(WiderPersonLookup obj);
            ...
            private List<WiderPersonLookup> _SelectList(DbManagerProxy manager
                , Int64? OfficeID
                , Int64? ID
            ...
            internal void _SetupLoad(DbManagerProxy manager, WiderPersonLookup obj)
            {
                if (obj == null) return;
            ...
            private WiderPersonLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    WiderPersonLookup obj = WiderPersonLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, WiderPersonLookup obj)
            {
