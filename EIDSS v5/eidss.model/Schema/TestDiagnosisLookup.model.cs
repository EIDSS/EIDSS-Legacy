...
namespace eidss.model.Schema
{
    ...
    public abstract partial class TestDiagnosisLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<TestDiagnosisLookup, TestDiagnosisLookup, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, TestDiagnosisLookup c)
        ...
        public Dictionary<string, Func<TestDiagnosisLookup, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<TestDiagnosisLookup, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(TestDiagnosisLookup obj);
            ...
            private List<TestDiagnosisLookup> _SelectList(DbManagerProxy manager
                , Int64? idfMaterial
            ...
            internal void _SetupLoad(DbManagerProxy manager, TestDiagnosisLookup obj)
            {
                if (obj == null) return;
            ...
            private TestDiagnosisLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    TestDiagnosisLookup obj = TestDiagnosisLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, TestDiagnosisLookup obj)
            {
