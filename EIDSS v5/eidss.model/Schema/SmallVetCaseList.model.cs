...
namespace eidss.model.Schema
{
    ...
    public abstract partial class SmallVetCaseListItem : 
        ...
        protected class field_info
        {
            ...
            internal Action<SmallVetCaseListItem, SmallVetCaseListItem, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, SmallVetCaseListItem c)
        ...
        public Dictionary<string, Func<SmallVetCaseListItem, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<SmallVetCaseListItem, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public partial class SmallVetCaseListItemGridModelList : List<SmallVetCaseListItemGridModel>, IGridModelList
        {
            ...
            private void LoadGridModelList(long key, IEnumerable<SmallVetCaseListItem> items, string errMes)
            {
                ...
                {
                    ItemKey=c.idfCase,strCaseID=c.strCaseID,datEnteredDate=c.datEnteredDate,DiagnosisName=c.DiagnosisName,AddressName=c.AddressName,FarmName=c.FarmName
                }));
                if (Count > 0)
                {
        ...
        {
            private delegate void on_action(SmallVetCaseListItem obj);
            ...
            private List<SmallVetCaseListItem> _SelectList(DbManagerProxy manager
          ...
          ");
            ...
            internal void _SetupLoad(DbManagerProxy manager, SmallVetCaseListItem obj)
            {
                if (obj == null) return;
            ...
            private SmallVetCaseListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    SmallVetCaseListItem obj = SmallVetCaseListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, SmallVetCaseListItem obj)
            {
      ...
      if (EidssUserContext.User.ForbiddenPersonalDataGroups.Contains(PersonalDataGroup.Vet_Farm_Details))
      {
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_DiagnosisName,
                    _str_DiagnosisName, null, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_AddressName,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_FarmName,
                    _str_FarmName, null, true, true, null
                    ));
