...
namespace eidss.model.Schema
{
    ...
    public abstract partial class RayonAggrLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<RayonAggrLookup, RayonAggrLookup, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, RayonAggrLookup c)
        ...
        public Dictionary<string, Func<RayonAggrLookup, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<RayonAggrLookup, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(RayonAggrLookup obj);
            ...
            private List<RayonAggrLookup> _SelectList(DbManagerProxy manager
                , Int64? RegionID
                , Int64? ID
                , Int64? idfsAggrCaseType
            ...
            internal void _SetupLoad(DbManagerProxy manager, RayonAggrLookup obj)
            {
                if (obj == null) return;
            ...
            private RayonAggrLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    RayonAggrLookup obj = RayonAggrLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, RayonAggrLookup obj)
            {
