...
namespace eidss.model.Schema
{
    ...
    public abstract partial class LabSampleLogBookListItem : 
        EditableObject<LabSampleLogBookListItem>
        , IObject
        , IDisposable
        , ILookupUsage
        {
        ...
        protected class field_info
        {
            ...
            internal Func<LabSampleLogBookListItem, object> _get_func;
            internal Action<LabSampleLogBookListItem, string> _set_func;
            internal Action<LabSampleLogBookListItem, LabSampleLogBookListItem, CompareModel> _compare_func;
        }
        ...
        internal CompareModel _compare(IObject o, CompareModel ret)
        {
            ...
            LabSampleLogBookListItem obj = (LabSampleLogBookListItem)o;
        ...
        internal string m_ObjectName = "LabSampleLogBookListItem";
        ...
        {
            var ret = base.Clone() as LabSampleLogBookListItem;
        ...
        public LabSampleLogBookListItem CloneWithSetup()
        {
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                return CloneWithSetup(manager) as LabSampleLogBookListItem;
            }
        }
        #endregion
      ...
      private bool IsRIRPropChanged(string fld, LabSampleLogBookListItem c)
        {
        ...
        public LabSampleLogBookListItem()
        {
        ...
        {
            PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(LabSampleLogBookListItem_PropertyChanged);
        }
        public void _RevokeMainHandler()
        {
            PropertyChanged -= new System.ComponentModel.PropertyChangedEventHandler(LabSampleLogBookListItem_PropertyChanged);
        }
        private void LabSampleLogBookListItem_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            (sender as LabSampleLogBookListItem).Changed(e.PropertyName);
        ...
        {
            LabSampleLogBookListItem obj = this;
        ...
        public Dictionary<string, Func<LabSampleLogBookListItem, bool>> m_isRequired;
        ...
        public void AddRequired(string name, Func<LabSampleLogBookListItem, bool> func)
        {
            if (m_isRequired == null) 
                m_isRequired = new Dictionary<string, Func<LabSampleLogBookListItem, bool>>();
            if (!m_isRequired.ContainsKey(name))
                m_isRequired.Add(name, func);
        }
    
    public Dictionary<string, Func<LabSampleLogBookListItem, bool>> m_isHiddenPersonalData;
    ...
    public void AddHiddenPersonalData(string name, Func<LabSampleLogBookListItem, bool> func)
    {
    if (m_isHiddenPersonalData == null)
    m_isHiddenPersonalData = new Dictionary<string, Func<LabSampleLogBookListItem, bool>>();
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public class LabSampleLogBookListItemGridModel : IGridModelItem
        {
        ...
        public partial class LabSampleLogBookListItemGridModelList : List<LabSampleLogBookListItemGridModel>, IGridModelList
        {
            ...
            public LabSampleLogBookListItemGridModelList(long key, IEnumerable items, string errMes)
            {
                LoadGridModelList(key, items as IEnumerable<LabSampleLogBookListItem>, errMes);
            }
            public LabSampleLogBookListItemGridModelList(long key, IEnumerable<LabSampleLogBookListItem> items)
            {
                LoadGridModelList(key, items, null);
            }
            partial void filter(List<LabSampleLogBookListItem> items);
            private void LoadGridModelList(long key, IEnumerable<LabSampleLogBookListItem> items, string errMes)
            {
                ListKey = key;
                ...
                Actions = new Dictionary<string, ActionMetaItem> {{_str_strBarcode, Accessor.Instance(null).Actions.SingleOrDefault(c => c.Name == "ActionEditLabSample")},{_str_TestType, Accessor.Instance(null).Actions.SingleOrDefault(c => c.Name == "ActionEditTest")}};
                var list = new List<LabSampleLogBookListItem>(items);
                filter(list);
                AddRange(list.Where(c => !c.IsMarkedToDelete).Select(c => new LabSampleLogBookListItemGridModel()
                {
        ...
        : DataAccessor<LabSampleLogBookListItem>
            , IObjectAccessor
            , IObjectMeta
            , IObjectValidator
        ...
        {
            private delegate void on_action(LabSampleLogBookListItem obj);
            ...
            public virtual List<LabSampleLogBookListItem> SelectListT(DbManagerProxy manager
            ...
            private List<LabSampleLogBookListItem> _SelectList(DbManagerProxy manager
                ...
                )
            {
                ...
                try
                {
                    ...
                    List<LabSampleLogBookListItem> objs = manager.ExecuteList<LabSampleLogBookListItem>();
            ...
            internal void _SetupLoad(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
                if (obj == null) return;
            ...
            internal void _SetPermitions(IObjectPermissions permissions, LabSampleLogBookListItem obj)
            {
                if (obj != null)
                {
            ...
            private LabSampleLogBookListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    LabSampleLogBookListItem obj = LabSampleLogBookListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.ContainerStatus = new Func<LabSampleLogBookListItem, BaseReference>(c => 
            ...
            public LabSampleLogBookListItem CreateNewT(DbManagerProxy manager, IObject Parent, int? HACode = null)
            {
            ...
            public LabSampleLogBookListItem CreateWithParamsT(DbManagerProxy manager, IObject Parent, List<object> pars)
            {
            ...
            public ActResult SelectTest(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
                
                return SelectTest(manager, obj
                    );
            }
            public ActResult SelectTest(DbManagerProxy manager, LabSampleLogBookListItem obj
                )
            {
            ...
            public ActResult DeleteTest(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
                
                return DeleteTest(manager, obj
                    );
            }
            public ActResult DeleteTest(DbManagerProxy manager, LabSampleLogBookListItem obj
                )
            {
            ...
            public ActResult EditSample(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
                
                return EditSample(manager, obj
                    );
            }
            public ActResult EditSample(DbManagerProxy manager, LabSampleLogBookListItem obj
                )
            {
            ...
            public ActResult EditTest(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
                
                return EditTest(manager, obj
                    );
            }
            public ActResult EditTest(DbManagerProxy manager, LabSampleLogBookListItem obj
                )
            {
            ...
            public ActResult MarkForDisposition(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
            ...
            public ActResult MarkForDisposition(DbManagerProxy manager, LabSampleLogBookListItem obj
                , object key
                , IObject item
                , object listPanel
                )
            ...
            public ActResult TransferOut(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
            ...
            public ActResult TransferOut(DbManagerProxy manager, LabSampleLogBookListItem obj
                , object key
                , IObject item
                , object listPanel
                )
            ...
            public ActResult AliquotsDerivatives(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
            ...
            public ActResult AliquotsDerivatives(DbManagerProxy manager, LabSampleLogBookListItem obj
                , object key
                , IObject item
                , object listPanel
                )
            ...
            public ActResult HumanAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
            ...
            public ActResult HumanAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj
                , object key
                , IObject item
                , object listPanel
                )
            ...
            public ActResult VetAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
            ...
            public ActResult VetAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj
                , object key
                , IObject item
                , object listPanel
                )
            ...
            public ActResult AsAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
            ...
            public ActResult AsAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj
                , object key
                , IObject item
                , object listPanel
                )
            ...
            public ActResult VsAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
            ...
            public ActResult VsAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj
                , object key
                , IObject item
                , object listPanel
                )
            ...
            public ActResult GroupAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
            ...
            public ActResult GroupAccessionIn(DbManagerProxy manager, LabSampleLogBookListItem obj
                , object key
                , IObject item
                , object listPanel
                )
            ...
            public ActResult AddToPreferences(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
                ...
                return AddToPreferences(manager, obj
                    , (long)pars[0]
                    );
            }
            public ActResult AddToPreferences(DbManagerProxy manager, LabSampleLogBookListItem obj
                , long id
                )
            {
                
                if (obj != null && !obj.GetPermissions().CanExecute("AddToPreferences"))
                    throw new PermissionException("Sample", "AddToPreferences");
            ...
            public ActResult ActionEditLabSample(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
                
                return ActionEditLabSample(manager, obj
                    );
            }
            public ActResult ActionEditLabSample(DbManagerProxy manager, LabSampleLogBookListItem obj
                )
            {
                
                if (obj != null && !obj.GetPermissions().CanExecute("ActionEditLabSample"))
                    throw new PermissionException("Sample", "ActionEditLabSample");
                
                return true;
                
            }
            
            public ActResult ActionEditTest(DbManagerProxy manager, LabSampleLogBookListItem obj, List<object> pars)
            {
                
                return ActionEditTest(manager, obj
                    );
            }
            public ActResult ActionEditTest(DbManagerProxy manager, LabSampleLogBookListItem obj
                )
            {
                
                if (obj != null && !obj.GetPermissions().CanExecute("ActionEditTest"))
                    throw new PermissionException("Sample", "ActionEditTest");
                
                return true;
                
            }
            
            private void _SetupChildHandlers(LabSampleLogBookListItem obj, object newobj)
            {
                
            }
            
            private void _SetupHandlers(LabSampleLogBookListItem obj)
            {
                
            }
    
            public void LoadLookup_Diagnosis(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
            ...
            public void LoadLookup_SampleType(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
            ...
            public void LoadLookup_TestTypeRef(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
            ...
            public void LoadLookup_TestResultRef(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
            ...
            public void LoadLookup_TestForDiseaseType(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
            ...
            public void LoadLookup_TestStatus(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
            ...
            public void LoadLookup_ContainerStatus(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
            ...
            private void _LoadLookups(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
            ...
            public bool Post(DbManagerProxy manager, IObject obj, bool bChildObject = false)
            {
                ...
                try
                {
                    LabSampleLogBookListItem bo = obj as LabSampleLogBookListItem;
                    ...
                    bSuccess = _PostNonTransaction(manager, obj as LabSampleLogBookListItem, bChildObject);
                    if (bTransactionStarted)
                    {
                        if (bSuccess)
                        {
            ...
            private bool _PostNonTransaction(DbManagerProxy manager, LabSampleLogBookListItem obj, bool bChildObject) 
            { 
            ...
            public bool ValidateCanDelete(LabSampleLogBookListItem obj)
            {
                using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
                {
            ...
            public bool ValidateCanDelete(DbManagerProxy manager, LabSampleLogBookListItem obj)
            {
            ...
            {
                return Validate(manager, obj as LabSampleLogBookListItem, bPostValidation, bChangeValidation, bDeepValidation, bRethrowException);
            }
            public bool Validate(DbManagerProxy manager, LabSampleLogBookListItem obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
            ...
            private void _SetupRequired(LabSampleLogBookListItem obj)
            {
            
            }
    
    private void _SetupPersonalDataRestrictions(LabSampleLogBookListItem obj)
    {
            ...
            public bool RequiredByField(string name, IObject obj) { return Meta.RequiredByField.ContainsKey(name) ? Meta.RequiredByField[name](obj as LabSampleLogBookListItem) : false; }
            public bool RequiredByProperty(string name, IObject obj) { return Meta.RequiredByProperty.ContainsKey(name) ? Meta.RequiredByProperty[name](obj as LabSampleLogBookListItem) : false; }
            public List<SearchPanelMetaItem> SearchPanelMeta { get { return Meta.SearchPanelMeta; } }
            public List<GridMetaItem> GridMeta { get { return Meta.GridMeta; } }
            public List<ActionMetaItem> Actions { get { return Meta.Actions; } }
            public string DetailPanel { get { return "LabSampleLogBookListItemDetail"; } }
        ...
        {
            private LabSampleLogBookListItem m_obj;
            internal Permissions(LabSampleLogBookListItem obj)
            {
                m_obj = obj;
            }
        ...
        public static class Meta
        {
            ...
            public static Dictionary<string, Func<LabSampleLogBookListItem, bool>> RequiredByField = new Dictionary<string, Func<LabSampleLogBookListItem, bool>>();
            public static Dictionary<string, Func<LabSampleLogBookListItem, bool>> RequiredByProperty = new Dictionary<string, Func<LabSampleLogBookListItem, bool>>();
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).SelectTest(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).DeleteTest(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).EditSample(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).EditTest(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).MarkForDisposition(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).TransferOut(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).AliquotsDerivatives(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).HumanAccessionIn(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).VetAccessionIn(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).AsAccessionIn(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).VsAccessionIn(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).GroupAccessionIn(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).AddToPreferences(manager, (LabSampleLogBookListItem)c, pars),
                        
                    null,
                    
                    new ActionMetaItem.VisualItem(
                        /*from BvMessages*/"titleAddToPreferences",
                        "add",
                        /*from BvMessages*/"titleAddToPreferences",
                        /*from BvMessages*/"",
                        "",
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).ActionEditLabSample(manager, (LabSampleLogBookListItem)c, pars),
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    (manager, c, pars) => Accessor.Instance(null).ActionEditTest(manager, (LabSampleLogBookListItem)c, pars),
