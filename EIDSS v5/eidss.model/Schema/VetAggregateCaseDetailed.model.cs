...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetAggregateCaseDetailed : 
      ...
      private bool IsRIRPropChanged(string fld, VetAggregateCaseDetailed c)
        ...
        public Dictionary<string, Func<VetAggregateCaseDetailed, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<VetAggregateCaseDetailed, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
                    ...
                    
        {
            ...
            internal void _SetupLoad(DbManagerProxy manager, VetAggregateCaseDetailed obj)
            {
                if (obj == null) return;
            ...
            private VetAggregateCaseDetailed _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
