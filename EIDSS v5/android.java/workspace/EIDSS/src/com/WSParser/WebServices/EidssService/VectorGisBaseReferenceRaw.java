...
public class VectorGisBaseReferenceRaw extends Vector<GisBaseReferenceRaw> implements KvmSerializable{

    public VectorGisBaseReferenceRaw(){}
    
    public VectorGisBaseReferenceRaw(SoapObject soapObject)
    {
        if (soapObject != null){
            ...
            for (int i0=0;i0<size;i0++){
                ...
                if (obj != null && obj.getClass().equals(SoapObject.class)){
                    ...
                    GisBaseReferenceRaw j1= new GisBaseReferenceRaw(j0);
                    add(j1);
                }
            }
        }
    ...
    public void getPropertyInfo(int arg0, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo arg2) {
        arg2.name = "GisBaseReferenceRaw";
        arg2.type = GisBaseReferenceRaw.class;
    }

    @Override
    public void setProperty(int arg0, Object arg1) {
        this.add((GisBaseReferenceRaw)arg1);
    }
