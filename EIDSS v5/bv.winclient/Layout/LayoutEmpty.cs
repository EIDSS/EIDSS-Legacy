...
{
    public partial class LayoutEmpty : UserControl, ILayout
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <param name="bo"></param>
        void OnAfterActionExecutedRaised(IBasePanel panel, ActionMetaItem action, IObject bo)
        {
        ...
        void OnBeforeActionExecutingRaised(IBasePanel panel, ActionMetaItem action, IObject bo, ref bool cancel)
        {
