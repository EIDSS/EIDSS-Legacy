...
namespace bv.tests.Reports
{
    ...
    public class BaseReportDataTests
    {
        ...
        {
            var report = new BaseReportStub();
            report.FillSummaryDataWithMultiKey(true);
