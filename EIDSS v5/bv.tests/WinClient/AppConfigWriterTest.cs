...
{
    ///<summary>
    ///  This is a test class for AppConfigWriterTest and is intended to contain all AppConfigWriterTest Unit Tests
    ///</summary>
    [TestClass]
    public class AppConfigWriterTest
    {
        ...
        {
            UserConfigWriter.m_TestUserConfigName = Path.GetTempPath() + "user_v5.config";
            AppConfigWriter.m_TestAppConfigName = Path.GetTempPath() + "app_v5.config";
