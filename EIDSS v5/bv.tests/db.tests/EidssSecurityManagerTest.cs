...
namespace bv.tests
{
    ...
    public class EidssSecurityManagerTest
    {
        ...
        {
            EidssSecurityManager_Accessor target = new EidssSecurityManager_Accessor();
        ...
        public void GetPermissionsTest()
        {
            ...
            foreach (bool value in actual.Values)
            {
                Assert.IsTrue(value);
            }
        ...
        {
            EidssSecurityManager_Accessor target = new EidssSecurityManager_Accessor(); // TODO: Initialize to an appropriate value
            string password = "test";
