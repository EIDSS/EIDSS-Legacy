...
namespace bv.tests.Schema
{
    ...
    public abstract partial class Lookup2ListItem : 
        ...
        protected class field_info
        {
            ...
            internal Action<Lookup2ListItem, Lookup2ListItem, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, Lookup2ListItem c)
        ...
        public Dictionary<string, Func<Lookup2ListItem, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<Lookup2ListItem, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        public partial class Lookup2ListItemGridModelList : List<Lookup2ListItemGridModel>, IGridModelList
        {
        ...
        {
            private delegate void on_action(Lookup2ListItem obj);
            ...
            private List<Lookup2ListItem> _SelectList(DbManagerProxy manager
            ...
            internal void _SetupLoad(DbManagerProxy manager, Lookup2ListItem obj)
            {
                if (obj == null) return;
            ...
            private Lookup2ListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    Lookup2ListItem obj = Lookup2ListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, Lookup2ListItem obj)
            {
        ...
        public static class Meta
        {
            ...
            static Meta()
            {
                ...
                SearchPanelMeta.Add(new SearchPanelMetaItem(
                    ...
                    false, false, 
                    "lblID",
                    () => DateTime.Now.ToString(), null, true, false, SearchPanelLocation.Main, false, null, null, null, null, null
                    ));
                SearchPanelMeta.Add(new SearchPanelMetaItem(
                    "par11",
                    EditorType.Text,
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    String.Empty,
                    String.Empty,
                    (manager, c, pars) => new ActResult(true, ObjectAccessor.CreatorInterface<Lookup2Table>().CreateNew(manager, null, pars == null ? null : (int?)pars[0])),
                    null,
                    new ActionMetaItem.VisualItem(
