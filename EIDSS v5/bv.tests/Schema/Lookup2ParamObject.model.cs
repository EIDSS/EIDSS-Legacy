...
namespace bv.tests.Schema
{
    ...
    public abstract partial class Lookup2ParamTable : 
        ...
        protected class field_info
        {
            ...
            internal Action<Lookup2ParamTable, Lookup2ParamTable, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, Lookup2ParamTable c)
        ...
        public Dictionary<string, Func<Lookup2ParamTable, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<Lookup2ParamTable, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(Lookup2ParamTable obj);
            ...
            private List<Lookup2ParamTable> _SelectList(DbManagerProxy manager
                , Int32? ParentID
            ...
            internal void _SetupLoad(DbManagerProxy manager, Lookup2ParamTable obj)
            {
                if (obj == null) return;
            ...
            private Lookup2ParamTable _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    Lookup2ParamTable obj = Lookup2ParamTable.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, Lookup2ParamTable obj)
            {
