...
namespace bv.tests.Schema
{
    ...
    public abstract partial class ListPanelObject : 
        ...
        protected class field_info
        {
            ...
            internal Action<ListPanelObject, ListPanelObject, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, ListPanelObject c)
        ...
        public Dictionary<string, Func<ListPanelObject, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<ListPanelObject, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(ListPanelObject obj);
            ...
            internal void _SetupLoad(DbManagerProxy manager, ListPanelObject obj)
            {
                if (obj == null) return;
            ...
            private ListPanelObject _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    ListPanelObject obj = ListPanelObject.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, ListPanelObject obj)
            {
