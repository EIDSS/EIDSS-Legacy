...
namespace bv.tests.Schema
{
    ...
    public abstract partial class Lookup2Table : 
        ...
        protected class field_info
        {
            ...
            internal Action<Lookup2Table, Lookup2Table, CompareModel> _compare_func;
        }
      ...
      private bool IsRIRPropChanged(string fld, Lookup2Table c)
        ...
        public Dictionary<string, Func<Lookup2Table, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<Lookup2Table, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(Lookup2Table obj);
            ...
            private List<Lookup2Table> _SelectList(DbManagerProxy manager
            ...
            internal void _SetupLoad(DbManagerProxy manager, Lookup2Table obj)
            {
                if (obj == null) return;
            ...
            private Lookup2Table _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    Lookup2Table obj = Lookup2Table.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, Lookup2Table obj)
            {
