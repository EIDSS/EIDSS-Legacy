...
namespace bv.tests.Schema
{
    ...
    public abstract partial class MasterTable : 
        ...
        protected class field_info
        {
            ...
            internal Action<MasterTable, MasterTable, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_InnerDate, _type = "DateTime?",
              _get_func = o => o.InnerDate,
              _set_func = (o, val) => { o.InnerDate = ParsingHelper.ParseDateTimeNullable(val); },
              _compare_func = (o, c, m) => {
              
                if (o.InnerDate != c.InnerDate || o.IsRIRPropChanged(_str_InnerDate, c)) 
                  m.Add(_str_InnerDate, o.ObjectIdent + _str_InnerDate, "DateTime?", o.InnerDate == null ? "" : o.InnerDate.ToString(), o.IsReadOnly(_str_InnerDate), o.IsInvisible(_str_InnerDate), o.IsRequired(_str_InnerDate));
                 }
              }, 
        
            new field_info {
              _name = _str_ChildrenCount, _type = "int",
              _get_func = o => o.ChildrenCount,
              _set_func = (o, val) => { o.ChildrenCount = ParsingHelper.ParseInt32(val); },
              _compare_func = (o, c, m) => {
              
                if (o.ChildrenCount != c.ChildrenCount || o.IsRIRPropChanged(_str_ChildrenCount, c)) 
                  m.Add(_str_ChildrenCount, o.ObjectIdent + _str_ChildrenCount, "int", o.ChildrenCount == null ? "" : o.ChildrenCount.ToString(), o.IsReadOnly(_str_ChildrenCount), o.IsInvisible(_str_ChildrenCount), o.IsRequired(_str_ChildrenCount));
                 }
              }, 
        
            new field_info {
              _name = _str_TestString, _type = "string",
              _get_func = o => o.TestString,
              _set_func = (o, val) => { o.TestString = ParsingHelper.ParseString(val); },
              _compare_func = (o, c, m) => {
              
                if (o.TestString != c.TestString || o.IsRIRPropChanged(_str_TestString, c)) 
                  m.Add(_str_TestString, o.ObjectIdent + _str_TestString, "string", o.TestString == null ? "" : o.TestString.ToString(), o.IsReadOnly(_str_TestString), o.IsInvisible(_str_TestString), o.IsRequired(_str_TestString));
                 }
              }, 
            ...
            new field_info {
              _name = _str_Lookup2Param, _type = "Lookup",
              ...
              _compare_func = (o, c, m) => {
                if (o.LookupField2 != c.LookupField2 || o.IsRIRPropChanged(_str_Lookup2Param, c)) 
                  m.Add(_str_Lookup2Param, o.ObjectIdent + _str_Lookup2Param, "Lookup", o.LookupField2 == null ? "" : o.LookupField2.ToString(), o.IsReadOnly(_str_Lookup2Param), o.IsInvisible(_str_Lookup2Param), o.IsRequired(_str_Lookup2Param)); }
              }, 
            ...
            new field_info {
              _name = _str_Sibling, _type = "Relation",
              _get_func = o => null,
              _set_func = (o, val) => {},
              _compare_func = (o, c, m) => {
        ...
        public IObject CloneWithSetup(DbManagerProxy manager)
        {
            ...
            if (_Sibling != null)
              ret.Sibling = _Sibling.CloneWithSetup(manager) as SiblingObject;
                
            if (_Link != null)
              ret.Link = _Link.CloneWithSetup(manager) as LinkObject;
        ...
        Children.RejectChanges();
            ...
            if (Sibling != null) Sibling.RejectChanges();
        ...
        Children.AcceptChanges();
            ...
            if (_Sibling != null) _Sibling.AcceptChanges();
      ...
      private bool IsRIRPropChanged(string fld, MasterTable c)
        ...
        public Dictionary<string, Func<MasterTable, bool>> m_isRequired;
    ...
    public Dictionary<string, Func<MasterTable, bool>> m_isHiddenPersonalData;
    ...
    m_isHiddenPersonalData.Add(name, func);
        ...
        {
            private delegate void on_action(MasterTable obj);
            ...
            internal void _SetupLoad(DbManagerProxy manager, MasterTable obj)
            {
                if (obj == null) return;
            ...
            private MasterTable _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created)
            {
                try
                {
                    MasterTable obj = MasterTable.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public void LoadLookup_Lookup2Param(DbManagerProxy manager, MasterTable obj)
            {
                ...
                LookupManager.AddObject("Lookup2ParamTable", obj, Lookup2ParamAccessor.GetType(), "SelectLookupList");
            }
            

            private void _LoadLookups(DbManagerProxy manager, MasterTable obj)
            {
