(function ($) {
    ...
    function defineViewedMonth(selectedValue, minValue, maxValue) {
        ...
        if (selectedValue) {
            today = new $t.datetime(selectedValue.toDate());
        }

        if (minValue.value > today.value) {
            today = new $t.datetime(minValue.value);
        } else if (maxValue.value < today.value) {
            today = new $t.datetime(maxValue.value);
        }
