(function ($) {
    ...
    function defineFocusedDate(focusedValue, selectedValue, minValue, maxValue) {
        ...
        if (minValue.value > focusedValue.value) {
            focusedValue = new $t.datetime(minValue.value);
        } else if (maxValue.value < focusedValue.value) {
            focusedValue = new $t.datetime(maxValue.value);
        }
        return focusedValue;
    }
    ...
    */
    ...
    $t.dateView = function (options) {
        ...
        this.focusedValue = defineFocusedDate(new $t.datetime(), this.selectedValue, this.minValue, this.maxValue);
    ...
    $.each(["min", "max"], $.proxy(function (index, method) {
        ...
        function (value) {
            ...
            if (parsedValue !== null) {
                ...
                if (!$t.calendar.isInRange(this.selectedValue, this.minDate, this.maxDate)) {
