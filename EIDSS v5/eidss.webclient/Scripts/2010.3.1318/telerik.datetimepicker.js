(function ($) {
    ...
    $t.datetimepicker.prototype = {
        _change: function (newValue) {
            ...
            var formattedValue = (newValue && newValue.date) ? $t.datetime.format(newValue.toDate(), this.format) : newValue;
            if (parsedValue == null || this.inputValue != formattedValue) {
    ...
    $.each(["min", "max"], $.proxy(function (index, method) {
        ...
        function (value) {
            ...
            if (parsedValue !== null) {
                ...
                if (!$t.calendar.isInRange(this.selectedValue, this.minValue, this.maxValue))
