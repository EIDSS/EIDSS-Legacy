            ...
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(EidssUserContext.Instance))
            {
                return LabTestListItem.Accessor.Instance(null)
                    ...
                    .Select(
                        ...
                        {
                            Id = c.idfTesting,
                            Type = new BaseReferenceItem() { Id = c.idfsTestType, Name = c.TestTypeName != null ? c.TestTypeName.name : "" },
                            SampleID = c.strBarcode,
                            Category = new BaseReferenceItem() { Id = c.idfsTestForDiseaseType, Name = c.TestForDiseaseType != null ? c.TestForDiseaseType.name : "" },
