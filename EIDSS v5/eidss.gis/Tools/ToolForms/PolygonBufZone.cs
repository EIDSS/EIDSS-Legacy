...
{
    public partial class PolygonBufZone : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void PolygonBufZone_FormClosing(object sender, System.Windows.Forms.FormClosingEventArgs e)
        {
            ...
            {
                ErrorForm.ShowError(
                    new ErrorMessage("ErrMandatoryFieldRequired",
                        Resources.gis_BufZonesLayer_MandatoryFieldRequiredError, null,
                        labelControl1.Text));
