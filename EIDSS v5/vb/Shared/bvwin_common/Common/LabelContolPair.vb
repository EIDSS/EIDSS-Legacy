Public Class LabelControlPair
    ...
    Public Sub Arrange(ByVal left As Integer, ByVal top As Integer, ByVal captionWidth As Integer, ByVal controlWidth As Integer)
        ...
        Dim m_SingleControlWidth As Integer = CInt((controlWidth - (m_Controls.Length - 1) * XDistance) / m_Controls.Length)
        ...
        For i As Integer = 0 To m_Controls.Length - 1
            ...
            Else
                ctl.Width = m_SingleControlWidth
            End If
            x += m_SingleControlWidth + XDistance
        Next
    End Sub
End Class
