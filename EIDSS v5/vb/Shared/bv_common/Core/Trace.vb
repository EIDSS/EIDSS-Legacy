...
Public Class Trace
    ...
    Private Shared Sub Init()
        ...
        Try
            ...
            m_output = New DebugFileOutput(LogFileName, False)
    ...
    Private Shared ReadOnly Property LogFileName() As String
        Get
            If Utils.Str(bv.common.Configuration.Config.GetSetting("logfile")) <> "" Then
                Return bv.common.Configuration.Config.GetSetting("logfile")
            End If
