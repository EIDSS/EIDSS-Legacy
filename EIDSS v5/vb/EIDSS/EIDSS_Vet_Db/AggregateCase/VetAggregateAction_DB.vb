...
#End Region
    ...
    Public Const TableAggreagteHeader As String = "AggregateHeader"
    ...
    Public Overrides Function GetDetail(ByVal ID As Object) As DataSet
        ...
        Try
            ...
            AggregateCaseDetail_Adapter.Fill(ds, TableAggreagteHeader)
            CorrectTable(ds.Tables(0), TableAggreagteHeader)
            ...
            If ID Is Nothing Then
                ID = NewIntID()
                Dim r As DataRow = ds.Tables(TableAggreagteHeader).NewRow
                r("idfAggrCase") = ID
                ...
                ds.Tables(TableAggreagteHeader).Rows.Add(r)
    ...
    Public Overrides Function PostDetail(ByVal ds As DataSet, ByVal Post_Type As Integer, Optional ByVal transaction As IDbTransaction = Nothing) As Boolean
        ...
        Try
            ExecPostProcedure("spAggregateCaseHeader_Post", ds.Tables(TableAggreagteHeader), Connection, transaction)
        Catch ex As Exception
