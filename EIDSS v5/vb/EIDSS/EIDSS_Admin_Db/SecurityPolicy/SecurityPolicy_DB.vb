...
Public Class SecurityPolicy_DB : Inherits BaseDbService
    ...
    Public Overrides Function GetDetail(ByVal ID As Object) As System.Data.DataSet
        ...
        CreateAdapter(cmd, False).Fill(ds, Table)
    ...
    Public Overrides Function PostDetail(ByVal ds As System.Data.DataSet, ByVal PostType As Integer, Optional ByVal transaction As System.Data.IDbTransaction = Nothing) As Boolean
        ...
        'For Each row As DataRow In ds.Tables(Table).GetChanges().Rows
        Dim cmd As IDbCommand = CreateSPCommand("spSecurityPolicy_Post", transaction)
        'AddParam(cmd, "@strName", row("strName"))
        'AddParam(cmd, "@strValue", row("strValue"))
