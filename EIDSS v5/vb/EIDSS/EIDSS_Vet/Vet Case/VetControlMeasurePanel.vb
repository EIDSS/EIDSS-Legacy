...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'ContolMeasureGroup
        '
        Me.ContolMeasureGroup.Appearance.BackColor = System.Drawing.Color.Transparent
...
#Region "Flexible Form Support"
    ...
    Private Sub ShowFlexibleForm(ByVal row As DataRow)
        If row("idfsFormTemplate") Is DBNull.Value Then
            ffControlMeasures.ShowFlexibleFormByDeterminant(m_DiagnosisID, CLng(row("idfObservation")), FFType.LivestockControlMeasures)
