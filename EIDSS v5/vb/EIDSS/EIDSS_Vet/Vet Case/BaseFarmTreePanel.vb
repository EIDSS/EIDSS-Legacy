...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'FarmTreeGroup
        '
        Me.FarmTreeGroup.Appearance.BackColor = System.Drawing.Color.Transparent
        Me.FarmTreeGroup.Appearance.Options.UseBackColor = True
        Me.FarmTreeGroup.AppearanceCaption.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(204, Byte))
...
#End Region
    ...
    Private Function CanChangeSpecies(ByVal speciesRow As DataRow) As Boolean
        If Utils.Str(speciesRow("strName")) = "" OrElse _
                            BaseFarmTree_DB.UndefinedSpecies.Equals(speciesRow("strName")) Then
            Return True
        End If
    ...
    Public Function GetHerdSpieciesFilter(ByVal HerdID As Object) As String
        ...
        For Each row As DataRowView In dv
            If Utils.Str(row("strName")) <> "" AndAlso Utils.Str(row("strName")) <> Utils.Str(BaseFarmTree_DB.UndefinedSpecies) Then
                If species = "" Then
    ...
    Private Sub RefreshSpiecesList()
        ...
        For Each row As DataRowView In m_SpeciesView
            If Utils.Str(row("strName")) = Utils.Str(BaseFarmTree_DB.UndefinedSpecies) Then
                Continue For
            End If
