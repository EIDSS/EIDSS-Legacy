...
#Region "Main form interface"
    ...
    Public Shared Sub Register(ByVal ParentControl As Control)
        ...
        ma = New MenuAction(AddressOf ShowMe, MenuActionManager.Instance, MenuActionManager.Instance.Journals, "ToolbarFindVetAggregateSummaryCase", 308)
...
#End Region
    ...
    Public Overrides Function Post(Optional ByVal postType As PostType = bv.common.PostType.FinalPosting) As Boolean
        Return True
    End Function
