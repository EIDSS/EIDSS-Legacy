...
Public Class VetAggregateCaseDetail
    ...
    Public Sub New()
        ...
        AuditObject = New Core.EIDSSAuditObject(EIDSSAuditObject.daoAggregateVetCase, AuditTable.tlbAggrCase)
...
#Region "Main form interface"
    ...
    Public Shared Sub Register(ByVal ParentControl As System.Windows.Forms.Control)
        ...
        Dim ma As MenuAction = New MenuAction(AddressOf ShowMe, MenuActionManager.Instance, MenuActionManager.Instance.Create, "MenuNewVetAggregateCase", 435)
