Namespace ActiveSurveillance
    ...
    Partial Class AsSessionTableViewPanel
        ...
        Private Sub InitializeComponent()
            ...
            Me.TableViewGrid.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.txtFarmID, Me.cbSpecies, Me.cbAnimalAge, Me.cbAnimalSex, Me.cbSampleType, Me.dtCollectionDate, Me.cbAnimalCode})
            Me.TableViewGrid.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.TableView})
            '
            'TableView
            '
            Me.TableView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colFarmID, Me.colSpecies, Me.colAnimalID, Me.colAnimalAge, Me.colAnimalColor, Me.colAnimalSex, Me.colAnimalName, Me.colSampleType, Me.colFieldSampleID, Me.colCollectionDate})
            ...
            Me.colSampleType.FieldName = "idfsSpecimenType"
