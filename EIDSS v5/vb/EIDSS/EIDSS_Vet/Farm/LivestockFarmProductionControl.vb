...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        'Core.LookupBinder.BindBaseLookup(Me.rgGrazingPattern, baseDataSet, LivestockFarmProduction_DB.TableFarm + ".idfsGrazingPattern", BaseReferenceType.rftGrazingPattern)
        ...
        'Core.LookupBinder.BindBaseLookup(Me.rgProductionStructure, baseDataSet, LivestockFarmProduction_DB.TableFarm + ".idfsLivestockProductionType", BaseReferenceType.rftLivestockProductionType)
        'Core.LookupBinder.BindBaseLookup(Me.rgMovementPattern, baseDataSet, LivestockFarmProduction_DB.TableFarm + ".idfsMovementPattern", BaseReferenceType.rftMovementPattern)
    End Sub
