...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colEventName, Me.colUser, Me.colEventTime})
        ...
        'ContextMenuStrip1
        '
        Me.ContextMenuStrip1.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.ShowEventsToolStripMenuItem, Me.ExitToolStripMenuItem})
...
#End Region
    ...
    Public Shared Sub QueueNotification(ByVal dt As DataTable)
        ...
        If m_Instance.GridControl1.DataSource Is Nothing AndAlso m_Instance.ds.Tables.Count > 0 Then
            ...
            dw.Sort = "intRowNum DESC"
            dw.RowFilter = "not idfsEventTypeID in (10025002,10025029,10025030)" '  evtLookupTableChanged, AVRLayoutUpdate,SettlementChanged
    ...
    Private Sub GridControl1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridControl1.DoubleClick, btnView.Click
        ...
        If Not row Is Nothing AndAlso Not row("idfObjectID") Is DBNull.Value Then
    ...
    Private Sub NotificationForm_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If e.KeyCode = Keys.F1 Then
            bv.Tools.MSHelp2Support.Help2.ShowHelp(Me, bv.winclient.Core.WinClientContext.HelpNames(bv.model.Model.Core.ModelUserContext.CurrentLanguage).ToString, "ClientAgent")
        End If
    End Sub
    ...
    Sub ResetLanguage(ByVal LangID As String)
        ...
        LangID = Localizer.SupportedLanguages(LangID).ToString
        Thread.CurrentThread.CurrentUICulture = New CultureInfo(LangID)
        Thread.CurrentThread.CurrentCulture = New CultureInfo(LangID)
        bv.common.db.Core.LookupCache.Init(True)
