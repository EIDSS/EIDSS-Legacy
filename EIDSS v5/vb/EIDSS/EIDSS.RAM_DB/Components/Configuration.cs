...
namespace EIDSS.RAM_DB.Components
{
    public static class Configuration
    {
        ...
        public static CustomSummaryType GetSummaryTypeFor(string name, Type type)
        {
            CustomSummaryType result;
            string originalName = RamPivotGridHelper.GetOriginalNameFromCopyForFilterName(name);
