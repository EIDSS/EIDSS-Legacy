...
Public Class HumanCaseSamplesDetail_DB
    ...
    Public Overrides Function GetDetail(ByVal ID As Object) As System.Data.DataSet
        ...
        'Remove for Search Mode'    'c'Lookup_Db.FillBaseLookup(ds, BaseReferenceType.rftTestType, Connection, HACode.Human, False)
        ...
        'ds.Tables(TableTests).PrimaryKey = New DataColumn() {ds.Tables(TableTests).Columns("idfTesting")}
    ...
    '            'c'Lookup_Db.FillBaseLookup(ds, BaseReferenceType.rftTestType, Connection, HACode.Human, False)
    ...
    '            'ds.Tables(TablesEnum.Materials).Columns("SpecimenType").ReadOnly = False
