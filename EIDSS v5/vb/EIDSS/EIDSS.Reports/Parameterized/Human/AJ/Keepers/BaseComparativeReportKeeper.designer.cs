...
namespace EIDSS.Reports.Parameterized.Human.AJ.Keepers
{
    partial class BaseComparativeReportKeeper
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.region2Filter = new EIDSS.Reports.Parameterized.Filters.RegionFilter();
            this.rayon2Filter = new EIDSS.Reports.Parameterized.Filters.RayonFilter();
            this.CounterLookUp = new DevExpress.XtraEditors.LookUpEdit();
            this.CounterLabel = new System.Windows.Forms.Label();
            this.ProvinceLabel = new DevExpress.XtraEditors.LabelControl();
            this.DistrictLabel = new DevExpress.XtraEditors.LabelControl();
            ...
            // pnlSettings
            // 
            this.pnlSettings.Controls.Add(this.DistrictLabel);
            ...
            this.pnlSettings.Controls.SetChildIndex(this.DistrictLabel, 0);
            // 
            // ceUseArchiveData
            // 
            ...
            this.region2Filter.ValueChanged += new System.EventHandler<EIDSS.Reports.BaseControls.Filters.SingleFilterEventArgs>(this.region2Filter_ValueChanged);
            // 
            // rayon2Filter
            // 
            ...
            this.rayon2Filter.ValueChanged += new System.EventHandler<EIDSS.Reports.BaseControls.Filters.SingleFilterEventArgs>(this.rayon2Filter_ValueChanged);
            // 
            // CounterLookUp
            // 
            ...
            // DistrictLabel
            // 
            resources.ApplyResources(this.DistrictLabel, "DistrictLabel");
        ...
        protected Parameterized.Filters.RegionFilter region1Filter;
        protected Parameterized.Filters.RayonFilter rayon1Filter;
        protected Parameterized.Filters.RegionFilter region2Filter;
        protected Parameterized.Filters.RayonFilter rayon2Filter;
        protected DevExpress.XtraEditors.LookUpEdit CounterLookUp;
        protected System.Windows.Forms.Label CounterLabel;
        protected DevExpress.XtraEditors.LabelControl DistrictLabel;
        protected DevExpress.XtraEditors.LabelControl ProvinceLabel;
    }
}