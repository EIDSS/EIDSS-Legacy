...
namespace EIDSS.FlexibleForms.Helpers
{
    ...
    public class FFRender
    {
        ...
        internal void RestoreTemplate(long idfsFormTemplate, long idfsFormType, string langid, List<AggregateCaseSection> presetStubs, long? idfVersion, bool isSummary)
        {
            ...
            var stubLength = 0;
            if ((presetStubs != null) && (idfVersion != null))
            {
                //обработаем загруженный боковик
                stubLength = presetStubs.IncludeStub(MainDbService, idfsFormTemplate, idfVersion.Value);
            }
        ...
        {
            RestoreTemplate(idfsFormTemplate, idfsFormType, langid, null, null, false);
        }
        ...
        internal Section CreateSectionInTemplateHost(FlexibleFormsDS.SectionTemplateRow rowSectionTemplate, Point mouseLocation, bool isSummaryTemplate)
        {
            ...
            if (sectionTable != null)
            {
                ...
                sectionTable.IsFixedStubSection = CriticalObjectsHelper.Sections.ContainsKey(rowSectionTemplate.idfsSection);
            }
