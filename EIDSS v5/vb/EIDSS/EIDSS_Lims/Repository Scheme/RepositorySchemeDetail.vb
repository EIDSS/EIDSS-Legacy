...
#Region " Windows Form Designer generated code "
    Public Sub New()
        ...
        AuditObject = New Core.EIDSSAuditObject(EIDSSAuditObject.daoRepositoryScheme, AuditTable.tlbFreezer)
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.FormID = "L12"
        Me.HelpTopicID = "Repository Scheme"
...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        Try
            Core.LookupBinder.BindBaseLookup(cbSubdivisionType, baseDataSet, RepositoryScheme_DB.TableSubdivision + ".idfsSubdivisionType", BaseReferenceType.rftSubdivisionType)
            ...
            Core.LookupBinder.BindBaseLookup(cbStorageType, baseDataSet, RepositoryScheme_DB.TableFreezer + ".idfsStorageType", BaseReferenceType.rftStorageType)
    ...
    Private Function CheckSubdivision(ByRef Node As DevExpress.XtraTreeList.Nodes.TreeListNode, ByVal capacity As Object) As Boolean
        ...
        Try
            ...
            Dim cmd As IDbCommand = BaseDbService.CreateSPCommand("spFreezerSubdivision_Validate", DbService.Connection, trans)
            BaseDbService.AddParam(cmd, "@idfSubdivision", row("idfSubdivision"))
            BaseDbService.AddParam(cmd, "@intCapacity", capacity)
            cmd.ExecuteNonQuery()
            trans.Rollback()
    ...
    Protected Overridable Function CanDelete(ByVal Node As DevExpress.XtraTreeList.Nodes.TreeListNode) As Boolean
        If CheckSubdivision(Node, 0) = False Then Return False
        Dim valid As Boolean = True
        For Each child As DevExpress.XtraTreeList.Nodes.TreeListNode In Node.Nodes
            valid = valid And CheckSubdivision(child, 0)
    ...
    Protected Sub GetLocationNumber(ByVal DRow As DataRow, ByRef LocationNumber As Integer, ByRef VialNumber As Integer)
        ...
        For Each TempDRow In DRow.GetChildRows("SubdivisionLocation")
            If Not TempDRow.IsNull("idfContainer") Then
                VialNumber += 1
            End If
            LocationNumber += 1
        Next
...
#End Region
    ...
    Private Sub txtCapacity_EditValueChanging(ByVal sender As System.Object, ByVal e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles txtCapacity.EditValueChanging
        e.Cancel = Not CheckSubdivision(Me.tvFreezerStruct.FocusedNode, e.NewValue)
        If e.Cancel Then
            ErrorForm.ShowWarningDirect(EidssMessages.Get("msgCanNotDecreaseLocationVial"))
        End If
