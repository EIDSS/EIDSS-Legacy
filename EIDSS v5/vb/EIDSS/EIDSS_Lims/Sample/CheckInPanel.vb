...
Public Class CheckInPanel
    ...
    Friend WithEvents colTests As DevExpress.XtraGrid.Columns.GridColumn
    ...
    'Friend WithEvents txtSamplesSearch As DevExpress.XtraEditors.TextEdit
    ...
    Private m_SessionType As EIDSS.model.Enums.SessionType
    Friend Property SessionType() As EIDSS.model.Enums.SessionType
        Get
            Return m_SessionType
        End Get
        Set(ByVal value As EIDSS.model.Enums.SessionType)
            m_SessionType = value
    ...
    Public Sub New()
        ...
        Try
            ...
            Me.colContainerID.VisibleIndex = 3
            Me.colContainerID.OptionsColumn.AllowEdit = True
            Me.SamplesGridView.Columns.Add(colContainerID)
            Me.SamplesGridView.Columns.Add(colLocation)
            Me.SamplesGridView.Columns.Add(colTests)
            ...
            Me.colTestsCount.Visible = True
            Me.colTestsCount.VisibleIndex = 20
            ShowNewButton = True
    ...
    Private Sub InitializeComponent()
        ...
        Me.colTests = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.cbAccessionDate.VistaTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton(), New DevExpress.XtraEditors.Controls.EditorButton()})
        '
        'grpSendToOffice
        '
        ...
        'colContainerID
        '
        resources.ApplyResources(Me.colContainerID, "colContainerID")
        Me.colContainerID.FieldName = "strBarcode"
    ...
    Protected Overrides Sub DefineBinding()
        If Me.baseDataSet.Tables.Count = 0 Then Exit Sub


        Dim caseRow As DataRow = Me.baseDataSet.Tables(CaseSamples_Db.TableCaseActivity).Rows(0)
        If Not Utils.IsEmpty(caseRow("idfVectorSurveillanceSession")) Then
            HACode = EIDSS.HACode.Vector
            chkFilterSamples.Visible = False
        ElseIf Not Utils.IsEmpty(caseRow("idfMonitoringSession")) Then
            HACode = EIDSS.HACode.Livestock
        Else
        ...
        If (HACode = HACode.Vector) Then
            CasePartyList = New DataView(Me.baseDataSet.Tables("VectorPartyList"))
        Else
            CasePartyList = New DataView(Me.baseDataSet.Tables("PartyList"))
        End If
        If (HACode = HACode.Human) Then
            If (Me.baseDataSet.Tables(CaseSamples_Db.TableCaseActivity).Rows.Count > 0) Then
                Me.DefaultPartyID = Me.baseDataSet.Tables(CaseSamples_Db.TableCaseActivity).Rows(0)("idfHuman")
            End If
        End If
        ...
        Core.LookupBinder.BindPersonLookup(cbRegisteredByPerson, m_SamplesView, "idfAccesionByPerson", False)
        ShowNewButton = True
        UpdateButtons()
    ...
    Overridable Sub btnAccession_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAccession.Click
        ...
        For Each rowHandle As Integer In selectedRows
            ...
            Dim data As DataRow = Me.SamplesGridView.GetDataRow(rowHandle)
    ...
    Private Sub AccessionRow(ByRef row As DataRow)
        ...
        row("idfContainer") = row("idfMaterial")
        row("strBarcode") = NumberingService.GetNextNumber(NumberingObject.Specimen, Me.DbService.Connection, Nothing)
        row("datAccession") = DateTime.Now
    ...
    Public Overrides Function IsCurrentSpecimenRowValid(Optional ByVal index As Integer = -1, Optional ByVal showError As Boolean = True) As Boolean
        ...
        If Utils.Str(row("Used")) = "1" AndAlso (Utils.IsEmpty(row("datAccession"))) Then
            If showError Then
                Dim msg As String = String.Format(BvMessages.Get("ErrMandatoryFieldRequired", "The field {0} is mandatory. You must enter data to this field before form saving"), SamplesGridView.Columns("datAccession").Caption)
        ...
        If Utils.IsEmpty(condition) = False AndAlso (condition.ToString() = AccessionCondition.AcceptedPoor.ToString("d") Or condition.ToString() = AccessionCondition.Rejected.ToString("d")) Then
            If Utils.Str(row("strCondition")).Trim().Length = 0 Then
                Me.SamplesGridView.FocusedColumn = Me.colSampleCondition
                If showError Then
                    Dim msg As String = String.Format(EidssMessages.Get("ErrSampleConditionRequired", "Please enter a comment describing why the {0} is identified as ""{1}"""), colConditionReceived.Caption, Me.SamplesGridView.GetRowCellDisplayText(index, Me.colConditionReceived))
                    ErrorForm.ShowWarningDirect(msg)
                End If
                Return False
            End If
        ...
        If Utils.Str(condition) = AccessionCondition.AcceptedGood.ToString("d") Or Utils.Str(condition) = AccessionCondition.AcceptedPoor.ToString("d") Then
            If Utils.Str(row("strBarcode")).Length = 0 Then
                If showError Then
                    Dim msg As String = String.Format(BvMessages.Get("ErrMandatoryFieldRequired", "The field {0} is mandatory. You must enter data to this field before form saving"), SamplesGridView.Columns("strBarcode").Caption)
                    ErrorForm.ShowErrorDirect(msg)
                End If
                Return False
            End If

            If row.RowState = DataRowState.Added Then 'AndAlso row.RowState = DataRowState.Modified 
                Using sampleCheck As SamplesCheckIn_DB = New SamplesCheckIn_DB()
                    If sampleCheck.CheckBarcodeForExist(Utils.Str(row("strBarcode"))) = True Then
                        If showError Then
        ...
        If (HACode And EIDSS.HACode.Human) = 0 Then Return True


        Dim external As ArrayList = New ArrayList()
        external.Add(New DictionaryEntry("datDateOfBirth", "Date of Birth"))
        external.Add(New DictionaryEntry("datOnSetDate", "Date of symptoms onset"))
        external.Add(New DictionaryEntry("datDiagnosisDate", "Diagnosis date"))

        If Me.baseDataSet.Tables(CaseSamples_Db.TableCaseActivity).Rows.Count > 0 Then
            Dim CaseRow As DataRow = Me.baseDataSet.Tables(CaseSamples_Db.TableCaseActivity).Rows(0)
            For Each pair As DictionaryEntry In external
                If True = MinMax_Err(CaseRow(pair.Key.ToString), row("datFieldCollectionDate"), pair.Value.ToString, "Sample Collection Date", True, showError) Then Return False
                If True = MinMax_Err(CaseRow(pair.Key.ToString), row("datAccession"), pair.Value.ToString, "Accession Date", True, showError) Then Return False
            Next
        End If
    ...
    Private Sub CheckInPanel_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ArrangeButtons(SamplesGroup, btnAccession.Top, "")
        'ArrangeButton(SamplesGroup, txtSamplesSearchAdvanced, btnSampleSearch)
        'ArrangeButton(SamplesGroup, lblSamplesSearch, txtSamplesSearchAdvanced)
        'ArrangeButton(SamplesGroup, chkFilterSamples, lblSamplesSearch)
    End Sub
    Private Sub SamplesCheckIn_OnAfterPost(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.OnAfterPost
        Me.ShowSampleDetails(Me.SamplesGridView.FocusedRowHandle)
    End Sub
    ...
    Public Overrides Sub UpdateButtons()
        ...
        If HACode = EIDSS.HACode.Human Then
            btnNewSpecimen.Enabled = Not [ReadOnly] AndAlso IsCurrentSpecimenRowValid(, False) AndAlso New StandardAccessPermissions(EIDSS.model.Enums.EIDSSPermissionObject.HumanCase).CanSelect 'CanUpdate
        ElseIf (HACode And EIDSS.HACode.Avian And EIDSS.HACode.Livestock) <> 0 AndAlso SessionType = EIDSS.model.Enums.SessionType.None Then
            btnNewSpecimen.Enabled = Not [ReadOnly] AndAlso IsCurrentSpecimenRowValid(, False) AndAlso New StandardAccessPermissions(EIDSS.model.Enums.EIDSSPermissionObject.VetCase).CanSelect 'CanUpdate
        ElseIf (HACode And EIDSS.HACode.Avian And EIDSS.HACode.Livestock) <> 0 AndAlso SessionType = EIDSS.model.Enums.SessionType.AsSession Then
            btnNewSpecimen.Enabled = Not [ReadOnly] AndAlso IsCurrentSpecimenRowValid(, False) AndAlso New StandardAccessPermissions(EIDSS.model.Enums.EIDSSPermissionObject.MonitoringSession).CanSelect 'CanUpdate
        ElseIf (HACode And EIDSS.HACode.Vector) <> 0 AndAlso SessionType = EIDSS.model.Enums.SessionType.VsSession Then
            btnNewSpecimen.Enabled = Not [ReadOnly] AndAlso IsCurrentSpecimenRowValid(, False) AndAlso New StandardAccessPermissions(EIDSS.model.Enums.EIDSSPermissionObject.VsSession).CanSelect 'CanUpdate
        End If
        BarcodeButton1.Enabled = Not [ReadOnly] AndAlso m_CanPrint AndAlso specimenSelected AndAlso Not Utils.IsEmpty(row("strBarcode"))
    End Sub
    ...
    Protected Overrides Function ShowEditor(ByVal row As DataRow) As Boolean
        ...
        Dim col As DevExpress.XtraGrid.Columns.GridColumn = Me.SamplesGridView.FocusedColumn
        Dim condition As Long = GetCondition(row)
        If (col Is Me.colLocation OrElse _
            col Is Me.colComment OrElse _
            col Is Me.colTests OrElse _
            col Is Me.colContainerID OrElse _
            col Is Me.colDepartmentName) AndAlso _
        ...
        If row.RowState = DataRowState.Modified AndAlso _
            Not (col Is Me.colSpecimenType) AndAlso _
            Not (col Is Me.colSpecimenID) AndAlso _
            Not (col Is Me.colAnimal) AndAlso _
            Not (col Is Me.colSpecies) AndAlso _
            Not (col Is Me.colVectorID) AndAlso _
            Not (col Is Me.colVectorType) AndAlso _
            Not (col Is Me.colCollectionDate) Then
            Return True
        End If
        Return False
    End Function
    ...
    Public Overrides Sub ShowSampleDetails(ByVal sampleIndex As Integer)
        ...
        SetLookupReadOnly(Me.cbRegisteredByPerson, added)
        SetLookupReadOnly(Me.cbCollectedByOrganization, added)
        SetLookupReadOnly(Me.cbCollectedByPerson, added)
    End Sub
    ...
    Private Sub SamplesGridView_CustomColumnDisplayText(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventArgs) 'Handles SamplesGridView.CustomColumnDisplayText
        ...
        If row Is Nothing Then
            Return
        End If
        If Me.GetCondition(row) = AccessionCondition.Rejected AndAlso ( _
            e.Column Is Me.colLocation OrElse _
            e.Column Is Me.colComment OrElse _
            e.Column Is Me.colTests OrElse _
            e.Column Is Me.colDepartmentName OrElse _
            e.Column Is Me.colContainerID) Then e.DisplayText = ""
    End Sub
    ...
    Private Sub SamplesGridView_CustomRowCellEditForEditing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs)
        ...
        Dim mainDataView As DataView = CType(Me.cbSpecimenType.DataSource, DataView).Table.Copy().DefaultView '.Table.Rows(0)("idfsReference")
    ...
    Private Function GetSampleFilterForDiagnosis(row As DataRow) As String
        ...
        End If
        Dim filteredDataTable As DataTable = Me.CheckinDbService.GetFilteredCase(speciesType)
    ...
    Protected Overridable Sub SearchByBarcode(ByVal barCode As String)
        ...
        If LockHandler() Then
            Try
                ...
                If TypeOf (Me.SamplesGrid.DataSource) Is DataView Then
                    view = CType(Me.SamplesGrid.DataSource, DataView)
                Else
                    view = CType(Me.SamplesGrid.DataSource, DataTable).DefaultView
                End If
                ...
                If Not (view.Table.Rows.Count = 0) Then
                    ...
                    If (rows.Length > 0) Then
                        ...
                        Dim view2 As DevExpress.XtraGrid.Views.Grid.GridView = CType(Me.SamplesGrid.Views(0), DevExpress.XtraGrid.Views.Grid.GridView)
    ...
    Private Sub btnSelectTest_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelectTest.Click
        ...
        If LockHandler() Then
            Try
                Dim arr As Integer() = CType(Me.SamplesGrid.MainView, DevExpress.XtraGrid.Views.Grid.GridView).GetSelectedRows()
                ...
                For Each rowIndex As Integer In arr
                    ...
                    Dim dataRow As DataRow = Me.SamplesGridView.GetDataRow(rowIndex)
                    rowList.Add(dataRow)
                Next
                ...
                For Each rowIndex As Integer In arr
                    If rowIndex = DevExpress.XtraGrid.GridControl.InvalidRowHandle Then Exit Sub
                    Dim dataRow As DataRow = Me.SamplesGridView.GetDataRow(rowIndex)
                    testsCount = SamplesCheckIn_DB.GetTestCount(CLng(dataRow("idfContainer")))
    ...
    Private Sub SamplesGridView_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        SetMultiSelectionButtonsState()
    End Sub

    Private Sub txtScannedBarcode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtSamplesSearchAdvanced.KeyDown
