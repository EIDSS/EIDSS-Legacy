...
Partial Class AggregateHeader
    ...
    Private Sub InitializeComponent()
        ...
        CType(Me.datDay.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.dtEnteringDate.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.dtReportingDate.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.dtReceivedDate.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.datDay.Properties.VistaTimeProperties.AccessibleDescription = resources.GetString("datDay.Properties.VistaTimeProperties.AccessibleDescription")
        Me.datDay.Properties.VistaTimeProperties.AccessibleName = resources.GetString("datDay.Properties.VistaTimeProperties.AccessibleName")
        Me.datDay.Properties.VistaTimeProperties.AutoHeight = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.AutoHeight"), Boolean)
        Me.datDay.Properties.VistaTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        Me.datDay.Properties.VistaTimeProperties.Mask.AutoComplete = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.Mask.AutoComplete"), DevExpress.XtraEditors.Mask.AutoCompleteType)
        Me.datDay.Properties.VistaTimeProperties.Mask.BeepOnError = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.Mask.BeepOnError"), Boolean)
        Me.datDay.Properties.VistaTimeProperties.Mask.EditMask = resources.GetString("datDay.Properties.VistaTimeProperties.Mask.EditMask")
        Me.datDay.Properties.VistaTimeProperties.Mask.IgnoreMaskBlank = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.Mask.IgnoreMaskBlank"), Boolean)
        Me.datDay.Properties.VistaTimeProperties.Mask.MaskType = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.Mask.MaskType"), DevExpress.XtraEditors.Mask.MaskType)
        Me.datDay.Properties.VistaTimeProperties.Mask.PlaceHolder = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.Mask.PlaceHolder"), Char)
        Me.datDay.Properties.VistaTimeProperties.Mask.SaveLiteral = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.Mask.SaveLiteral"), Boolean)
        Me.datDay.Properties.VistaTimeProperties.Mask.ShowPlaceHolders = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.Mask.ShowPlaceHolders"), Boolean)
        Me.datDay.Properties.VistaTimeProperties.Mask.UseMaskAsDisplayFormat = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.Mask.UseMaskAsDisplayFormat"), Boolean)
        Me.datDay.Properties.VistaTimeProperties.NullValuePrompt = resources.GetString("datDay.Properties.VistaTimeProperties.NullValuePrompt")
        Me.datDay.Properties.VistaTimeProperties.NullValuePromptShowForEmptyValue = CType(resources.GetObject("datDay.Properties.VistaTimeProperties.NullValuePromptShowForEmptyValue"), Boolean)
        Me.datDay.Tag = "{M}"
        '
        'cbCountry
        '
        ...
        Me.dtEnteringDate.Properties.VistaTimeProperties.AccessibleDescription = resources.GetString("dtEnteringDate.Properties.VistaTimeProperties.AccessibleDescription")
        Me.dtEnteringDate.Properties.VistaTimeProperties.AccessibleName = resources.GetString("dtEnteringDate.Properties.VistaTimeProperties.AccessibleName")
        Me.dtEnteringDate.Properties.VistaTimeProperties.AutoHeight = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.AutoHeight"), Boolean)
        Me.dtEnteringDate.Properties.VistaTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        Me.dtEnteringDate.Properties.VistaTimeProperties.Mask.AutoComplete = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.Mask.AutoComplete"), DevExpress.XtraEditors.Mask.AutoCompleteType)
        Me.dtEnteringDate.Properties.VistaTimeProperties.Mask.BeepOnError = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.Mask.BeepOnError"), Boolean)
        Me.dtEnteringDate.Properties.VistaTimeProperties.Mask.EditMask = resources.GetString("dtEnteringDate.Properties.VistaTimeProperties.Mask.EditMask")
        Me.dtEnteringDate.Properties.VistaTimeProperties.Mask.IgnoreMaskBlank = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.Mask.IgnoreMaskBlank"), Boolean)
        Me.dtEnteringDate.Properties.VistaTimeProperties.Mask.MaskType = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.Mask.MaskType"), DevExpress.XtraEditors.Mask.MaskType)
        Me.dtEnteringDate.Properties.VistaTimeProperties.Mask.PlaceHolder = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.Mask.PlaceHolder"), Char)
        Me.dtEnteringDate.Properties.VistaTimeProperties.Mask.SaveLiteral = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.Mask.SaveLiteral"), Boolean)
        Me.dtEnteringDate.Properties.VistaTimeProperties.Mask.ShowPlaceHolders = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.Mask.ShowPlaceHolders"), Boolean)
        Me.dtEnteringDate.Properties.VistaTimeProperties.Mask.UseMaskAsDisplayFormat = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.Mask.UseMaskAsDisplayFormat"), Boolean)
        Me.dtEnteringDate.Properties.VistaTimeProperties.NullValuePrompt = resources.GetString("dtEnteringDate.Properties.VistaTimeProperties.NullValuePrompt")
        Me.dtEnteringDate.Properties.VistaTimeProperties.NullValuePromptShowForEmptyValue = CType(resources.GetObject("dtEnteringDate.Properties.VistaTimeProperties.NullValuePromptShowForEmptyValue"), Boolean)
        ...
        Me.dtReportingDate.Properties.VistaTimeProperties.AccessibleDescription = resources.GetString("dtReportingDate.Properties.VistaTimeProperties.AccessibleDescription")
        Me.dtReportingDate.Properties.VistaTimeProperties.AccessibleName = resources.GetString("dtReportingDate.Properties.VistaTimeProperties.AccessibleName")
        Me.dtReportingDate.Properties.VistaTimeProperties.AutoHeight = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.AutoHeight"), Boolean)
        Me.dtReportingDate.Properties.VistaTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        Me.dtReportingDate.Properties.VistaTimeProperties.Mask.AutoComplete = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.Mask.AutoComplete"), DevExpress.XtraEditors.Mask.AutoCompleteType)
        Me.dtReportingDate.Properties.VistaTimeProperties.Mask.BeepOnError = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.Mask.BeepOnError"), Boolean)
        Me.dtReportingDate.Properties.VistaTimeProperties.Mask.EditMask = resources.GetString("dtReportingDate.Properties.VistaTimeProperties.Mask.EditMask")
        Me.dtReportingDate.Properties.VistaTimeProperties.Mask.IgnoreMaskBlank = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.Mask.IgnoreMaskBlank"), Boolean)
        Me.dtReportingDate.Properties.VistaTimeProperties.Mask.MaskType = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.Mask.MaskType"), DevExpress.XtraEditors.Mask.MaskType)
        Me.dtReportingDate.Properties.VistaTimeProperties.Mask.PlaceHolder = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.Mask.PlaceHolder"), Char)
        Me.dtReportingDate.Properties.VistaTimeProperties.Mask.SaveLiteral = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.Mask.SaveLiteral"), Boolean)
        Me.dtReportingDate.Properties.VistaTimeProperties.Mask.ShowPlaceHolders = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.Mask.ShowPlaceHolders"), Boolean)
        Me.dtReportingDate.Properties.VistaTimeProperties.Mask.UseMaskAsDisplayFormat = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.Mask.UseMaskAsDisplayFormat"), Boolean)
        Me.dtReportingDate.Properties.VistaTimeProperties.NullValuePrompt = resources.GetString("dtReportingDate.Properties.VistaTimeProperties.NullValuePrompt")
        Me.dtReportingDate.Properties.VistaTimeProperties.NullValuePromptShowForEmptyValue = CType(resources.GetObject("dtReportingDate.Properties.VistaTimeProperties.NullValuePromptShowForEmptyValue"), Boolean)
        ...
        Me.dtReceivedDate.Properties.VistaTimeProperties.AccessibleDescription = resources.GetString("dtReceivedDate.Properties.VistaTimeProperties.AccessibleDescription")
        Me.dtReceivedDate.Properties.VistaTimeProperties.AccessibleName = resources.GetString("dtReceivedDate.Properties.VistaTimeProperties.AccessibleName")
        Me.dtReceivedDate.Properties.VistaTimeProperties.AutoHeight = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.AutoHeight"), Boolean)
        Me.dtReceivedDate.Properties.VistaTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        Me.dtReceivedDate.Properties.VistaTimeProperties.Mask.AutoComplete = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.Mask.AutoComplete"), DevExpress.XtraEditors.Mask.AutoCompleteType)
        Me.dtReceivedDate.Properties.VistaTimeProperties.Mask.BeepOnError = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.Mask.BeepOnError"), Boolean)
        Me.dtReceivedDate.Properties.VistaTimeProperties.Mask.EditMask = resources.GetString("dtReceivedDate.Properties.VistaTimeProperties.Mask.EditMask")
        Me.dtReceivedDate.Properties.VistaTimeProperties.Mask.IgnoreMaskBlank = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.Mask.IgnoreMaskBlank"), Boolean)
        Me.dtReceivedDate.Properties.VistaTimeProperties.Mask.MaskType = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.Mask.MaskType"), DevExpress.XtraEditors.Mask.MaskType)
        Me.dtReceivedDate.Properties.VistaTimeProperties.Mask.PlaceHolder = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.Mask.PlaceHolder"), Char)
        Me.dtReceivedDate.Properties.VistaTimeProperties.Mask.SaveLiteral = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.Mask.SaveLiteral"), Boolean)
        Me.dtReceivedDate.Properties.VistaTimeProperties.Mask.ShowPlaceHolders = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.Mask.ShowPlaceHolders"), Boolean)
        Me.dtReceivedDate.Properties.VistaTimeProperties.Mask.UseMaskAsDisplayFormat = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.Mask.UseMaskAsDisplayFormat"), Boolean)
        Me.dtReceivedDate.Properties.VistaTimeProperties.NullValuePrompt = resources.GetString("dtReceivedDate.Properties.VistaTimeProperties.NullValuePrompt")
        Me.dtReceivedDate.Properties.VistaTimeProperties.NullValuePromptShowForEmptyValue = CType(resources.GetObject("dtReceivedDate.Properties.VistaTimeProperties.NullValuePromptShowForEmptyValue"), Boolean)
        Me.dtReceivedDate.Tag = "{M}"
        '
        ...
        CType(Me.datDay.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.dtEnteringDate.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.dtReportingDate.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.dtReceivedDate.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
