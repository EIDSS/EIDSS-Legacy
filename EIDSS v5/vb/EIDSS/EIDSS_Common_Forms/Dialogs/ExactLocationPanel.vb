...
Public Class ExactLocationPanel
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Core.LookupBinder.BindPersonalDataSpinEdit(seLongitude, baseDataSet, "GeoLocation.dblLongitude", group, IgnorePersonalData, -180, +180, True)
        Core.LookupBinder.BindPersonalDataSpinEdit(seLatitude, baseDataSet, "GeoLocation.dblLatitude", group, IgnorePersonalData, -89, +89, True)
    End Sub
