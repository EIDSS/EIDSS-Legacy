...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        Try
            ...
            DebugTimer.Start("LocationLookup Constructor")
            ...
            'RegisterChildObject(AddressLookup1, RelatedPostOrder.SkipPost)

            Me.btnMAP.Enabled = True
            '                'Note: [Ivan] No need to check map existance for  new Gis component

            '            Try
            '                Me.btnMAP.Enabled = GISPanel.MapsInstalled
    ...
    Friend WithEvents AddressLookup1 As EIDSS.AddressLookup
...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Try
            ...
            CType(cbLocationType.Properties.DataSource, DataView).RowFilter = String.Format("idfsReference<>{0} and idfsReference<>{1}", CLng(GeoLocationType.Default), CLng(GeoLocationType.Address))
    ...
    Private ReadOnly Property LocationHelper As LocationHelper
        Get
            If (m_LocationHelper Is Nothing) Then
                m_LocationHelper = New LocationHelper(baseDataSet.Tables("GeoLocation"), eventManager)
            End If
    ...
    Public ReadOnly Property LocationType() As GeoLocationType
        Get
            If LocationRow("idfsGeoLocationType") Is DBNull.Value Then
                LocationRow("idfsGeoLocationType") = CLng(GeoLocationType.ExactPoint)
                UpdateInterface()
            End If
        ...
        Select Case LocationType
            ...
            Case GeoLocationType.ExactPoint
                If baseDataSet.Tables("GeoLocation").Rows.Count > 0 Then
                    ...
                    Return EIDSS_DbUtils.GetExactLocaionString("", _
                        "", _
                        Utils.Dbl(row("dblLatitude")), _
                        ...
                        LookupCache.GetLookupValue(row("idfsRayon"), LookupTables.Rayon, "strRayonName"))
                End If
            Case GeoLocationType.RelativePoint
                If baseDataSet.Tables("GeoLocation").Rows.Count > 0 Then
                    Dim row As DataRow = LocationRow
                    Return EIDSS_DbUtils.GetRelatedLocaionString("", _
                        "", _
                        Utils.Dbl(row("dblDistance")), _
