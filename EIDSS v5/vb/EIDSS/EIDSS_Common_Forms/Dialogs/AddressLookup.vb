...
Public Class AddressLookup
    ...
    Friend WithEvents txtForeignAddress As DevExpress.XtraEditors.TextEdit
    ...
    Dim ControlPairs As New LabelControlList
    Public Event AddressChanged As EventHandler
    Private Sub RaiseAddressChangeEvent()
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        ControlPairs.Add(New LabelControlPair(Me.lblResidenceType, Me.cbResidenceType))
        ControlPairs.Add(New LabelControlPair(Me.lblCountry, Me.cbCountry))
        ControlPairs.Add(New LabelControlPair(Me.lblRegion, Me.cbRegion))
        ControlPairs.Add(New LabelControlPair(Me.lblRayon, Me.cbRayon))
        ControlPairs.Add(New LabelControlPair(Me.lblSettlment, Me.cbSettlement))
        ControlPairs.Add(New LabelControlPair(Me.lblStreet, Me.cbStreet))
        ControlPairs.Add(New LabelControlPair(Me.lblPostalCode, Me.cbPostalCode))
        If (bv.model.Model.Core.ModelUserContext.CurrentLanguage = Localizer.lngEn) Then
            ControlPairs.Add(New LabelControlPair(Me.lblHouse, New Control() {Me.txtBuilding, Me.txtHouse, Me.txtApartment}))
        Else
            ControlPairs.Add(New LabelControlPair(Me.lblHouse, New Control() {Me.txtHouse, Me.txtBuilding, Me.txtApartment}))
        End If
        ControlPairs.Add(New LabelControlPair(Me.lblLongitude, New Control() {Me.seLongitude, seLatitude, btnMAP}))
        ...
        ControlPairs.Item(8).Visible = False
    ...
    Friend WithEvents cbResidenceType As DevExpress.XtraEditors.LookUpEdit
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cbResidenceType = New DevExpress.XtraEditors.LookUpEdit()
        ...
        Me.txtForeignAddress = New DevExpress.XtraEditors.TextEdit()
        ...
        CType(Me.cbResidenceType.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        'cbResidenceType
        '
        resources.ApplyResources(Me.cbResidenceType, "cbResidenceType")
        Me.cbResidenceType.Name = "cbResidenceType"
        Me.cbResidenceType.Properties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton(CType(resources.GetObject("cbResidenceType.Properties.Buttons"), DevExpress.XtraEditors.Controls.ButtonPredefines))})
        Me.cbResidenceType.Properties.Columns.AddRange(New DevExpress.XtraEditors.Controls.LookUpColumnInfo() {New DevExpress.XtraEditors.Controls.LookUpColumnInfo(resources.GetString("cbResidenceType.Properties.Columns"), resources.GetString("cbResidenceType.Properties.Columns1"), CType(resources.GetObject("cbResidenceType.Properties.Columns2"), Integer), CType(resources.GetObject("cbResidenceType.Properties.Columns3"), DevExpress.Utils.FormatType), resources.GetString("cbResidenceType.Properties.Columns4"), CType(resources.GetObject("cbResidenceType.Properties.Columns5"), Boolean), CType(resources.GetObject("cbResidenceType.Properties.Columns6"), DevExpress.Utils.HorzAlignment))})
        Me.cbResidenceType.Properties.NullText = resources.GetString("cbResidenceType.Properties.NullText")
        Me.cbResidenceType.Tag = ""
        '
        'lblResidenceType
        '
        resources.ApplyResources(Me.lblResidenceType, "lblResidenceType")
        ...
        Me.txtForeignAddress.Properties.MaxLength = 254
        '
        'lblLongitude
        '
        ...
        Me.Controls.Add(Me.lblResidenceType)
        ...
        Me.Controls.SetChildIndex(Me.lblResidenceType, 0)
        ...
        CType(Me.cbResidenceType.Properties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Public Overrides ReadOnly Property DisplayText() As String
        Get
            ...
            If baseDataSet.Tables.Contains("Address") AndAlso baseDataSet.Tables("Address").Rows.Count > 0 Then
                ...
                End If
                If m_ShowResidenceType Then
                    ResidenceType = LookupCache.GetLookupValue(row("idfsResidentType"), db.BaseReferenceType.rftResidentType.ToString(), "Name")
                Else
                    ResidenceType = LookupCache.GetLookupValue(38970000000, db.BaseReferenceType.rftResidentType.ToString(), "Name") '"rstPrivate"
                End If
                m_displayText = EIDSS_DbUtils.GetAddressString(Country, _
                    ...
                    IIf(m_IsAddressPrivate, "", Utils.Str(row("strApartment"))).ToString(), _
                    ResidenceType)
            End If
            Return m_displayText
        End Get
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Try
            ...
            If m_ShowResidenceType Then
                Core.LookupBinder.BindBaseLookup(cbResidenceType, baseDataSet, "Address.idfsResidentType", db.BaseReferenceType.rftResidentType)
            End If
            ...
            eventManager.AttachDataHandler("Address.idfsResidentType", AddressOf Address_Changed)
    ...
    Private ReadOnly Property LocationHelper As LocationHelper
        Get
            If (m_LocationHelper Is Nothing) Then
                m_LocationHelper = New LocationHelper(baseDataSet.Tables("Address"), eventManager)
            End If
    ...
    Private Sub Country_Changed(ByVal sender As System.Object, ByVal e As DataFieldChangeEventArgs)
        ...
        If Not currentRegionID Is DBNull.Value AndAlso _
            ...
            eventManager.Cascade("Address.idfsRegion")
        End If
        If Utils.Str(currentCountryID) = "-1" Then
    ...
    Private m_ShowResidenceType As Boolean = True
    <Browsable(True), DefaultValue(True), Localizable(False)> _
    Public Property ShowResidenceType() As Boolean
        Get
            Return m_ShowResidenceType
        End Get
        Set(ByVal Value As Boolean)
            m_ShowResidenceType = Value
            ControlPairs.Item(0).Visible = Value
            ControlPairs.ForceUpdate()
        End Set
    End Property
    ...
    Public Property ShowContry() As Boolean
        ...
        Set(ByVal Value As Boolean)
            m_ShowContry = Value
            ControlPairs.Item(1).Visible = Value
            ControlPairs.ForceUpdate()
        End Set
    End Property
    ...
    Private Sub SetCoordinatesVisibility(value As Boolean)
        ControlPairs.Item(8).Visible = value
        ControlPairs.ForceUpdate()
    ...
    Private Sub UpdateResidenceTypeView(ByVal LabelLeft As Integer, ByVal LabelWidth As Integer, ByVal CtrlLeft As Integer, ByVal CtrlWidth As Integer)
        lblResidenceType.Left = LabelLeft
        lblResidenceType.Width = LabelWidth
        cbResidenceType.Anchor = AnchorStyles.Left Or AnchorStyles.Top
        cbResidenceType.Left = CtrlLeft
        cbResidenceType.Width = CtrlWidth
    End Sub
    ...
    Private Sub UpdateLabelView(ByVal LabelAlignment As System.Drawing.ContentAlignment)
        If (m_ShowResidenceType = True) Then
            lblResidenceType.TextAlign = LabelAlignment
        End If
        If (m_ShowContry = True) Then
            ...
            If (i = m_ColumnCount) Then
                ...
                If Not bv.winclient.Core.WinUtils.IsComponentInDesignMode(Me) Then
                    If (ForeignAddressMode) Then
                        ...
                        Else
                            lbForeignAddress.Top = ControlPairs.Item(1).Label.Top
                            txtForeignAddress.Top = ControlPairs.Item(1).Controls(0).Top
                        End If
                ...
                Else
                End If
                If (m_ShowContry = True) AndAlso (m_ShowResidenceType = True) Then
                    Select Case m_ColumnCount
                        Case 1
                            UpdateResidenceTypeView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
                            UpdateCountryView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
                        ...
                        Case Else
                            ...
                            UpdateHouseView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
                            LabelLeft = CInt(LabelColLeft(8))
                            LabelWidth = CInt(LabelColWidth(8))
                            CtrlLeft = CInt(CtrlColLeft(8))
                            CtrlWidth = CInt(CtrlColWidth(8))
                            If ShowCoordinates Then
                                UpdateCoordinatesView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
                            End If
                    End Select
                ElseIf (m_ShowContry = True) AndAlso (m_ShowResidenceType = False) Then
                    Select Case m_ColumnCount
                        Case 1
                            UpdateCountryView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
                            UpdateRegionView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
                        ...
                        Case Else
                            ...
                            End If
                    End Select
                ElseIf (m_ShowContry = False) AndAlso (m_ShowResidenceType = True) Then
                    Select Case m_ColumnCount
                        Case 1
                            UpdateResidenceTypeView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
                            UpdateRegionView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
                        ...
                        Case Else
                            ...
                            End If
                    End Select
                ElseIf (m_ShowContry = False) AndAlso (m_ShowResidenceType = False) Then
                    Select Case m_ColumnCount
                        Case 1
                            UpdateRegionView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
                            UpdateRayonView(LabelLeft, LabelWidth, CtrlLeft, CtrlWidth)
    ...
    Public Property ResidenceTypeID() As Object
        Get
            If ShowResidenceType AndAlso (Not cbResidenceType Is Nothing) Then Return cbResidenceType.EditValue
            Return 38970000000 '"rstPrivate"
        End Get
        Set(ByVal value As Object)
            If IsCorrectValue(value) AndAlso ShowResidenceType AndAlso (Not cbResidenceType Is Nothing) Then _
                cbResidenceType.EditValue = value
        End Set
    End Property
    <Browsable(False), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
    ...
    Public Property ForeignAddressMode As Boolean
        ...
        Set(ByVal value As Boolean)
            If Not AddressRow Is Nothing Then
                If Not value.Equals(AddressRow("blnForeignAddress")) Then
            ...
            txtApartment.Visible = Not value
            txtBuilding.Visible = Not value
            txtHouse.Visible = Not value
            ...
            If Not value Then
                lblResidenceType.Visible = ShowResidenceType
                cbResidenceType.Visible = ShowResidenceType
            Else
                lblResidenceType.Visible = False
                cbResidenceType.Visible = False
            End If
