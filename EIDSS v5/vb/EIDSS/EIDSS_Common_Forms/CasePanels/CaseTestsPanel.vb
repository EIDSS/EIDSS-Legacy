...
#Region " Windows Form Designer generated code "
    ...
    Private Sub InitializeComponent()
        ...
        CType(Me.dtDateReceived.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.dtDateEdit.VistaTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        CType(Me.dtDateEdit1.VistaTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.dtDateReceived.Properties.VistaTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        '
        'lbDateReceived
        '
        ...
        Me.ffLabTestDetails.DefaultFormState = System.Windows.Forms.FormWindowState.Normal
        ...
        Me.ffLabTestDetails.IsStatusReadOnly = False
        ...
        Me.ffLabTestDetails.Status = bv.common.win.FormStatus.Draft
        ...
        Me.colFieldID.FieldName = "idfContainer"
        ...
        Me.dtDateEdit.VistaTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        '
        'colDepartment
        '
        ...
        Me.ValidationGrid.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {Me.cbTestTypeLookup, Me.cbTestNameLookup, Me.cbDisease, Me.txtMemo, Me.cbPersonLookup, Me.RepositoryItemCheckEdit1, Me.cbRuleInLookup, Me.dtDateEdit1})
        Me.ValidationGrid.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.ValidationGridView})
        '
        'ValidationGridView
        '
        Me.ValidationGridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colDiseaseV, Me.colTestNameV, Me.colTestTypeV, Me.colRule, Me.colCommentInterpreted, Me.colDateInterpreted, Me.colPersonInterpreted, Me.colValidated, Me.colCommentValidated, Me.colDateValidated, Me.colPersonValidated})
        ...
        Me.cbTestTypeLookup.DisplayMember = "TestType"
        ...
        Me.dtDateEdit1.VistaTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        '
        ...
        CType(Me.dtDateReceived.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.dtDateEdit.VistaTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        CType(Me.dtDateEdit1.VistaTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Public Sub ShowAsSessionColums()
    ...
    Protected Overrides Sub DefineBinding()
        ...
        If (HACode And eidss.HACode.Human) = eidss.HACode.Human Then
            ...
            LookupBinder.BindOrganizationLookup(cbExtOrganization, baseDataSet, CaseTestsDetail_Db.TableTests + ".idfPerformedByOffice")
        ...
        LookupBinder.BindBaseRepositoryLookup(Me.cbTestCategory, db.BaseReferenceType.rftTestForDiseaseType)
        LookupBinder.BindTestResultRepositoryLookup(Me.cbTestResult)
        LookupBinder.BindBaseRepositoryLookup(Me.cbTestStatus, db.BaseReferenceType.rftActivityStatus)
        LookupBinder.BindBaseRepositoryLookup(Me.cbTestType, db.BaseReferenceType.rftTestType, HACode)
        BindSamplesLookup()
        ...
        eventManager.AttachDataHandler(CaseTestsDetail_Db.TableTests + ".idfContainer", AddressOf SampleChanged)
        eventManager.AttachDataHandler(CaseTestsDetail_Db.TableTests + ".idfsTestType", AddressOf TestTypeChanged)

        TestGridView.OptionsBehavior.Editable = True
        Me.TestGrid.DataSource = baseDataSet.Tables(CaseTestsDetail_Db.TableTests)
    ...
    Private Sub BindSamplesLookup()
        ...
        If (HACode And EIDSS.HACode.Human) = EIDSS.HACode.Human Then
            ...
            cbSample.Columns.AddRange(New LookUpColumnInfo() { _
                ...
                New LookUpColumnInfo("strSpecimenName", EidssFields.Get("strSpecimenName", "Sample Type"), 240), _
        ...
        Else
            ...
            'New LookUpColumnInfo("strSpecimenName", EidssFields.Get("strSpecimenName", "Sample Type"), 140), _

        End If
        LookupBinder.SetDataSource(cbSample, Nothing, "strFieldBarcode", "idfMaterial", AddressOf cbSample_QueryPopUp, AddressOf cbSample_QueryCloseUp)
    ...
    Public Sub RefreshTests(ByVal oldSampleID As Object, ByVal newSampleID As Object)
        If Utils.IsEmpty(oldSampleID) Then ' new sample is created, do nothing
            Return
        End If
        For Each testRow As DataRow In baseDataSet.Tables(CaseTestsDetail_Db.TableTests).Select(String.Format("idfContainer = {0}", newSampleID))
    ...
    Private Sub SampleChanged(ByVal sender As Object, ByVal e As DataFieldChangeEventArgs)
        ...
        e.Row("SpecimenType") = sampleRow(0)("strSpecimenName")
        e.Row("datFieldCollectionDate") = sampleRow(0)("datFieldCollectionDate")
        If (HACode And eidss.HACode.Human) = eidss.HACode.Human Then
            If (sampleRow(0)("idfsSpecimenType").Equals(CLng(SampleTypeEnum.Unknown))) AndAlso sampleRow(0)("idfMaterial").Equals(CaseTestsDetail_Db.UnknownMaterial) Then
                sampleRow(0).SetAdded()
                e.Row("idfContainer") = BaseDbService.NewIntID()
                sampleRow(0)("idfMaterial") = e.Row("idfContainer")
            End If
        ElseIf ((HACode And HACode.Avian) = eidss.HACode.Avian) Then
    ...
    Private Function IsTestWithUnknownSample(testRow As DataRow) As Boolean
        If testRow Is Nothing OrElse cbSample.DataSource Is Nothing Then
            Return False
        End If
        Dim sampleRow As DataRow() = CType(cbSample.DataSource, DataView).Table.Select(String.Format("idfMaterial = {0}", IIf(Utils.IsEmpty(testRow("idfContainer")), -1, testRow("idfContainer"))))
        If sampleRow.Length = 0 Then Return False
        Return sampleRow(0)("idfsSpecimenType").Equals(CLng(SampleTypeEnum.Unknown))
    End Function
    ...
    Public Property HACode() As HACode
        ...
        Set(ByVal Value As HACode)
            If (Value And eidss.HACode.Human) = eidss.HACode.Human Then Me.colAnimal.Visible = False
            'If CInt((Value And EIDSS.HACode.Avian And HACode.Livestock)) <> 0 Then
            If (Value Or eidss.HACode.Avian Or eidss.HACode.Livestock) = (eidss.HACode.Avian Or eidss.HACode.Livestock) Then
                Me.colTestBarcode.Visible = False
    ...
    Function GetSpecimenName(ByVal row As DataRow) As String
        ...
        If Not row Is Nothing Then
            If Utils.Str(row("strBarcode")) <> "" Then
                str = Utils.Str(row("SpecimenType")) + ", " + Utils.Str(row("strBarcode"))
            Else
                str = Utils.Str(row("SpecimenType"))
            End If
        End If
        Return str
    End Function
    ...
    Private Sub TestGridView_FocusedRowChanged(ByVal sender As Object, ByVal e As FocusedRowChangedEventArgs) _
        ...
        Finally
            Dim row As DataRow = TestGridView.GetFocusedDataRow
            If Not row Is Nothing Then
                btnDeleteTest.Enabled = row("blnNonLaboratoryTest").Equals(True)
            End If
            m_Updating = False
        End Try
    End Sub
...
#Region "Flexible Form Support"
    ...
    Private Sub ShowFF()
        ...
        If Utils.IsEmpty(obs) OrElse Utils.IsEmpty(row.Item("idfsTestType")) OrElse row("blnNonLaboratoryTest").Equals(True) Then
            ffLabTestDetails.Visible = False
        Else
            ffLabTestDetails.ShowFlexibleFormByDeterminant(CType(row.Item("idfsTestType"), Long), CType(obs, Long), _
                                                          FFType.TestDetails)
...
#End Region
    ...
    Private Sub InitManadatoryFields()
        If (m_TestMandatoryFields.Count = 0) Then
            m_TestMandatoryFields.AddRange({New FieldCaptionPair("idfContainer", colFieldID.Caption), _
    ...
    Private Function IsTestRowValid(Optional ByVal index As Integer = -1, Optional ByVal showError As Boolean = True) _
        ...
        Next
        If (showError) Then
            If Not WinUtils.CompareDates(row("datFieldCollectionDate"), row("datConcludedDate"), "datFieldCollectionDate_datConcludedDate_msgId") Then
                Return False
            End If
        Else
            If Not WinUtils.CompareDates(row("datFieldCollectionDate"), row("datConcludedDate")) Then
                Return False
            End If
        End If
    ...
    Public Overrides Sub UpdateButtonsState(ByVal sender As Object, ByVal e As EventArgs)
        ...
        If Me.TestGridView.SelectedRowsCount > 0 Then
            If testRow("idfsTestStatus").Equals(CLng(model.Enums.TestStatus.Completed)) AndAlso IsTestRowValid(TestGridView.FocusedRowHandle, False) Then
                canNew = True
                If Me.ValidationGridView.FocusedRowHandle <> GridControl.InvalidRowHandle Then
                    canNew = IsValidationRowValid(Me.ValidationGridView.FocusedRowHandle, False)
                End If
            End If
        End If
        Me.cmdNew.Enabled = canNew AndAlso (Not [ReadOnly]) AndAlso eidss.model.Core.EidssUserContext.User.HasPermission(PermissionHelper.ExecutePermission(eidss.model.Enums.EIDSSPermissionObject.CanValidateTestResult))



        Dim validationRow As DataRow = Me.ValidationGridView.GetFocusedDataRow()
    ...
    Private Sub btnNew_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdNew.Click
        ...
        test("TestName") = LookupCache.GetLookupValue(test("idfsTestType"), db.BaseReferenceType.rftTestType, "name")
        test("TestType") = LookupCache.GetLookupValue(test("idfsTestForDiseaseType"), db.BaseReferenceType.rftTestForDiseaseType, "name")
        table.Rows.Add(row)
    ...
    Public Sub CreateTestForSample(ByVal fieldSampleID As String)
        ...
        If sampleRows.Length > 0 Then
            ...
            testRow("SpecimenType") = sampleRows(0)("strSpecimenName")
            testRow("AnimalName") = sampleRows(0)("AnimalName")
            testRow("strFarmCode") = sampleRows(0)("strFarmCode")
            testRow("idfContainer") = sampleRows(0)("idfMaterial")
            testRow.EndEdit()
    ...
    Private Sub cbSample_QueryPopUp(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cbSample.QueryPopUp
        If cbSample.DataSource Is Nothing Then Return
        defSampleFilter = CType(cbSample.DataSource, DataView).RowFilter
        CType(cbSample.DataSource, DataView).RowFilter = "not idfMaterial is null" 'isnull(Used,0) <> 1 and - removed by requirements
    ...
    Private Sub cbTestResult_QueryPopUp(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles cbTestResult.QueryPopUp
        Dim row As DataRow = TestGridView.GetFocusedDataRow
        CType(Me.cbTestResult.DataSource, DataView).RowFilter = GetTestResultFilter(row("idfsTestType"), row("idfsTestResult"))
    End Sub
    ...
    Private Function GetTestResultFilter(testType As Object, currentTestResult As Object) As String
        If testType Is DBNull.Value Then
            Return "idfsTestType = -1"
        ElseIf Not currentTestResult Is DBNull.Value Then
            Return String.Format("((intRowStatus = 0 or idfsReference = {1}) and idfsTestType = {0}) or idfsReference = {2}", testType, currentTestResult, LookupCache.EmptyLineKey)
        Else
            Return String.Format("(intRowStatus = 0 and idfsTestType = {0}) or idfsReference = {1}", testType, LookupCache.EmptyLineKey)
        End If
    ...
    'Private Sub CaseTestsPanel_OnBeforePost(sender As Object, e As PostEventArgs)
    '    Dim testRows As DataRow() = baseDataSet.Tables(CaseTestsDetail_Db.TableTests).Select("idfContainer=-1")
    '    If testRows.Length > 0 Then
    '        Dim samplesRows As DataRow() = CType(cbSample.DataSource, DataView).Table.Select(String.Format("idfsSpecimenType = {0}", CLng(SampleTypeEnum.Unknown)))
    '        If samplesRows.Length > 0 Then
    '            For Each row As DataRow In testRows
    '                row("idfContainer") = samplesRows(0)("idfMaterial")
    '            Next
    '        End If
    '    End If
    'End Sub
    ...
    Public Function CanDeleteSample(ByVal sampleID As Object) As Boolean
        ...
        For Each row As DataRow In baseDataSet.Tables(CaseTestsDetail_Db.TableTests).Rows
            If row.RowState <> DataRowState.Deleted Then
                If row("idfContainer").Equals(sampleID) Then
                    Return False
                End If
            End If
        Next
    ...
    Function HasCompletedTest() As Boolean
        For Each row As DataRow In baseDataSet.Tables(CaseTestsDetail_Db.TableTests).Rows
            If row.RowState <> DataRowState.Deleted Then
                If row("idfsTestStatus").Equals(CLng(model.Enums.TestStatus.Completed)) Then
                    Return True
                End If
            End If
        Next
    ...
    Public Sub SetMainTestForSample(idfTesting As Object, idfMaterial As Object)
        If (Utils.IsEmpty(idfMaterial) OrElse Utils.IsEmpty(idfTesting)) Then
            Return
        End If
        For Each row As DataRow In baseDataSet.Tables(CaseTestsDetail_Db.TableTests).Select(String.Format("idfContainer = {0}", idfMaterial))
