...
Public Class Address_DB
    ...
    Protected AddressDetailAdapter As DbDataAdapter

    Dim Street_Adapter As DbDataAdapter
    Dim PostalCode_Adapter As DbDataAdapter
    Dim GeoLocation_Adapter As DbDataAdapter
    ...
    Public Overrides Function GetDetail(ByVal ID As Object) As System.Data.DataSet
        ...
        Try
            ...
            AddParam(cmd, "@LangID", eidss.model.Core.EidssUserContext.CurrentLanguage)

            AddressDetailAdapter = CreateAdapter(cmd, False)
            AddressDetailAdapter.Fill(ds, "Address")
    ...
    Public Overrides Function PostDetail(ByVal ds As System.Data.DataSet, ByVal PostType As Integer, Optional ByVal transaction As System.Data.IDbTransaction = Nothing) As Boolean
        ...
        Try
            ...
            cmd = CreateSPCommand("spAddress_Post", Connection, transaction)
            ...
            Dim da As DbDataAdapter = BaseDbService.CreateAdapter(cmd, False)
