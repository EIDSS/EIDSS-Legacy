...
#Region " Windows Form Designer generated code "
    Public Sub New()
        ...
        AuditObject = New Core.EIDSSAuditObject(EIDSSAuditObject.daoStatistic, AuditTable.tlbStatistic)
    ...
    Private Sub InitializeComponent()
        ...
        CType(Me.datStatisticStartDate.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.datStatisticStartDate.Properties.VistaTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton()})
        ...
        Me.AreaLookup1.DefaultFormState = System.Windows.Forms.FormWindowState.Normal
        Me.AreaLookup1.FormID = Nothing
        Me.AreaLookup1.HelpTopicID = Nothing
        Me.AreaLookup1.IsStatusReadOnly = False
        ...
        Me.AreaLookup1.Status = bv.common.win.FormStatus.Draft
        ...
        CType(Me.datStatisticStartDate.Properties.VistaTimeProperties, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        txtValue.DataBindings.Add("EditValue", baseDataSet, "Statistic.varValue")
        Core.LookupBinder.BindDateEdit(datStatisticStartDate, baseDataSet, "Statistic.datStatisticStartDate")
        Core.LookupBinder.BindBaseLookup(cbStatistic_Data_Type, baseDataSet, "Statistic.idfsStatisticDataType", BaseReferenceType.rftStatisticDataType, False)
        Core.LookupBinder.BindBaseLookup(cbStatistic_Period_Type, baseDataSet, "Statistic.idfsStatisticPeriodType", BaseReferenceType.rftStatisticPeriodType, False)
        Core.LookupBinder.BindBaseLookup(cbStatistic_Area_Type, baseDataSet, "Statistic.idfsStatisticAreaType", BaseReferenceType.rftStatisticAreaType, False)
    ...
    Private Sub BindPeriodAreaParameter()
        ...
        If Not Utils.IsEmpty(dataType) Then
            If (Me.State And BusinessObjectState.NewObject) <> 0 OrElse StatisticRow("idfsStatisticAreaType") Is DBNull.Value Then ' new object editing
                ...
                If Not row Is Nothing Then
                    ...
                    If Not row("idfsReferenceType") Is DBNull.Value Then
                        StatisticRow("strParameterType") = LookupCache.GetLookupValue(row("idfsReferenceType"), BaseReferenceType.rftReferenceTypeName, "Name")
                    End If
            ...
            If Not Utils.IsEmpty(StatisticRow("idfsReferenceType")) Then
                ...
                Dim TableId As BaseReferenceType = BaseReferenceType.rftNone
                Try
                    TableId = CType(StatisticRow("idfsReferenceType"), BaseReferenceType)
                Catch ex As Exception
                    TableId = BaseReferenceType.rftNone
                End Try
    ...
    Private Sub ArrangeAdditionalParameters()
        If StatisticRow("blnRelatedWithAgeGroup").Equals(True) Then
            Core.LookupBinder.BindBaseLookup(cbStatisticAgeGroup, baseDataSet, "Statistic.idfsStatisticalAgeGroup", BaseReferenceType.rftStatisticalAgeGroup, False)
    ...
    Public Overrides Function ValidateData() As Boolean
        ...
        If Not Utils.IsEmpty(cbStatistic_Data_Type.EditValue) AndAlso _
            ...
            ErrorForm.ShowError(New EIDSSErrorMessage("ErrMandatoryFieldRequired", "The field {0} is mandatory. You must enter data in this field before saving form.", Nothing, "Area"), ErrorForm.FormType.Warning)
        ...
        If res AndAlso StatisticDbService.StatisticExists(StatisticRow) Then
            ErrorForm.ShowError(New EIDSSErrorMessage("errDoubleStatistic", "Statistic for current Statistic Data Type, Period and Area exists already."), ErrorForm.FormType.Warning)
            res = False
        End If
        Return res
    End Function
    ...
    Private Function GetStartDate(ByVal value As Object) As Object
        ...
        Select Case CType(StatisticRow("idfsStatisticPeriodType"), StatisticPeriodType)
            ...
            Case StatisticPeriodType.Week
                Return DateAdd(DateInterval.Day, 1 - startDate.DayOfWeek, startDate)
            Case StatisticPeriodType.Quarter
