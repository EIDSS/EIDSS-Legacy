    ...
    Public Overrides Function ValidateData() As Boolean
        ...
        If row.RowState = DataRowState.Added Then
            If (Utils.IsEmpty(Me.txtPassword.EditValue)) Then
                ErrorForm.ShowWarning("msgPasswordTooShort", "Password should contain at least {0} characters", MinPasswordLength.ToString)
        ...
        If Not (Utils.IsEmpty(Me.txtPassword.EditValue)) Then
            ...
            If Not SecurityPolicy_DB.ValidatePassword(pass, Me.baseDataSet) Then
                ErrorForm.ShowError(SecurityMessages.GetLoginErrorMessage(8))
                Return False
            End If
        ...
        Select Case result
            ...
            Case -1
                ErrorForm.ShowError(PersonDBService.LastError)
        End Select
        If result <> 0 Then
            txtUserLogin.Select()
            Return False
