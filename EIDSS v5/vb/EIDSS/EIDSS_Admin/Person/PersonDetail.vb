...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        AuditObject = New Core.EIDSSAuditObject(EIDSSAuditObject.daoPerson, AuditTable.tlbEmployee)
...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        Try
            ...
            Core.LookupBinder.BindOrganizationLookup(cbOrganization, baseDataSet, Person_DB.TablePerson + ".idfInstitution")
            Core.LookupBinder.BindDepartmentLookup(cbDepartment, baseDataSet, Person_DB.TablePerson + ".idfDepartment")
            Core.LookupBinder.BindBaseLookup(cbRank, baseDataSet, Person_DB.TablePerson + ".idfsStaffPosition", BaseReferenceType.rftPosition, True, True)
            SetDepartmentFilter()
