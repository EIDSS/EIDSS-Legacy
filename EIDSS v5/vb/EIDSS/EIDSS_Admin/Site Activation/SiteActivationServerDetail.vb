...
#Region " Windows Form Designer generated code "
    Public Sub New()
        ...
        AuditObject  = New Core.EIDSSAuditObject(EIDSSAuditObject.daoSite, AuditTable.tstSite)
...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Core.LookupBinder.BindBaseLookup(cbSiteType, baseDataSet, "SiteActivationServer.idfsSiteType", BaseReferenceType.rftSiteType)
        Core.LookupBinder.BindCountryLookup(cbCountry, baseDataSet, "SiteActivationServer.idfsCountry")
        Core.LookupBinder.BindOrganizationLookup(cbOrganization, baseDataSet, "SiteActivationServer.idfOffice")
        'BindReplication()
        'BindNotification()
    ...
    Private Sub cbParentSite_EditValueChanging(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ChangingEventArgs) Handles cbParentSite.EditValueChanging
        ...
        If Not Utils.IsEmpty(e.NewValue) Then
            ...
            If Not CheckParentSite(ParentSiteID, SiteID, ChildSiteList) Then
                ErrorForm.ShowError(New EIDSSErrorMessage("errWrongParentSite", "This site can't be parent for current site."), ErrorForm.FormType.Warning)
                OkToCancel = True
            Else
                Dim i As Integer = 0
