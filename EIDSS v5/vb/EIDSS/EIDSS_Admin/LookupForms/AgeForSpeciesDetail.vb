...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Core.LookupBinder.BindBaseLookup(cbSpeciesType, baseDataSet, "SpeciesType.idfsSpeciesType", BaseReferenceType.rftSpeciesList, False)
        ...
        Core.LookupBinder.BindBaseRepositoryLookup(cbAnimalAge, _
                                              BaseReferenceType.rftAnimalAgeList, False)
    ...
    Private Sub Age_Changed(ByVal sender As Object, ByVal e As DataFieldChangeEventArgs)
        Dim order As String = LookupCache.GetLookupValue(e.Value, BaseReferenceType.rftAnimalAgeList, "intOrder")
