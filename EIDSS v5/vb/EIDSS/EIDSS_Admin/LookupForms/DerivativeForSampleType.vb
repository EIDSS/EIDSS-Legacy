...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Core.LookupBinder.BindSampleLookup(cbSampleType, baseDataSet, "SampleType.idfsSampleType", False)
        eventManager.AttachDataHandler("SampleType.idfsSampleType", AddressOf m_Helper.RefType_Changed)

        Core.LookupBinder.BindSampleRepositoryLookup(cbDerivativeType, HACode.All, False, False)
