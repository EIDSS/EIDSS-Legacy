...
#Region " Windows Form Designer generated code "
    Public Sub New()
        ...
        AuditObject  = New Core.EIDSSAuditObject(EIDSSAuditObject.daoDepartment, AuditTable.tlbOffice)
...
#End Region
    Protected Overrides Sub DefineBinding()
        ...
        Core.LookupBinder.BindOrganizationLookup(Me.cbOrganization, baseDataSet, "Department.idfOrganization")
