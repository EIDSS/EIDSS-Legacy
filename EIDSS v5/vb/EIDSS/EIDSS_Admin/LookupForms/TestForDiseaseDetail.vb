...
Public Class TestForDiseaseDetail
    ...
    Dim TestForDiseaseDbService As TestForDisease_DB
...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        TestForDiseaseDbService = New TestForDisease_DB

        DbService = TestForDiseaseDbService
        AuditObject = New AuditObject(EIDSSAuditObject.daoTestDiseaseMatrix, AuditTable.trtTestForDisease)
        m_Helper = New ReferenceEditorHelper(gcTest_For_Disease, Nothing, "idfsTestType", "idfsTestType")
    ...
    Private Sub InitializeComponent()
        ...
        Me.gcolTest_Type.FieldName = "idfsTestType"
        ...
        Me.gcolTForDType.FieldName = "idfsTestForDiseaseType"
        ...
        Me.FormID = "A04"
        Me.HelpTopicID = "diagnosis_lab_tests_matrix"
...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Core.LookupBinder.BindDiagnosisHACodeLookup(cbDiagnosis, baseDataSet, LookupTables.StandardDiagnosis, "MasterDiagnosis.idfsDiagnosis", False)
        ...
        Core.LookupBinder.BindBaseRepositoryLookup(redLookUpTest_Type, _
                                              BaseReferenceType.rftTestType)

        Core.LookupBinder.BindBaseRepositoryLookup(redLookUpTForDType, _
                                              BaseReferenceType.rftTestForDiseaseType)
