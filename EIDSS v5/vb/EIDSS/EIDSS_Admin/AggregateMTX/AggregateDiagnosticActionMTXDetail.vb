...
Public Class AggregateDiagnosticActionMTXDetail
    Public Sub New()
        ...
        AuditObject = New Core.EIDSSAuditObject(EIDSSAuditObject.daoAggregateMTX, AuditTable.tlbAggrDiagnosticActionMTX)
...
#End Region
    ...
    Protected Overrides Sub BindView()
        MyBase.BindView()
        Core.LookupBinder.BindDiagnosisHACodeRepositoryLookup(cbDiagnosis, LookupTables.VetAggregatedDiagnosis, True, False)
        Core.LookupBinder.BindBaseRepositoryLookup(cbSpecies, BaseReferenceType.rftSpeciesList, HACode.None, AddressOf Core.LookupBinder.AddSpecies)
        Core.LookupBinder.BindBaseRepositoryLookup(cbDiagnosticAction, db.BaseReferenceType.rftDiagnosticActionList)
