var EIDSS = {
	BvMessages: {
		...
		'errAjaxRequestException': 'Sorry, an error occurred while processing your request.',
		'errInternetConnection': 'An error occurred while attempting to contact the server. Please check your internet connection.',
