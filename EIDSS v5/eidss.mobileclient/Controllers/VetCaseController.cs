...
namespace eidss.mobileclient.Controllers
{
    ...
    public class VetCaseController : Controller
    {
        ...
        public ActionResult ExtendedSearch()
        {
            ...
            ViewBag.Filter = SearchPanelHelper.GetDefaultFilter(accessor.SearchPanelMeta);
        ...
        public ActionResult VetInvestigationReport(long id)
        {
            ...
            using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
            {
                ...
                {
                    // todo: take papameters from singletone
        ...
        public ActionResult Details(FormCollection form)
        {
            ...
            vetCase.Farm.Location.CopyAddressValues(vetCase.Farm.Address);
        ...
        private static void SetDefaultValues(VetCase vetCase)
        {
            ...
            vetCase.strInvestigatedByOffice = EidssUserContext.User.Organization;
