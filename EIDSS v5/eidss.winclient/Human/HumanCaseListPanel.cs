...
namespace eidss.winclient.Human
{
    public partial class HumanCaseListPanel : BaseListPanel_HumanCaseListItem
    {
        ...
        {
            RegisterItem("MenuFindHumanCase", 100, false);
            RegisterItem("ToolbarFindHumanCase", 100, true);
        }
        ...
        public override IApplicationForm Edit(object key, System.Collections.Generic.List<object> parameters, bv.common.Enums.ActionTypes actionType, bool readOnly)
        {
           IObject bo = null;
           ...
           if (detailPanel is IBasePanel)
           {
               ...
               if (foundAction != null)
               {
                   ...
                   {
                       var childObject = foundAction.RunAction(manager, null, new List<object> { key }).obj;
