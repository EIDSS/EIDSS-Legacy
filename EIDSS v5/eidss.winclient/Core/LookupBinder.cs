...
namespace eidss.winclient.Core
{
    public class LookupBinder
    {
        ...
        private static void SetDataSource(RepositoryItemLookUpEdit cb, object ds, string displayMember, string valueMember)
        {
            cb.DataSource = ds;
        ...
        public static void AddLookupClosedHandler(RepositoryItemLookUpEdit cb)
        {
            try
            {
        ...
        private static void AddPerson(object sender, ButtonPressedEventArgs e)
        {
            ...
            if (ActionLocker.LockAction(sender))
            {
                ...
                try
                {
                    ...
                    {
                        if (!EidssUserContext.User.HasPermission(PermissionHelper.InsertPermission(EIDSSPermissionObject.Person)))
                        {
                        ...
                        object id = null;
                        if (BaseFormManager.ShowModal(((IApplicationForm)(ClassLoader.LoadClass("PersonDetailPanel"))), ((Control)sender).FindForm(), ref id, null, null))
                        {
                            var cb = (LookUpEdit)sender;

                            using (var manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
                            {
                                LookupManager.ClearAndReload(manager, "PersonLookup");
                            }
                            SetPersonEditValueAsync(sender, id);
                        }
                    }
                }
                finally
        ...
        //private static System.Text.RegularExpressions.Regex RowFilterExp = new System.Text.RegularExpressions.Regex("\\=\\s*([\\\'a-zA-Z0-9_]*)");
        //private static object GetParentIDFromRowFilter(string filter)
        //{
        //    if (Utils.IsEmpty(filter))
        //    {
        //        return null;
        //    }
        //    System.Text.RegularExpressions.Match m = RowFilterExp.Match(filter);
        ...
        public static void AddVectorType(object sender, ButtonPressedEventArgs e)
        {
            ...
            if (ActionLocker.LockAction(sender))
            {
                ...
                try
                {
                    if (e.Button.Kind == ButtonPredefines.Plus)
                    {
                        var frm = new VectorTypeReferenceMasterDetail();
                        object id = 0;
                        if (BaseFormManager.ShowModal(frm, ((Control)sender).FindForm(), ref id, null, null))
                        {
                            RefreshCache("rftVectorType");
                            SetEditValueAsync(sender, id);
                        }
                    }
                }
        ...
        {
            var lookupList = (List<OrganizationLookup>)((LookUpEdit)sender).Properties.DataSource;
            var value = lookupList.FirstOrDefault(c => c.idfInstitution.Equals(id));
            Application.DoEvents();
            if (value != null)
            {
                ((BaseEdit)sender).EditValue = value;
        ...
        {
            var lookupList = (List<DepartmentLookup>)((LookUpEdit)sender).Properties.DataSource;
            var value = lookupList.FirstOrDefault(c => c.idfDepartment.Equals(id));
            Application.DoEvents();
            if (value != null)
            {
                ((BaseEdit)sender).EditValue = value;
        ...
        public static void BindPersonLookup(LookUpEdit cb, object ds, string bindField, List<PersonLookup> personLookup, bool showClearButton = true)
        {
            cb.Properties.Columns.Clear();
        ...
        public static void BindSiteLookup(LookUpEdit cb, object ds, string bindField, List<SiteLookup> siteLookup, bool showClearButton = true)
        {
            ...
            cb.Properties.Columns.AddRange(new[]
                                               {
                                                   new LookUpColumnInfo("strSiteID", EidssMessages.Get("colSiteID", "Site ID"), 80)
                                                   ,new LookUpColumnInfo("strSiteType",  EidssFields.Get("strSiteType", "Site Type"), 150)
                                                   ,new LookUpColumnInfo("strSiteName",EidssMessages.Get("colSiteName", "Name"), 150)
                                               });
            cb.Properties.PopupWidth = 350;
            SetDataSource(cb, siteLookup, "strSiteID", "");//idfPerson
        ...
        private static void AddOrganizationSearchButton(EditorButtonCollection buttons)
        {
            if (buttons.Cast<EditorButton>().Any(b => b.Kind == ButtonPredefines.Glyph))
                return;
        ...
        private static void SearchOrganization(object sender, ButtonPressedEventArgs e)
        {
            ...
            if (ActionLocker.LockAction(sender))
            {
                ...
                try
                {
                    ...
                    {
                        var bo = BaseFormManager.ShowForSelection((IBaseListPanel)ClassLoader.LoadClass("OrganizationListPanel"), ((Control)sender).FindForm());
                        if (bo != null)
                        {
                            var cb = (LookUpEdit)sender;
        ...
        public static void BindOrganizationLookup(LookUpEdit cb, object dataSource, string bindField, List<OrganizationLookup> organizationLookup, bool showPlusButton = true, RefreshCacheDelegate refreshCache = null)
        {
            cb.Properties.Columns.Clear();
        ...
        public static void BindVectorsLookup(LookUpEdit cb, Vector dataSource, string bindField, EditableList<Vector> vectorLookup)
        {
            cb.Properties.Columns.Clear();
        ...
        public static void BindOrganizationRepositoryLookup(RepositoryItemLookUpEdit cb, List<OrganizationLookup> organizationLookup, string valueMember = "idfInstitution")
        {
            cb.Columns.Clear();
        ...
        private static void CreateDiagnosisColumns(RepositoryItemLookUpEdit cb, int aHACode, bool showAdditionalColumns)
        {
            cb.Columns.Clear();
            cb.Columns.Add(new LookUpColumnInfo("name", EidssMessages.Get("colDiseaseName", "Diagnosis"), 200, FormatType.None, "", true, HorzAlignment.Near));
        ...
        public static void BindDiagnosisHACodeLookup(LookUpEdit cb, object ds, List<DiagnosisLookup> diagnosisLookup, string bindField, HACode aHACode, bool showAdditionalColumns = false, bool showClearButton = true)
        {
            CreateDiagnosisColumns(cb.Properties, (int)aHACode, showAdditionalColumns);
            cb.Properties.PopupWidth = 500;
        ...
        public static void BindDiagnosisAgeGroupLookup(RepositoryItemLookUpEdit cb, DiagnosisAgeGroupToDiagnosis dataSource, string bindField, List<DiagnosisAgeGroupLookup> diagnosisAgeGroupLookup)
        {
            cb.Columns.Clear();
            cb.Columns.AddRange(
                new[]
        ...
        /// <param name="bindField"></param>
        /// <param name="diagnosisAgeGroupLookup"></param>
        public static void BindDiagnosisAgeGroupLookup(LookUpEdit cb, DiagnosisAgeGroup2StatisticalAgeGroupMaster dataSource, string bindField, List<DiagnosisAgeGroupLookup> diagnosisAgeGroupLookup)
        {
            cb.Properties.Columns.Clear();
            cb.Properties.Columns.AddRange(
                new[]
                    {
                        new LookUpColumnInfo("DiagnosisAgeGroupNameTranslated", EidssFields.Get("idfsDiagnosisAgeGroup", "Name"), 100)
                    });
            cb.Properties.PopupWidth = 380;
            SetDataSource(cb, diagnosisAgeGroupLookup, "DiagnosisAgeGroupNameTranslated", "idfsDiagnosisAgeGroup");
            //AddBinding(cb, dataSource, bindField, true);
        ...
        public static void BindDiagnosisRepositoryLookup(RepositoryItemLookUpEdit cb, List<DiagnosisLookup> diagnosisLookup, HACode aHACode, string displayMember = "name", bool showAdditionalColumns = false, bool addClearBtn = true, bool addPlusBtn = false)
        {
            CreateDiagnosisColumns(cb, (int)aHACode, showAdditionalColumns);
            cb.PopupWidth = 400;
            ...
            if (ActionLocker.LockAction(sender))
            {
                ...
                try
                {
                    if (e.Button.Kind == ButtonPredefines.Plus)
                    {
                        ...
                        var cb = (LookUpEdit)sender;
                        object id = null;
                        object parentID = null;//TODO: = GetParentIDFromRowFilter(((DataView)cb.Properties.DataSource).RowFilter);
                        if (BaseFormManager.ShowModal(((IApplicationForm)(ClassLoader.LoadClass("DepartmentDetail"))), cb.FindForm(), ref id, parentID, null))
                        {
        ...
        //{
        //    cb.Columns.AddRange(new LookUpColumnInfo[] { new LookUpColumnInfo("Name", EidssMessages.Get("colName", "Name"), 200, DevExpress.Utils.FormatType.None, "", true, DevExpress.Utils.HorzAlignment.Near) });
        //    cb.PopupWidth = 400;
        ...
        public static void BindVectorType2SampleTypeRepository(RepositoryItemLookUpEdit cb, EditableList<VectorType2SampleTypeLookup> lookup)
        {
            cb.Columns.Clear();
            cb.Columns.AddRange(
                new[]
                    {
                        //new LookUpColumnInfo("idfsSampleType", EidssFields.Get("SampleType", "idfsSampleType"), 80,FormatType.None, String.Empty, false, HorzAlignment.Default)
        ...
        /// <param name="cb"></param>
        /// <param name="lookup"></param>
        public static void BindTypeFieldTestToResultMatrixLookupRepository(RepositoryItemLookUpEdit cb, EditableList<TypeFieldTestToResultMatrixLookup> lookup)
        {
            cb.Columns.Clear();
            cb.Columns.AddRange(
                new[]
        ...
        /// <param name="cb"></param>
        /// <param name="lookup"></param>
        public static void BindDiagnosis2PensideTestMatrixLookupRepository(RepositoryItemLookUpEdit cb, EditableList<Diagnosis2PensideTestMatrixLookup> lookup)
        {
            cb.Columns.Clear();
            cb.Columns.AddRange(
                new[]
