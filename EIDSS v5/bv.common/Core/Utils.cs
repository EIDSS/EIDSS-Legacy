...
namespace bv.common.Core
{
    public class Utils
    {
        ...
        /// <returns> Returns string representation of passed object. If passed object is <b>Nothing</b> or <b>DBNull.Value</b> the method returns empty string. </returns>
        ...
        /// <returns> False if passed object is <b>Nothing</b> or <b>DBNull.Value</b> or its string representation is empty string and True in other case. </returns>
        /// <history>[Mike]	03.04.2006	Created</history>
        /// -----------------------------------------------------------------------------
        ...
        /// <returns> Returns <b>True</b> if requested directory exists or was created successfully and <b>False</b> if requested directory can't be created </returns>
        /// <history>[Mike]	03.04.2006	Created</history>
        /// -----------------------------------------------------------------------------
