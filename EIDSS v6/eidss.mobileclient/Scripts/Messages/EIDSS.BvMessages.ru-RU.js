var EIDSS = {
	BvMessages: {
		...
		'errAjaxRequestException': 'Извините, во время выполнения запроса произошла ошибка.',
		'errInternetConnection': 'При попытке связаться с сервером произошла ошибка. Просьба проверить соединение с Интернетом.',
