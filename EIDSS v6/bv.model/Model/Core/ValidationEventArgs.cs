...
namespace bv.model.Model.Core
{
    public class ValidationEventArgs : EventArgs
    {
        ...
        private readonly bool m_ShouldAsk;
        public bool ShouldAsk { get { return m_ShouldAsk; } }

        public ValidationEventArgs(string msgId, string fldName, string prpName, object[] pars, Type type, IObject obj, bool shouldAsk)
            : base()
        {
            Continue = false;
            m_MsgId = msgId;
