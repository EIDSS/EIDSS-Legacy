        ...
        */
            ...
            where T : IObject
        {
            ...
            if (i != null)
            {
                ...
                throw new ValidationModelException("ErrUniqueness1", m_FldName, m_PrpName, pairs, GetType(), m_ShouldAsk, t);
            }
        }
            ...
            where T : IObject
        {
            ...
            if (i != null)
            {
                ...
                throw new ValidationModelException("ErrUniqueness2", m_FldName, m_PrpName, pairs, GetType(), m_ShouldAsk, t);
            }
        }
            ...
            where T : IObject
        {
            ...
            if (i != null)
            {
                ...
                throw new ValidationModelException("ErrUniqueness3", m_FldName, m_PrpName, pairs, GetType(), m_ShouldAsk, t);
            }
        }
    }
