...
public class FileAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //если это фейковый файл, то ставим метку "вверх"
        TextView tvFilename = (TextView)view.findViewById(R.id.tvFileName);
        ImageView img = (ImageView)view.findViewById(R.id.imgIcon);
        boolean isFakeFile = file.getPath().equals(EidssBaseActivity.FILE_TO_UPPER_DIR);
        if (isFakeFile)
        {
        	tvFilename.setText(EidssBaseActivity.FILE_TO_UPPER_DIR);
        	img.setImageDrawable(null);
        }
        else
        {        	
        	if (file.isDirectory()){
        		img.setImageResource(R.drawable.diricon2);
        	...
        	{
        		img.setImageResource(R.drawable.fileicon2);
