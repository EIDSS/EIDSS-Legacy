...
namespace eidss.winclient.VectorSurveillance
{
    public partial class VsSessionSummaryPanel : BaseGroupPanel_VsSessionSummary
    {
        ...
        public override void InitGridBehavior(IObject dummyObjectWithLookups)
        {
            ...
            if (column != null)
            {
                LookupBinder.BindVectorTypesRepositoryLookup(column.SetLookupEditor(),
                                                             fakeSessionSummary.VectorTypeLookup);
                column.Width = 80;
            }
            ...
            if (column != null)
            {
                ...
                LookupBinder.BindVectorSubTypeRepositoryLookup(le, fakeSessionSummary.VectorSubTypeAllLookup);
                le.QueryPopUp += OnVectorSubTypeQueryPopUp;
                le.QueryCloseUp += OnVectorSubTypeQueryCloseUp;
                column.Width = 80;
            }
        ...
        /// <param name="e"></param>
        private void OnVectorSubTypeQueryCloseUp(object sender, CancelEventArgs e)
        {
            var le = sender as LookUpEdit;
            if (le == null) return;
            le.Properties.DataSource = fakeSessionSummary.VectorSubTypeAllLookup;
        }
        ...
        private void OnVectorSubTypeQueryPopUp(object sender, CancelEventArgs e)
        {
            ...
            var le = sender as LookUpEdit;
            if (le == null) return;
            le.Properties.DataSource = summary.VectorSubTypeLookup;
        }
    }
}
