...
namespace eidss.winclient.VectorSurveillance
{
    public partial class VectorSampleListPanel : BaseGroupPanel_VectorSample
    {
        ...
        public override void InitGridBehavior(IObject dummyObjectWithLookups)
        {
            ...
            if (column != null)
            {
                LookupBinder.BindBaseRepositoryLookup(column.SetLookupEditor(), fakeSample.VectorTypeLookup);
                column.Width = 80;
            }
            ...
            if (column != null)
            {
                ...
                LookupBinder.BindVectorType2SampleTypeRepository(le, fakeSample.VectorType2SampleTypeLookup);
                column.Width = 80;
                le.QueryPopUp += OnLookupSampleTypeQueryPopUp;
                le.QueryCloseUp += OnLookupSampleTypeQueryCloseUp;
            }
            ...
            if (column != null)
            {
                LookupBinder.BindOrganizationRepositoryLookup(column.SetLookupEditor(), fakeSample.SendToOfficeLookup, HACode.Vector);
                column.Width = 220;
            }
            ...
            if (column != null)
            {
                LookupBinder.BindOrganizationRepositoryLookup(column.SetLookupEditor(), fakeSample.FieldCollectedByOfficeLookup, HACode.Vector);
                column.Width = 220;
            }
        ...
        void OnLookupSampleTypeQueryCloseUp(object sender, CancelEventArgs e)
        {
            ...
            if (le == null) return;
            le.Properties.DataSource = fakeSample.VectorType2SampleTypeLookup;
        }
        ...
        void OnLookupSampleTypeQueryPopUp(object sender, CancelEventArgs e)
        {
            ...
            else
            {
                var le = sender as LookUpEdit;
                if (le == null) return;
                le.Properties.DataSource = sample.VectorType2SampleTypeLookup;
            }
        }
