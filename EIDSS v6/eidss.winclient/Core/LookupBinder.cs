...
namespace eidss.winclient.Core
{
    public class LookupBinder
    {
            ...
            lock (m_LookupParams)
            {
                if (m_LookupParams.Count == 0)
                {
                    ...
                    m_LookupParams.Add(typeof(DiagnosisLookup),
                                       new LookupParams("DiagnosisReferenceDetail", "HumanDiagnoses,HumanVetDiagnoses,HumanStandardDiagnosis,AvianStandardDiagnosis,LivestockStandardDiagnosis,VetStandardDiagnosis,HumanAggregatedDiagnosis,AvianAggregatedDiagnosis,LivestockAggregatedDiagnosis,VetAggregatedDiagnosis,VectorDiagnosis,OutbreakDiagnoses",
                                                        EIDSSPermissionObject.Reference, 0));
        ...
        public static void BindPersonLookup(LookUpEdit cb, object ds, string bindField, List<PersonLookup> personLookup, bool showClearButton = true, bool showEditButton = false)
        {
            cb.Properties.Columns.Clear();
        ...
        public static void BindRepositoryLookup<T>(RepositoryItemLookUpEdit cb, object ds, string valueMember, string displayMember, List<T> lookup)
        {
            cb.Columns.Clear();
        ...
        public static void BindRepositoryLookup<T>(RepositoryItemLookUpEdit cb, object ds, List<T> lookup)
        {
            BindRepositoryLookup<T>(cb, ds, "idfsReference", "name", lookup);
        }
      public static void BindPersonRepositoryLookup(RepositoryItemLookUpEdit cb, List<PersonLookup> personLookup)
        ...
        public static void BindTestDiagnosisRepositoryLookup(RepositoryItemLookUpEdit cb, List<TestDiagnosisLookup> testDiagnosisLookup)
        {
            cb.Columns.Clear();
            cb.Columns.AddRange(
                new[]
            ...
            cb.PopupWidth = 200;
            SetDataSource(cb, testDiagnosisLookup, "name", "idfsDiagnosis");
        }
