...
namespace eidss.avr.mweb.Controllers
{
    ...
    public class ChartController : Controller
    {
        ...
        {
            ModelStorage.Remove(Session.SessionID, layoutId, storagePrefixData);

            var viewModel = ModelStorage.Get(Session.SessionID, layoutId, ViewLayoutController.storagePrefix, false) as AvrPivotViewModel;
        ...
        {
            var model = ModelStorage.Get(Session.SessionID, layoutId, ViewLayoutController.storagePrefix) as AvrPivotViewModel;
        ...
        {
            var ret = ModelStorage.Get(Session.SessionID, layoutId, storagePrefix) as byte[];
        ...
        private byte[] GetChartBytesFromService(long layoutId, AvrPivotViewModel viewModel, int width, int height)
        {
            ...
            var tbl = new ChartTableModel(viewModel.ViewHeader.ViewID,
                                    ...
                                    GetChartDataFromSession(layoutId, viewModel),
            ...
            ModelStorage.Put(Session.SessionID, 0, layoutId, storagePrefix, result.Model.JpgBytes);
        ...
        private DataTable GetChartDataFromSession(long layoutId, AvrPivotViewModel viewModel)
        {
            ...
            if (data == null)
            {
                ...
                ModelStorage.Put(Session.SessionID, 0, layoutId, storagePrefixData, data);
            }
