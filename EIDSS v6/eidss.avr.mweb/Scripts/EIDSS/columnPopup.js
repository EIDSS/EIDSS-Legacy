        ...
        onSaveChanges: function() {
            $.ajax({
                ...
                data: {
                    ...
                    aggregateFunctionId: cbAggregateFunction.GetValue(),
                    ...
                    startDate: (typeof dtDiapasonStartDate != "undefined" && dtDiapasonStartDate.GetValue() != null) ? dtDiapasonStartDate.GetValue().toJSON() : '',
                    endDate: (typeof dtDiapasonEndDate != "undefined" && dtDiapasonEndDate.GetValue() != null) ? dtDiapasonEndDate.GetValue().toJSON() : '',
                },
                success: function(data) {
