...
namespace eidss.gis.Forms
{
    public class AvrMapControl:EidssMapControl
    {
        ...
        {
            /*ITheme gradLayerTheme;
            ITheme chartLayerTheme;
            GisInterface.GetAvrStyles(51581690000000, out gradLayerTheme, out chartLayerTheme);
            */
            ...
            try
            {
                ...
                if (eventGroup != null)
                {
                    ...
                    if (settings.MapSettings != null)
                    {
                        ...
                        m_mapImage.MapSettings = EidssMapSerializer.Instance.DeserializeSettingsFromDocument(settings.MapSettings);
                    }
