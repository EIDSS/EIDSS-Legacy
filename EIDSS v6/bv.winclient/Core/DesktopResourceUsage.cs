...
namespace bv.winclient.Core
{
    class DesktopResourceUsage : ResourceUsage
    {
        ...
        const string FormsListFile = @"\Translations\ResourceUsage\FormList.xml";
        const string ResourcesListFile = @"\Translations\ResourceUsage\ResourceUsing.xml";
        ...
        {
            string xmlForms = String.IsNullOrEmpty(xmlFormsFile) ? appDir + FormsListFile : xmlFormsFile;
            string xmlResources = String.IsNullOrEmpty(xmlResourcesFile) ? appDir + ResourcesListFile : xmlResourcesFile;
