...
namespace eidss.model.Schema
{
    ...
    public abstract partial class FarmPanel : 
        ...
        {
            get { return new Func<FarmPanel, AsSession>(c => c.Parent is AsSession ? c.Parent as AsSession : (c.Parent.Parent == null ? null : (c.Parent.Parent is AsSession ? c.Parent.Parent as AsSession : c.Parent.Parent.Parent as AsSession)))(this); }
                    ...
                    
        {
            ...
            internal void _SetupLoad(DbManagerProxy manager, FarmPanel obj, bool bCloning = false)
            {
                ...
                obj._blnAllowFarmReload = true;
                  if (!obj.bInMonitoringSession)
                  {
                    ...
                    {
                      obj.FFPresenterEpi.SetProperties(obj.idfsFormTemplate.Value, obj.idfFarm);
                    }
                    else
                    {
                      ...
                      obj.FFPresenterEpi.SetProperties(EidssSiteContext.Instance.CountryID, null, ((obj.intHACode & 32) > 0) ? FFTypeEnum.LivestockFarmEPI : FFTypeEnum.AvianFarmEPI, obj.idfObservation.Value, obj.idfFarm);
            ...
            private FarmPanel _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                ...
                obj.Address.blnGeoLocationShared = false;
                  if (!obj.bInMonitoringSession)
                  {
                    obj.FFPresenterEpi.SetProperties(EidssSiteContext.Instance.CountryID, null, obj._HACode.Value == (int)eidss.model.Enums.HACode.Livestock ? FFTypeEnum.LivestockFarmEPI : FFTypeEnum.AvianFarmEPI, obj.idfObservation.Value, obj.idfFarm);
