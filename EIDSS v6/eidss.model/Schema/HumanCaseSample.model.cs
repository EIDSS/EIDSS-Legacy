    ...
    public abstract partial class HumanCaseSample : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsSampleType != c.idfsSampleType || o.IsRIRPropChanged(_str_SampleTypeWithUnknown, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfMainTest != c.idfMainTest || o.IsRIRPropChanged(_str_Testing, c)) {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        public partial class HumanCaseSampleGridModelList : List<HumanCaseSampleGridModel>, IGridModelList, IGridModelListLoad
        {
            ...
            private void LoadGridModelList(long key, IEnumerable<HumanCaseSample> items, string errMes)
            {
                ...
                Columns = new List<string> {_str_strSampleName,_str_strFieldBarcode,_str_datFieldCollectionDate,_str_strSendToOffice,_str_datFieldSentDate,_str_strNote,_str_strAccessionCondition,_str_datAccession,_str_strTestName,_str_strTestResult,_str_datTestPerformedDate,_str_strFieldCollectedByOffice,_str_strFieldCollectedByPerson};
                    
                Hiddens = new List<string> {_str_idfMaterial};
                Keys = new List<string> {_str_idfMaterial};
                Labels = new Dictionary<string, string> {{_str_strSampleName, "idfsSampleType"},{_str_strFieldBarcode, "strFieldBarcodeLocal"},{_str_datFieldCollectionDate, _str_datFieldCollectionDate},{_str_strSendToOffice, "strSendToOrganization"},{_str_datFieldSentDate, _str_datFieldSentDate},{_str_strNote, "strComment"},{_str_strAccessionCondition, "idfsAccessionCondition"},{_str_datAccession, _str_datAccession},{_str_strTestName, "TestName"},{_str_strTestResult, "TestResult"},{_str_datTestPerformedDate, "datConcludedDate"},{_str_strFieldCollectedByOffice, "CollectedbyInstitution"},{_str_strFieldCollectedByPerson, "CollectedbyOfficer"}};
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_datFieldSentDate, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strNote,
                    "strComment", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strAccessionCondition,
                    "idfsAccessionCondition", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datAccession,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strTestName,
                    "TestName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strTestResult,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    "datConcludedDate", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFieldCollectedByOffice,
                    "CollectedbyInstitution", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFieldCollectedByPerson,
                    "CollectedbyOfficer", null, true, true, true, true, null
                    ));
