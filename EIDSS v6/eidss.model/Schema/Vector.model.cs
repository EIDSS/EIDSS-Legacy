...
namespace eidss.model.Schema
{
    ...
    public abstract partial class Vector : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfHostVector != c.idfHostVector || o.IsRIRPropChanged(_str_HostVector, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsSurrounding != c.idfsSurrounding || o.IsRIRPropChanged(_str_Surrounding, c)) {
        ...
        {
            get { return new Func<Vector, EditableList<VectorSample>>(c => { var list = new EditableList<VectorSample>(); foreach (var vector in c.Vectors) list.AddRange(vector.Samples); return list;})(this); }
        ...
        private bool _ValidateOnDelete(bool bReport = true)
        {
            ...
            try
            {
              ...
              new object[] {
                        ...
                        false
                    )).Validate(obj, v => v.Samples.Count == 0
                    );
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        public partial class VectorGridModelList : List<VectorGridModel>, IGridModelList, IGridModelListLoad
        {
            ...
            private void LoadGridModelList(long key, IEnumerable<Vector> items, string errMes)
            {
                ...
                Actions = new Dictionary<string, ActionMetaItem> {{_str_strVectorID, Accessor.Instance(null).Actions.SingleOrDefault(c => c.Name == "ActionEditVector")}};
                ...
                
        {
            ...
            public void LoadLookup_Surrounding(DbManagerProxy manager, Vector obj)
            {
                ...
                LookupManager.AddObject("rftSurrounding", obj, SurroundingAccessor.GetType(), "rftSurrounding_SelectList"
                  , "SelectLookupList");
            }
            ...
            public void LoadLookup_DayPeriod(DbManagerProxy manager, Vector obj)
            {
                ...
                LookupManager.AddObject("rftCollectionTimePeriod", obj, DayPeriodAccessor.GetType(), "rftCollectionTimePeriod_SelectList"
                  , "SelectLookupList");
            }
    ...
    new ChainsValidatorDateTime<Vector>(obj, "datCollectionDateTime", c => true, 
      ...
      false, listdatCollectionDateTime => {
            ...
            public bool Validate(DbManagerProxy manager, Vector obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
                ...
                (new RequiredValidator( "strCollectedByOffice", "strCollectedByOffice","",
                false
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfVector,
                    _str_idfVector, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strVectorID,
                    "Vector.strVectorID", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFieldVectorID,
                    "Vector.strFieldVectorID", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strRegion,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strSettlement,
                    "Vector.strSettlement", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_dblLongitude,
                    "VsSessionListItem.dblLongitude", "{0:F5}", true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_dblLatitude,
                    "VsSessionListItem.dblLatitude", "{0:F5}", true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intElevation,
                    _str_intElevation, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSurrounding,
                    _str_strSurrounding, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strDayPeriod,
                    _str_strDayPeriod, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCollectedByPerson,
                    "Vector.idfFieldCollectedByPerson", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCollectedByOffice,
                    "VectorSample.idfFieldCollectedByOffice", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSpecies,
                    _str_strSpecies, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intQuantity,
                    _str_intQuantity, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSex,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_strEctoparasitesCollected, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strHostVector,
                    "idfHostVector", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCollectionMethod,
                    _str_strCollectionMethod, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strBasisOfRecord,
                    _str_strBasisOfRecord, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strGEOReferenceSources,
                    _str_strGEOReferenceSources, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strIdentifiedByPerson,
                    _str_strIdentifiedByPerson, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strIdentifiedByOffice,
                    _str_strIdentifiedByOffice, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datIdentifiedDateTime,
                    _str_datIdentifiedDateTime, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strIdentificationMethod,
                    _str_strIdentificationMethod, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strVectorSpecificData,
                    _str_strVectorSpecificData, null, true, true, true, true, null
                    ));
    ...
    public abstract partial class CopyDialogWindowItem : 
        ...
        protected class field_info
        {
            ...
            internal Action<CopyDialogWindowItem, CopyDialogWindowItem, CompareModel> _compare_func;
        }
        internal const string _str_Parent = "Parent";
        internal const string _str_IsNew = "IsNew";
    ...
    public void AddHiddenPersonalData(string name, Func<CopyDialogWindowItem, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                ...
                
        {
            ...
            private delegate void on_action(CopyDialogWindowItem obj);
            private static Accessor g_Instance = CreateInstance<Accessor>();
            private CacheScope m_CS;
            public static Accessor Instance(CacheScope cs) 
            { 
            ...
            private List<CopyDialogWindowItem> _SelectList(DbManagerProxy manager
                , Int64? idfVectorSurveillanceSession
                , on_action loading, on_action loaded
                )
            {
            ...
            private CopyDialogWindowItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    CopyDialogWindowItem obj = CopyDialogWindowItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, CopyDialogWindowItem obj)
            {
