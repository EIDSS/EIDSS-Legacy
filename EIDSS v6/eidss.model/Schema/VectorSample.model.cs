    ...
    public abstract partial class VectorSample : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsSampleType != c.idfsSampleType || o.IsRIRPropChanged(_str_VectorType2SampleType, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsSampleType != c.idfsSampleType || o.IsRIRPropChanged(_str_VectorType2SampleTypeFiltered, c)) {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                ...
                
        {
            ...
            public void LoadLookup_VectorType2SampleType(DbManagerProxy manager, VectorSample obj)
            {
                ...
                LookupManager.AddObject("VectorType2SampleTypeLookup", obj, VectorType2SampleTypeAccessor.GetType(), "SelectLookupList");
            }
            ...
            public void LoadLookup_VectorType2SampleTypeFiltered(DbManagerProxy manager, VectorSample obj)
            {
                ...
                LookupManager.AddObject("VectorType2SampleTypeLookup", obj, VectorType2SampleTypeFilteredAccessor.GetType(), "SelectLookupList");
            }
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strBarcode,
                    "VectorSample.strBarcode", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfsSampleType,
                    _str_idfsSampleType, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSampleType,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_strSendToOffice, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strNote,
                    "VectorSample.strNote", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datAccession,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfsAccessionCondition, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
