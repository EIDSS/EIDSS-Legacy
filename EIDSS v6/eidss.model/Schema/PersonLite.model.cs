...
namespace eidss.model.Schema
{
    ...
    public abstract partial class PersonLite : 
        ...
        protected class field_info
        {
            ...
            internal Action<PersonLite, PersonLite, CompareModel> _compare_func;
        }
        ...
        private bool _isReadOnly(string name)
        {
            ...
            if (readonly_names2.Where(c => c == name).Count() > 0)
                return ReadOnly || new Func<PersonLite, bool>(c => !EidssUserContext.User.HasPermission(PermissionHelper.ExecutePermission(EIDSSPermissionObject.ManageRightsRemotely)))(this);
    ...
    public void AddHiddenPersonalData(string name, Func<PersonLite, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(PersonLite obj);
            ...
            private PersonLite _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    PersonLite obj = PersonLite.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, PersonLite obj)
            {
    ...
    public abstract partial class PersonLiteGroupInfo : 
        ...
        protected class field_info
        {
            ...
            internal Action<PersonLiteGroupInfo, PersonLiteGroupInfo, CompareModel> _compare_func;
        }
        internal const string _str_Parent = "Parent";
        internal const string _str_IsNew = "IsNew";
    ...
    public void AddHiddenPersonalData(string name, Func<PersonLiteGroupInfo, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(PersonLiteGroupInfo obj);
            private static Accessor g_Instance = CreateInstance<Accessor>();
            private CacheScope m_CS;
            public static Accessor Instance(CacheScope cs) 
            { 
            ...
            private PersonLiteGroupInfo _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    PersonLiteGroupInfo obj = PersonLiteGroupInfo.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, PersonLiteGroupInfo obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfEmployeeGroup, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strName,
                    _str_strName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strDescription,
                    _str_strDescription, null, true, true, true, true, null
                    ));
                Actions.Add(new ActionMetaItem(
                    "AddGroupInfo",
                    ActionTypes.Action,
