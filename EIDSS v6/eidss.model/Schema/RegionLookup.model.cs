...
namespace eidss.model.Schema
{
    ...
    public abstract partial class RegionLookup : 
        ...
        [LocalizedDisplayName(_str_strExtendedRegionName)]
        [MapField(_str_strExtendedRegionName)]
        public abstract String strExtendedRegionName { get; set; }
        protected String strExtendedRegionName_Original { get { return ((EditableValue<String>)((dynamic)this)._strExtendedRegionName).OriginalValue; } }
        protected String strExtendedRegionName_Previous { get { return ((EditableValue<String>)((dynamic)this)._strExtendedRegionName).PreviousValue; } }
        ...
        protected class field_info
        {
            ...
            internal Action<RegionLookup, RegionLookup, CompareModel> _compare_func;
        }
        ...
        internal const string _str_strExtendedRegionName = "strExtendedRegionName";
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_strExtendedRegionName, _formname = _str_strExtendedRegionName, _type = "String",
              _get_func = o => o.strExtendedRegionName,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseString(val); if (o.strExtendedRegionName != newval) o.strExtendedRegionName = newval; },
              _compare_func = (o, c, m) => {
                if (o.strExtendedRegionName != c.strExtendedRegionName || o.IsRIRPropChanged(_str_strExtendedRegionName, c)) 
                  m.Add(_str_strExtendedRegionName, o.ObjectIdent + _str_strExtendedRegionName, o.ObjectIdent2 + _str_strExtendedRegionName, o.ObjectIdent3 + _str_strExtendedRegionName, "String", 
                    o.strExtendedRegionName == null ? "" : o.strExtendedRegionName.ToString(),                  
                  o.IsReadOnly(_str_strExtendedRegionName), o.IsInvisible(_str_strExtendedRegionName), o.IsRequired(_str_strExtendedRegionName)); 
                  }
              }, 
    ...
    public void AddHiddenPersonalData(string name, Func<RegionLookup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
            ...
            
        {
            ...
            private delegate void on_action(RegionLookup obj);
            ...
            private List<RegionLookup> _SelectList(DbManagerProxy manager
                , Int64? CountryID
                , Int64? ID
            ...
            private RegionLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    RegionLookup obj = RegionLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, RegionLookup obj)
            {
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                Sizes.Add(_str_strExtendedRegionName, 365);
