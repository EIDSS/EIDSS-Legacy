      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfDataAuditEvent, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datEnteringDate,
                    "datTransactionDate", "G", true, true, true, true, ListSortDirection.Descending
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strObjectType,
                    _str_strObjectType, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strActionName,
                    _str_strActionName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strPersonName,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strSiteID,
                    "idfsSite", null, true, true, true, true, null
                    ));
