...
namespace eidss.model.Schema
{
    ...
    public abstract partial class BasicSyndromicSurveillanceAggregateList : 
        ...
        protected class field_info
        {
            ...
            internal Action<BasicSyndromicSurveillanceAggregateList, BasicSyndromicSurveillanceAggregateList, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<BasicSyndromicSurveillanceAggregateList, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(BasicSyndromicSurveillanceAggregateList obj);
            ...
            private List<BasicSyndromicSurveillanceAggregateList> _SelectList(DbManagerProxy manager
            ...
            private BasicSyndromicSurveillanceAggregateList _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    BasicSyndromicSurveillanceAggregateList obj = BasicSyndromicSurveillanceAggregateList.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, BasicSyndromicSurveillanceAggregateList obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfAggregateHeader, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFormID,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strWeek,
                    "WeekForAggr", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strHospitals,
