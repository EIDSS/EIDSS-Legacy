...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetCaseLog : 
        ...
        protected class field_info
        {
            ...
            internal Action<VetCaseLog, VetCaseLog, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsCaseLogStatus != c.idfsCaseLogStatus || o.IsRIRPropChanged(_str_CaseLogStatus, c)) {
    ...
    public void AddHiddenPersonalData(string name, Func<VetCaseLog, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        public class VetCaseLogGridModel : IGridModelItem
        {
            ...
            public DateTime? datCaseLogDate { get; set; }
                ...
                
        {
            ...
            private delegate void on_action(VetCaseLog obj);
            ...
            private List<VetCaseLog> _SelectList(DbManagerProxy manager
                , Int64? idfCase
            ...
            private VetCaseLog _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    VetCaseLog obj = VetCaseLog.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public void LoadLookup_CaseLogStatus(DbManagerProxy manager, VetCaseLog obj)
            {
                ...
                LookupManager.AddObject("rftVetCaseLogStatus", obj, CaseLogStatusAccessor.GetType(), "rftVetCaseLogStatus_SelectList"
                  , "SelectLookupList");
            }
            ...
            private void _LoadLookups(DbManagerProxy manager, VetCaseLog obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfVetCaseLog,
                    _str_idfVetCaseLog, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strActionRequired,
                    _str_strActionRequired, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datCaseLogDate,
                    _str_datCaseLogDate, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strPerson,
                    "strPersonEnteredBy", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strNote,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_strCaseLogStatus, null, true, true, true, true, null
                    ));
