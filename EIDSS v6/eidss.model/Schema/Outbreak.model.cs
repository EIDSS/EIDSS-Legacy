...
namespace eidss.model.Schema
{
    ...
    public abstract partial class Outbreak : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsDiagnosisOrDiagnosisGroup != c.idfsDiagnosisOrDiagnosisGroup || o.IsRIRPropChanged(_str_Diagnosis, c)) {
    ...
    public abstract partial class OutbreakCase : 
        ...
        protected class field_info
        {
            ...
            internal Action<OutbreakCase, OutbreakCase, CompareModel> _compare_func;
        }
        internal const string _str_Parent = "Parent";
        internal const string _str_IsNew = "IsNew";
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        public partial class OutbreakCaseGridModelList : List<OutbreakCaseGridModel>, IGridModelList, IGridModelListLoad
        {
            ...
            private void LoadGridModelList(long key, IEnumerable<OutbreakCase> items, string errMes)
            {
                ...
                {
                    ItemKey=c.idfCase,strCaseID=c.strCaseID,datEnteredDate=c.datEnteredDate,strSourceOfCaseSessionDate=c.strSourceOfCaseSessionDate,strCaseStatus=c.strCaseStatus,strDiagnosis=c.strDiagnosis,strGeoLocation=c.strGeoLocation,strAddress=c.strAddress,strPatientName=c.strPatientName
                }));
                if (Count > 0)
                {
                ...
                
        {
            ...
            private delegate void on_action(OutbreakCase obj);
            private static Accessor g_Instance = CreateInstance<Accessor>();
            private CacheScope m_CS;
            public static Accessor Instance(CacheScope cs) 
            { 
            ...
            private List<OutbreakCase> _SelectList(DbManagerProxy manager
                , Int64? OutbreakID
                , on_action loading, on_action loaded
                )
            {
            ...
            private OutbreakCase _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    OutbreakCase obj = OutbreakCase.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, OutbreakCase obj)
            {
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strCaseID,
                    "strCaseSessionID", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datEnteredDate,
                    "strCaseSessionDate", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSourceOfCaseSessionDate,
                    _str_strSourceOfCaseSessionDate, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCaseStatus,
                    "CaseStatusName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strDiagnosis,
                    "DiagnosisName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strGeoLocation,
                    "strExposureLocation", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strAddress,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strPatientName,
                    _str_strPatientName, null, true, true, true, true, null
                    ));
                Actions.Add(new ActionMetaItem(
                    "Create",
                    ActionTypes.Create,
    ...
    public abstract partial class OutbreakNote : 
        ...
        protected class field_info
        {
            ...
            internal Action<OutbreakNote, OutbreakNote, CompareModel> _compare_func;
        }
        internal const string _str_Parent = "Parent";
        internal const string _str_IsNew = "IsNew";
        ...
        private static string[] readonly_names1 = "FullName,strInstitution".Split(new char[] { ',' });
    ...
    public void AddHiddenPersonalData(string name, Func<OutbreakNote, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                ...
                
        {
            ...
            private delegate void on_action(OutbreakNote obj);
            private static Accessor g_Instance = CreateInstance<Accessor>();
            private CacheScope m_CS;
            public static Accessor Instance(CacheScope cs) 
            { 
            ...
            private List<OutbreakNote> _SelectList(DbManagerProxy manager
                , Int64? OutbreakID
                , on_action loading, on_action loaded
                )
            {
            ...
            private OutbreakNote _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    OutbreakNote obj = OutbreakNote.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.strInstitution = new Func<OutbreakNote, string>(c => EidssUserContext.User.Organization)(obj);
                    // created extenters - end
            ...
            private void _LoadLookups(DbManagerProxy manager, OutbreakNote obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfOutbreakNote, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strNote,
                    "Note", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datNoteDate,
                    "datDate", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_FullName,
                    "CreatedName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strInstitution,
                    "strInstitutionName", null, true, true, true, true, null
                    ));
                Actions.Add(new ActionMetaItem(
                    "Create",
                    ActionTypes.Create,
