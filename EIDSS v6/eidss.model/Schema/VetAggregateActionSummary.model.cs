...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetAggregateActionSummary : 
        ...
        protected class field_info
        {
            ...
            internal Action<VetAggregateActionSummary, VetAggregateActionSummary, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<VetAggregateActionSummary, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(VetAggregateActionSummary obj);
                ...
                )
            {
                ...
                try
                {
                    ...
                    VetAggregateActionSummary obj = objs[0];
                    obj.m_CS = m_CS;
            ...
            private VetAggregateActionSummary _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    VetAggregateActionSummary obj = VetAggregateActionSummary.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, VetAggregateActionSummary obj)
            {
