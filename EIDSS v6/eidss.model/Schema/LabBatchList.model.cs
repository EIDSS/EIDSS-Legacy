      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            public void LoadLookup_BatchStatusName(DbManagerProxy manager, LabBatchListItem obj)
            {
                ...
                LookupManager.AddObject("rftTestStatus", obj, BatchStatusNameAccessor.GetType(), "rftTestStatus_SelectList"
                  , "SelectLookupList");
            }
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfBatchTest,
                    _str_idfBatchTest, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strBarcode,
                    _str_strBarcode, null, true, true, true, true, ListSortDirection.Descending
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_TestName,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_datPerformedDate, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datValidatedDate,
                    _str_datValidatedDate, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_TestsInBatchCount,
                    "TestsCount", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_StatusName,
                    _str_StatusName, null, true, true, true, true, null
                    ));
