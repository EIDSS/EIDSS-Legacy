...
namespace eidss.model.Schema
{
    ...
    public abstract partial class Organization : 
        ...
        protected class field_info
        {
            ...
            internal Action<Organization, Organization, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<Organization, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(Organization obj);
            ...
            private Organization _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    Organization obj = Organization.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, Organization obj)
            {
    ...
    public abstract partial class OrganizationsDepartment : 
        ...
        protected class field_info
        {
            ...
            internal Action<OrganizationsDepartment, OrganizationsDepartment, CompareModel> _compare_func;
        }
        internal const string _str_Parent = "Parent";
        internal const string _str_IsNew = "IsNew";
    ...
    public void AddHiddenPersonalData(string name, Func<OrganizationsDepartment, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(OrganizationsDepartment obj);
            private static Accessor g_Instance = CreateInstance<Accessor>();
            private CacheScope m_CS;
            public static Accessor Instance(CacheScope cs) 
            { 
            ...
            private OrganizationsDepartment _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    OrganizationsDepartment obj = OrganizationsDepartment.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, OrganizationsDepartment obj)
            {
    ...
    public abstract partial class OrganizationsPerson : 
        ...
        protected class field_info
        {
            ...
            internal Action<OrganizationsPerson, OrganizationsPerson, CompareModel> _compare_func;
        }
        internal const string _str_Parent = "Parent";
        internal const string _str_IsNew = "IsNew";
    ...
    public void AddHiddenPersonalData(string name, Func<OrganizationsPerson, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(OrganizationsPerson obj);
            private static Accessor g_Instance = CreateInstance<Accessor>();
            private CacheScope m_CS;
            public static Accessor Instance(CacheScope cs) 
            { 
            ...
            private OrganizationsPerson _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    OrganizationsPerson obj = OrganizationsPerson.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, OrganizationsPerson obj)
            {
