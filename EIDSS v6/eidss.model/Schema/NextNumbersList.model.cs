      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfsNumberName,
                    _str_idfsNumberName, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strObjectName,
                    _str_strObjectName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strPrefix,
                    _str_strPrefix, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intNumberValue,
                    _str_intNumberValue, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intMinNumberLength,
                    _str_intMinNumberLength, null, true, true, true, true, null
                    ));
