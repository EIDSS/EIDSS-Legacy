      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfObjectAccess, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_FunctionName,
                    _str_FunctionName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_ObjectOperationName,
                    _str_ObjectOperationName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_isDeny,
                    _str_isDeny, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_isAllow,
                    _str_isAllow, null, true, true, true, true, null
                    ));
