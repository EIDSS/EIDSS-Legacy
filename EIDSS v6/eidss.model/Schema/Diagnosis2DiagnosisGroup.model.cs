...
namespace eidss.model.Schema
{
    ...
    public abstract partial class Diagnosis2DiagnosisGroup : 
        ...
        protected class field_info
        {
            ...
            internal Action<Diagnosis2DiagnosisGroup, Diagnosis2DiagnosisGroup, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _set_func = (o, val) => { var newval = ParsingHelper.ParseInt64(val); if (o.idfsDiagnosisGroup != newval) o.idfsDiagnosisGroup = newval; },
              _compare_func = (o, c, m) => {
    ...
    public void AddHiddenPersonalData(string name, Func<Diagnosis2DiagnosisGroup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                ...
                
        {
            ...
            private delegate void on_action(Diagnosis2DiagnosisGroup obj);
            ...
            private List<Diagnosis2DiagnosisGroup> _SelectList(DbManagerProxy manager
                , Int64? idfDiagnosisToDiagnosisGroup
            ...
            private Diagnosis2DiagnosisGroup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    Diagnosis2DiagnosisGroup obj = Diagnosis2DiagnosisGroup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, Diagnosis2DiagnosisGroup obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfDiagnosisToDiagnosisGroup, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsDiagnosis,
