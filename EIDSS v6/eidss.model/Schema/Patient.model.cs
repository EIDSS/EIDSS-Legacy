    ...
    public abstract partial class Patient : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsPersonIDType != c.idfsPersonIDType || o.IsRIRPropChanged(_str_PersonIDType, c)) {
        ...
        private static string[] readonly_names5 = "strPersonID".Split(new char[] { ',' });
        
        private static string[] readonly_names6 = "datEnteredDate,datModificationDate".Split(new char[] { ',' });
        ...
        private bool _isReadOnly(string name)
        {
            ...
            if (readonly_names5.Where(c => c == name).Count() > 0)
                return ReadOnly || new Func<Patient, bool>(c => c.IsReadOnlyParent || !c.idfsPersonIDType.HasValue || c.idfsPersonIDType.Value == (long)eidss.model.Enums.PersonalIDType.Unknown)(this);
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            public void LoadLookup_PersonIDType(DbManagerProxy manager, Patient obj)
            {
                ...
                LookupManager.AddObject("rftPersonIDType", obj, PersonIDTypeAccessor.GetType(), "rftPersonIDType_SelectList"
                  , "SelectLookupList");
            }
            ...
            public bool Validate(DbManagerProxy manager, Patient obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
                ...
                false
              )).Validate(c => c.idfsPersonIDType.HasValue && c.idfsPersonIDType.Value != (long)eidss.model.Enums.PersonalIDType.Unknown, obj, obj.strPersonID);
            
                (new RequiredValidator( "intPatientAgeFromCase", "intPatientAgeFromCase","",
                false
              )).Validate(c => c.idfsHumanAgeTypeFromCase.HasValue || (c.Parent != null && c.Parent is HumanCase && EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.HumanCase_Patient_Age)), obj, obj.intPatientAgeFromCase);
            
                (new RequiredValidator( "idfsHumanAgeTypeFromCase", "idfsHumanAgeTypeFromCase","",
                false
              )).Validate(c => c.intPatientAgeFromCase.HasValue || (c.Parent != null && c.Parent is HumanCase && EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.HumanCase_Patient_AgeType)), obj, obj.idfsHumanAgeTypeFromCase);
            ...
            private void _SetupRequired(Patient obj)
            {
                ...
                obj
                    .AddRequired("strPersonID", c => c.idfsPersonIDType.HasValue && c.idfsPersonIDType.Value != (long)eidss.model.Enums.PersonalIDType.Unknown);
                    
                obj
                    .AddRequired("intPatientAgeFromCase", c => c.idfsHumanAgeTypeFromCase.HasValue || (c.Parent != null && c.Parent is HumanCase && EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.HumanCase_Patient_Age)));
                    
                obj
                    .AddRequired("idfsHumanAgeTypeFromCase", c => c.intPatientAgeFromCase.HasValue || (c.Parent != null && c.Parent is HumanCase && EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.HumanCase_Patient_AgeType)));
                    
                  obj
                    .AddRequired("HumanAgeType", c => c.intPatientAgeFromCase.HasValue || (c.Parent != null && c.Parent is HumanCase && EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.HumanCase_Patient_AgeType)));
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                if (!RequiredByField.ContainsKey("strPersonID")) RequiredByField.Add("strPersonID", c => c.idfsPersonIDType.HasValue && c.idfsPersonIDType.Value != (long)eidss.model.Enums.PersonalIDType.Unknown);
                if (!RequiredByProperty.ContainsKey("strPersonID")) RequiredByProperty.Add("strPersonID", c => c.idfsPersonIDType.HasValue && c.idfsPersonIDType.Value != (long)eidss.model.Enums.PersonalIDType.Unknown);
                
                if (!RequiredByField.ContainsKey("intPatientAgeFromCase")) RequiredByField.Add("intPatientAgeFromCase", c => c.idfsHumanAgeTypeFromCase.HasValue || (c.Parent != null && c.Parent is HumanCase && EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.HumanCase_Patient_Age)));
                if (!RequiredByProperty.ContainsKey("intPatientAgeFromCase")) RequiredByProperty.Add("intPatientAgeFromCase", c => c.idfsHumanAgeTypeFromCase.HasValue || (c.Parent != null && c.Parent is HumanCase && EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.HumanCase_Patient_Age)));
                
                if (!RequiredByField.ContainsKey("idfsHumanAgeTypeFromCase")) RequiredByField.Add("idfsHumanAgeTypeFromCase", c => c.intPatientAgeFromCase.HasValue || (c.Parent != null && c.Parent is HumanCase && EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.HumanCase_Patient_AgeType)));
                if (!RequiredByProperty.ContainsKey("idfsHumanAgeTypeFromCase")) RequiredByProperty.Add("idfsHumanAgeTypeFromCase", c => c.intPatientAgeFromCase.HasValue || (c.Parent != null && c.Parent is HumanCase && EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.HumanCase_Patient_AgeType)));
