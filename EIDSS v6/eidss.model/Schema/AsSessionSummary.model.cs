...
namespace eidss.model.Schema
{
    ...
    public abstract partial class AsSessionSummary : 
        ...
        {
            get { return new Func<AsSessionSummary, List<VetFarmTree>>(c => c.Parent == null ? new List<VetFarmTree>() : (c.Parent as AsSession).ASFarmsSummary.SingleOrDefault(i => i.idfFarm == c.idfFarm, farm => farm.Farm.FarmTree.Where(i => i.idfsPartyType == (long)PartyTypeEnum.Species && !i.IsMarkedToDelete && ( !(c.Parent as AsSession).Diseases.Any(j => !j.IsMarkedToDelete && j.idfsSpeciesType.HasValue) || (c.Parent as AsSession).Diseases.Any(j => !j.IsMarkedToDelete && j.idfsSpeciesType == i.idfsSpeciesTypeReference) ) ).ToList()))(this); }
        ...
        {
            get { return new Func<AsSessionSummary, List<AsSessionDisease>>(c => new List<AsSessionDisease>((c.Parent as AsSession)
                ...
                
        {
            ...
            private void _SetupHandlers(AsSessionSummary obj)
            {
              ...
              new object[] {
                ...
                obj.Species = (new SetScalarHandler()).Handler(obj,
                    obj.idfFarm, obj.idfFarm_Previous, obj.Species,
                    (o, fld, prev_fld) => null);
            ...
            public void LoadLookup_AnimalSex(DbManagerProxy manager, AsSessionSummary obj)
            {
                ...
                LookupManager.AddObject("rftAnimalSex", obj, AnimalSexAccessor.GetType(), "rftAnimalSex_SelectList"
                  , "SelectLookupList");
            }
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfMonitoringSessionSummary, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFarmCode,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_intSampledAnimalsQty, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSamplesCalc,
                    "AsSessionSummary.strSamples", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intSamplesQty,
                    _str_intSamplesQty, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datCollectionDate,
                    _str_datCollectionDate, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intPositiveAnimalsQty,
                    _str_intPositiveAnimalsQty, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strDiagnosisCalc,
                    "strDiagnosis", null, true, true, true, true, null
                    ));
