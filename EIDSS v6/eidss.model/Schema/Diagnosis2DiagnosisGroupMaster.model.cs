...
namespace eidss.model.Schema
{
    ...
    public abstract partial class Diagnosis2DiagnosisGroupMaster : 
        ...
        protected class field_info
        {
            ...
            internal Action<Diagnosis2DiagnosisGroupMaster, Diagnosis2DiagnosisGroupMaster, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<Diagnosis2DiagnosisGroupMaster, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(Diagnosis2DiagnosisGroupMaster obj);
                ...
                )
            {
                ...
                try
                {
                    ...
                    Diagnosis2DiagnosisGroupMaster obj = objs[0];
                    obj.m_CS = m_CS;
            ...
            private Diagnosis2DiagnosisGroupMaster _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    Diagnosis2DiagnosisGroupMaster obj = Diagnosis2DiagnosisGroupMaster.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, Diagnosis2DiagnosisGroupMaster obj)
            {
                ...
                .Where(c => c.Item2 > 1).Select(c => c.Item1).FirstOrDefault(),
                    (o, i) => new Tuple<
                      ...
                      "idfsDiagnosis", 
                        ...
                        i.idfsDiagnosis,"idfsDiagnosisGroup", 
                        
                        i.idfsDiagnosisGroup
                      )
                );
