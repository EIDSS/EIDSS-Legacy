...
namespace eidss.model.Schema
{
    ...
    public abstract partial class TestForDiseaseLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<TestForDiseaseLookup, TestForDiseaseLookup, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<TestForDiseaseLookup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
            ...
            
        {
            ...
            private delegate void on_action(TestForDiseaseLookup obj);
            ...
            private List<TestForDiseaseLookup> _SelectList(DbManagerProxy manager
            ...
            private TestForDiseaseLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    TestForDiseaseLookup obj = TestForDiseaseLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, TestForDiseaseLookup obj)
            {
