...
namespace eidss.model.Schema
{
    ...
    public abstract partial class AsSessionAnimalSample : 
        ...
        protected class field_info
        {
            ...
            internal Action<AsSessionAnimalSample, AsSessionAnimalSample, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfFarm != c.idfFarm || o.IsRIRPropChanged(_str_Farms, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfSpecies != c.idfSpecies || o.IsRIRPropChanged(_str_Species, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.strAnimalCode != c.strAnimalCode || o.IsRIRPropChanged(_str_Animals, c)) {
        ...
        public List<AsSessionAnimalSample> AnimalsLookup
        {
            ...
            { 
                ...
                if (ParentAnimals != null)
                {
                    ...
                    if (IsNew && !ParentAnimals.Any(c => c.strAnimalCode == this.strAnimalCode))
                        ret.Add(this);
        ...
        {
            get { return new Func<AsSessionAnimalSample, List<VetFarmTree>>(c => c.Parent == null ? new List<VetFarmTree>() : (c.Parent as AsSession).ASFarmsDetails.SingleOrDefault(i => i.idfFarm == c.idfFarm, farm => farm.Farm.FarmTree.Where(i => i.idfsPartyType == (long)PartyTypeEnum.Species && !i.IsMarkedToDelete && ( !(c.Parent as AsSession).Diseases.Any(j => !j.IsMarkedToDelete && j.idfsSpeciesType.HasValue) || (c.Parent as AsSession).Diseases.Any(j => !j.IsMarkedToDelete && j.idfsSpeciesType == i.idfsSpeciesTypeReference) )).ToList()))(this); }
        ...
        private bool _ValidateOnDelete(bool bReport = true)
        {
            ...
            try
            {
              ...
              new object[] {
                        ...
                        false
                    )).Validate(obj, c => !(c.Parent as AsSession).CaseTests.Any(i => !i.IsMarkedToDelete && i.idfMaterial == c.idfMaterial)
                    );
        ...
        private bool _isReadOnly(string name)
        {
            ...
            if (readonly_names2.Where(c => c == name).Count() > 0)
                return ReadOnly || new Func<AsSessionAnimalSample, bool>(c => c.Used)(this);
            
            if (readonly_names3.Where(c => c == name).Count() > 0)
                return ReadOnly || new Func<AsSessionAnimalSample, bool>(c => c.Used || c.SampleType == null)(this);
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        public partial class AsSessionAnimalSampleGridModelList : List<AsSessionAnimalSampleGridModel>, IGridModelList, IGridModelListLoad, IGridModelListSequence
        {
            ...
            private void LoadGridModelList(long key, IEnumerable<AsSessionAnimalSample> items, string errMes)
            {
                ...
                Hiddens = new List<string> {_str_id,_str_idfsSpeciesType};
                ...
                {
                    ItemKey=c.id,idfsSpeciesType=c.idfsSpeciesType,SequenceNumber=c.SequenceNumber,strFarmCode=c.strFarmCode,strSpeciesType=c.strSpeciesType,strAnimalCode=c.strAnimalCode,AnimalAge=c.AnimalAge,strColor=c.strColor,AnimalGender=c.AnimalGender,strName=c.strName,strDescription=c.strDescription,SampleType=c.SampleType,strFieldBarcode=c.strFieldBarcode,datFieldCollectionDate=c.datFieldCollectionDate,strSendToOffice=c.strSendToOffice
                }));
                if (Count > 0)
                {
                ...
                
        {
            ...
            private delegate void on_action(AsSessionAnimalSample obj);
            ...
            private List<AsSessionAnimalSample> _SelectList(DbManagerProxy manager
                , Int64? idfMonitoringSession
            ...
            private AsSessionAnimalSample _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    AsSessionAnimalSample obj = AsSessionAnimalSample.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.strAnimalCode = "(new animal " + ++(Parent as AsSession).newCounterAnimal + ")";
                obj.idfMonitoringSession = new Func<AsSessionAnimalSample, long?>(c => (Parent as AsSession).idfMonitoringSession)(obj);
                ...
                )
            {
                ...
                obj.SampleType = new Func<AsSessionAnimalSample, SampleTypeForDiagnosisLookup>(c => original.SampleType == null ? null : c.SampleTypeLookup.SingleOrDefault(i => i.idfsReference == original.SampleType.idfsReference))(obj);
            ...
            private void _SetupHandlers(AsSessionAnimalSample obj)
            {
                ...
                obj.Species = new Func<AsSessionAnimalSample, VetFarmTree>(c => c.SpeciesLookup.Count() != 1 ? null : c.SpeciesLookup[0])(obj);
                        }
              ...
              */
                ...
                obj.AnimalAge = new Func<AsSessionAnimalSample, AnimalAgeLookup>(c => c.AnimalsLookup.SingleOrDefault(i => i.idfAnimal == c.idfAnimal, i => i.AnimalAge))(obj);
                        }
                    
                        if (e.PropertyName == _str_idfAnimal)
                        {
                    
                obj.strColor = new Func<AsSessionAnimalSample, string>(c => c.AnimalsLookup.SingleOrDefault(i => i.idfAnimal == c.idfAnimal, i => i.strColor))(obj);
                        }
                    
                        if (e.PropertyName == _str_idfAnimal)
                        {
                    
                obj.AnimalGender = new Func<AsSessionAnimalSample, BaseReference>(c => c.AnimalsLookup.SingleOrDefault(i => i.idfAnimal == c.idfAnimal, i => i.AnimalGender))(obj);
                        }
                    
                        if (e.PropertyName == _str_idfAnimal)
                        {
                    
                obj.strName = new Func<AsSessionAnimalSample, string>(c => c.AnimalsLookup.SingleOrDefault(i => i.idfAnimal == c.idfAnimal, i => i.strName))(obj);
                        }
                    
                        if (e.PropertyName == _str_idfAnimal)
                        {
                    
                obj.strDescription = new Func<AsSessionAnimalSample, string>(c => c.AnimalsLookup.SingleOrDefault(i => i.idfAnimal == c.idfAnimal, i => i.strDescription))(obj);
                        }
                    
                        if (e.PropertyName == _str_idfAnimal)
                        {
                    
                obj.strFieldBarcode = new Func<AsSessionAnimalSample, string>(c => c.idfAnimal == c.idfAnimal_Previous ? c.strFieldBarcode : "")(obj);
                        }
                    
                        if (e.PropertyName == _str_idfAnimal)
                        {
                    
                obj.datFieldCollectionDate = new Func<AsSessionAnimalSample, DateTime?>(c => c.idfAnimal == c.idfAnimal_Previous ? c.datFieldCollectionDate : null)(obj);
                        }
            ...
            private void _LoadLookups(DbManagerProxy manager, AsSessionAnimalSample obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfsSpeciesType, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_SequenceNumber,
                    _str_SequenceNumber, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFarmCode,
                    _str_strFarmCode, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSpeciesType,
                    _str_strSpeciesType, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strAnimalCode,
                    _str_strAnimalCode, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_AnimalAge,
                    "strAnimalAge", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strColor,
                    _str_strColor, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_AnimalGender,
                    "strAnimalGender", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strName,
                    "strAnimalName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strDescription,
                    "strComments", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_SampleType,
                    "AsSessionTableViewItem.strSampleName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFieldBarcode,
                    "AsSessionTableViewItem.strFieldBarcode", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datFieldCollectionDate,
                    _str_datFieldCollectionDate, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSendToOffice,
                    "strSendToOrganization", null, true, true, true, true, null
                    ));
