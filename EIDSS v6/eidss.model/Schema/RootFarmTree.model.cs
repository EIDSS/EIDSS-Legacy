...
namespace eidss.model.Schema
{
    ...
    public abstract partial class RootFarmTree : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_idfsPartyType, _formname = _str_idfsPartyType, _type = "Int32",
              _get_func = o => o.idfsPartyType,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseInt32(val); if (o.idfsPartyType != newval) o.idfsPartyType = newval; },
              _compare_func = (o, c, m) => {
                if (o.idfsPartyType != c.idfsPartyType || o.IsRIRPropChanged(_str_idfsPartyType, c)) 
                  m.Add(_str_idfsPartyType, o.ObjectIdent + _str_idfsPartyType, o.ObjectIdent2 + _str_idfsPartyType, o.ObjectIdent3 + _str_idfsPartyType, "Int32", 
