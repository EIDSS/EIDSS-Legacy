...
namespace eidss.model.Schema
{
    ...
    public abstract partial class HumanAggregateCaseSummary : 
        ...
        protected class field_info
        {
            ...
            internal Action<HumanAggregateCaseSummary, HumanAggregateCaseSummary, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<HumanAggregateCaseSummary, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(HumanAggregateCaseSummary obj);
                ...
                )
            {
                ...
                try
                {
                    ...
                    HumanAggregateCaseSummary obj = objs[0];
                    obj.m_CS = m_CS;
            ...
            private HumanAggregateCaseSummary _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    HumanAggregateCaseSummary obj = HumanAggregateCaseSummary.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, HumanAggregateCaseSummary obj)
            {
