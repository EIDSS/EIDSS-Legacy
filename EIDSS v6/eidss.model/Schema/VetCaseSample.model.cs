    ...
    public abstract partial class VetCaseSample : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsSampleType != c.idfsSampleType || o.IsRIRPropChanged(_str_SampleTypeForDiagnosis, c)) {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        public partial class VetCaseSampleGridModelList : List<VetCaseSampleGridModel>, IGridModelList, IGridModelListLoad
        {
            ...
            private void LoadGridModelList(long key, IEnumerable<VetCaseSample> items, string errMes)
            {
                ...
                Columns = new List<string> {_str_strSampleName,_str_strFieldBarcode,_str_AnimalID,_str_Species,_str_strBirdStatus,_str_datFieldCollectionDate,_str_strSendToOffice,_str_datAccession,_str_strAccessionCondition,_str_strNote,_str_strFieldCollectedByOffice,_str_strFieldCollectedByPerson};
                ...
                
        {
            ...
            public void LoadLookup_SampleTypeForDiagnosis(DbManagerProxy manager, VetCaseSample obj)
            {
                ...
                LookupManager.AddObject("SampleTypeForDiagnosisLookup", obj, SampleTypeForDiagnosisAccessor.GetType(), "SelectLookupList");
            }
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strBirdStatus,
                    _str_strBirdStatus, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
