      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfsDiagnosisAgeGroup, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_DiagnosisAgeGroupName,
                    _str_DiagnosisAgeGroupName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_DiagnosisAgeGroupNameTranslated,
                    _str_DiagnosisAgeGroupNameTranslated, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intOrder,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_intLowerBoundary, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intUpperBoundary,
                    _str_intUpperBoundary, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsAgeType,
                    _str_idfsAgeType, null, true, true, true, true, null
                    ));
