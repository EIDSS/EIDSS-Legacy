...
namespace eidss.model.Schema
{
    ...
    public abstract partial class CustomReportRow : 
        ...
        protected class field_info
        {
            ...
            internal Action<CustomReportRow, CustomReportRow, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsDiagnosisOrGroup != c.idfsDiagnosisOrGroup || o.IsRIRPropChanged(_str_DiagnosisOrReportGroup, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsDiagnosisOrReportDiagnosisGroup != c.idfsDiagnosisOrReportDiagnosisGroup || o.IsRIRPropChanged(_str_Diagnosis, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsReportAdditionalText != c.idfsReportAdditionalText || o.IsRIRPropChanged(_str_ReportAdditionalText, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsICDReportAdditionalText != c.idfsICDReportAdditionalText || o.IsRIRPropChanged(_str_ICDReportAdditionalText, c)) {
        ...
        [Relation(typeof(DiagnosesAndGroupsLookup), eidss.model.Schema.DiagnosesAndGroupsLookup._str_idfsDiagnosisOrDiagnosisGroup, _str_idfsDiagnosisOrReportDiagnosisGroup)]
        ...
        private BvSelectList _getList(string name)
        {
            ...
            switch(name)
            {
                ...
                case _str_Diagnosis:
                    return new BvSelectList(DiagnosisLookup, eidss.model.Schema.DiagnosesAndGroupsLookup._str_idfsDiagnosisOrDiagnosisGroup, null, Diagnosis, _str_idfsDiagnosisOrReportDiagnosisGroup);
    ...
    public void AddHiddenPersonalData(string name, Func<CustomReportRow, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                ...
                
        {
            ...
            private delegate void on_action(CustomReportRow obj);
            ...
            private List<CustomReportRow> _SelectList(DbManagerProxy manager
                , Int64? idfReportRows
            ...
            private CustomReportRow _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    CustomReportRow obj = CustomReportRow.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public void LoadLookup_DiagnosisOrReportGroup(DbManagerProxy manager, CustomReportRow obj)
            {
                ...
                if (obj.idfsDiagnosisOrGroup != null && obj.idfsDiagnosisOrGroup != 0)
                {
                ...
                LookupManager.AddObject("DiagnosisOrReportGroupLookup", obj, DiagnosisOrReportGroupAccessor.GetType(), "SelectLookupList");
            }
            ...
            public void LoadLookup_Diagnosis(DbManagerProxy manager, CustomReportRow obj)
            {
                ...
                obj.DiagnosisLookup.AddRange(DiagnosisAccessor.SelectLookupList(manager
                    ...
                    , new Func<CustomReportRow, long>(c => 19000130)(obj)
                ...
                LookupManager.AddObject("DiagnosesAndGroupsLookup", obj, DiagnosisAccessor.GetType(), "SelectLookupList");
            }
            ...
            public void LoadLookup_ReportAdditionalText(DbManagerProxy manager, CustomReportRow obj)
            {
                ...
                LookupManager.AddObject("rftReportAdditionalText", obj, ReportAdditionalTextAccessor.GetType(), "rftReportAdditionalText_SelectList"
                  , "SelectLookupList");
            }
            ...
            public void LoadLookup_ICDReportAdditionalText(DbManagerProxy manager, CustomReportRow obj)
            {
                ...
                LookupManager.AddObject("rftReportAdditionalText", obj, ICDReportAdditionalTextAccessor.GetType(), "rftReportAdditionalText_SelectList"
                  , "SelectLookupList");
            }
            

            private void _LoadLookups(DbManagerProxy manager, CustomReportRow obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfReportRows,
                    _str_idfReportRows, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsCustomReportType,
                    _str_idfsCustomReportType, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intRowOrder,
                    _str_intRowOrder, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsDiagnosisOrGroup,
                    _str_idfsDiagnosisOrGroup, null, true, true, true, false, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsDiagnosisOrReportDiagnosisGroup,
                    "strDiagnosisOrReportDiagnosisGroup", null, true, true, true, false, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strUsingType,
                    _str_strUsingType, null, true, true, true, false, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsReportAdditionalText,
                    _str_idfsReportAdditionalText, null, true, true, true, false, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsICDReportAdditionalText,
                    _str_idfsICDReportAdditionalText, null, true, true, true, false, null
                    ));
