...
namespace eidss.model.Schema.Smartphone
{
    ...
    public abstract partial class SmphGisBaseReferenceLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<SmphGisBaseReferenceLookup, SmphGisBaseReferenceLookup, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<SmphGisBaseReferenceLookup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
            ...
            
        {
            ...
            private delegate void on_action(SmphGisBaseReferenceLookup obj);
            ...
            private List<SmphGisBaseReferenceLookup> _SelectList(DbManagerProxy manager
                , Int64? idfsCountry
            ...
            private SmphGisBaseReferenceLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    SmphGisBaseReferenceLookup obj = SmphGisBaseReferenceLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, SmphGisBaseReferenceLookup obj)
            {
