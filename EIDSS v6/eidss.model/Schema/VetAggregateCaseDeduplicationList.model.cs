...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetAggregateCaseDeduplicationListItem : 
        ...
        protected class field_info
        {
            ...
            internal Action<VetAggregateCaseDeduplicationListItem, VetAggregateCaseDeduplicationListItem, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<VetAggregateCaseDeduplicationListItem, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(VetAggregateCaseDeduplicationListItem obj);
            ...
            private List<VetAggregateCaseDeduplicationListItem> _SelectList(DbManagerProxy manager
            ...
            private VetAggregateCaseDeduplicationListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    VetAggregateCaseDeduplicationListItem obj = VetAggregateCaseDeduplicationListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, VetAggregateCaseDeduplicationListItem obj)
            {
