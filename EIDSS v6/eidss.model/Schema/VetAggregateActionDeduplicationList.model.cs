...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetAggregateActionDeduplicationListItem : 
        ...
        protected class field_info
        {
            ...
            internal Action<VetAggregateActionDeduplicationListItem, VetAggregateActionDeduplicationListItem, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<VetAggregateActionDeduplicationListItem, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(VetAggregateActionDeduplicationListItem obj);
            ...
            private List<VetAggregateActionDeduplicationListItem> _SelectList(DbManagerProxy manager
            ...
            private VetAggregateActionDeduplicationListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    VetAggregateActionDeduplicationListItem obj = VetAggregateActionDeduplicationListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, VetAggregateActionDeduplicationListItem obj)
            {
