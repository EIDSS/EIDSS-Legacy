...
namespace eidss.model.Schema
{
    ...
    public abstract partial class HumanCase : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _set_func = (o, val) => { var newval = ParsingHelper.ParseInt64Nullable(val); if (o.idfSoughtCareFacility != newval) o.idfSoughtCareFacility = newval; },
              _compare_func = (o, c, m) => {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsInitialCaseStatus != c.idfsInitialCaseStatus || o.IsRIRPropChanged(_str_InitialCaseClassification, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsFinalCaseStatus != c.idfsFinalCaseStatus || o.IsRIRPropChanged(_str_FinalCaseClassification, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfInvestigatedByOffice != c.idfInvestigatedByOffice || o.IsRIRPropChanged(_str_InvestigatedByOffice, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfHospital != c.idfHospital || o.IsRIRPropChanged(_str_Hospital, c)) {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfInvestigatedByPerson != c.idfInvestigatedByPerson || o.IsRIRPropChanged(_str_InvestigatedByPerson, c)) {
        ...
        {
            get { return new Func<HumanCase, bool>(c => (c.idfsCaseProgressStatus == (long)CaseStatusEnum.InProgress) || (c.idfsCaseProgressStatus == (long)CaseStatusEnum.Closed && c.IsDirty) || (c.idfsCaseProgressStatus == (long)CaseStatusEnum.Closed && !c.IsDirty && c.GetPermissions().CanExecute("CanReopenClosedCase")))(this); }
        ...
        private static string[] readonly_names14 = "idfOutbreak".Split(new char[] { ',' });
        
        private static string[] readonly_names15 = "AntimicrobialTherapy".Split(new char[] { ',' });
        
        private static string[] readonly_names16 = "Samples".Split(new char[] { ',' });
        
        private static string[] readonly_names17 = "CaseTests,CaseTestValidations".Split(new char[] { ',' });
        
        private static string[] readonly_names18 = "strSampleNotes".Split(new char[] { ',' });
        
        private static string[] readonly_names19 = "NotCollectedReason,idfsNotCollectedReason".Split(new char[] { ',' });
        
        private static string[] readonly_names20 = "datHospitalizationDate,strHospitalizationPlace".Split(new char[] { ',' });
        
        private static string[] readonly_names21 = "strCurrentLocation".Split(new char[] { ',' });
        
        private static string[] readonly_names22 = "idfHospital".Split(new char[] { ',' });
        
        private static string[] readonly_names23 = "datFinalDiagnosisDate".Split(new char[] { ',' });
        
        private static string[] readonly_names24 = "datTentativeDiagnosisDate".Split(new char[] { ',' });
        
        private static string[] readonly_names25 = "intPatientAge,idfsHumanAgeType".Split(new char[] { ',' });
        
        private static string[] readonly_names26 = "blnClinicalDiagBasis,blnEpiDiagBasis,blnLabDiagBasis".Split(new char[] { ',' });
        
        private static string[] readonly_names27 = "datFinalCaseClassificationDate".Split(new char[] { ',' });
        
        private static string[] readonly_names28 = "buttonGeoLocationPicker".Split(new char[] { ',' });
        
        private static string[] readonly_names29 = "buttonSearchforDuplicates".Split(new char[] { ',' });
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private HumanCase _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                ...
                obj.strOfficeEnteredBy = new Func<HumanCase, string>(c => EidssUserContext.User.Organization)(obj);
            ...
            private void _SetupHandlers(HumanCase obj)
            {
              ...
              new object[] {
                ...
                obj.datFinalCaseClassificationDate = new Func<HumanCase, DateTime?>(c => eidss.model.Core.EidssSiteContext.Instance.CustomizationPackageID != (long) eidss.model.Enums.CustomizationPackage.Georgia && c.idfsFinalCaseStatus.HasValue && !c.idfsFinalCaseStatus_Previous.HasValue ? DateTime.Today : c.datFinalCaseClassificationDate)(obj);
                        }
            ...
            public void LoadLookup_InitialCaseClassification(DbManagerProxy manager, HumanCase obj)
            {
                ...
                LookupManager.AddObject("InitialCaseClassificationLookup", obj, InitialCaseClassificationAccessor.GetType(), "SelectLookupList");
            ...
            public void LoadLookup_FinalCaseClassification(DbManagerProxy manager, HumanCase obj)
            {
                ...
                LookupManager.AddObject("FinalCaseClassificationLookup", obj, FinalCaseClassificationAccessor.GetType(), "SelectLookupList");
            ...
            public void LoadLookup_PatientState(DbManagerProxy manager, HumanCase obj)
            {
                ...
                LookupManager.AddObject("rftPatientState", obj, PatientStateAccessor.GetType(), "rftPatientState_SelectList"
                  , "SelectLookupList");
            ...
            public void LoadLookup_InvestigatedByOffice(DbManagerProxy manager, HumanCase obj)
            {
                ...
                LookupManager.AddObject("OrganizationLookup", obj, InvestigatedByOfficeAccessor.GetType(), "SelectLookupList");
            ...
            public void LoadLookup_Hospital(DbManagerProxy manager, HumanCase obj)
            {
                ...
                LookupManager.AddObject("OrganizationLookup", obj, HospitalAccessor.GetType(), "SelectLookupList");
            ...
            public void LoadLookup_InvestigatedByPerson(DbManagerProxy manager, HumanCase obj)
            {
                ...
                LookupManager.AddObject("WiderPersonLookup", obj, InvestigatedByPersonAccessor.GetType(), "SelectLookupList");
  ...
  listdatDateofBirth.Add(
    ...
    new ChainsValidatorDateTime<HumanCase>(obj, "datFinalCaseClassificationDate", с => eidss.model.Core.EidssSiteContext.Instance.CustomizationPackageID != (long) eidss.model.Enums.CustomizationPackage.Georgia, 
      obj.datFinalCaseClassificationDate,
      obj.GetType(),
  ...
  obj.CaseTests.Where(c => !c.IsMarkedToDelete).ToList().ForEach(j =>
    ...
    new ChainsValidatorDateTime<HumanCase>(obj, "CurrentDate", c => true, 
      ...
      false, listCurrentDate => {
            ...
            public bool Validate(DbManagerProxy manager, HumanCase obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
                ...
                false
              )).Validate(c => c.idfsFinalCaseStatus == (long)eidss.model.Enums.CaseClassification.Confirmed && eidss.model.Core.EidssSiteContext.Instance.CustomizationPackageID != (long) eidss.model.Enums.CustomizationPackage.Georgia, obj, obj.datFinalCaseClassificationDate);
            ...
            private void _SetupRequired(HumanCase obj)
            {
                ...
                obj
                    .AddRequired("datFinalCaseClassificationDate", c => c.idfsFinalCaseStatus == (long)eidss.model.Enums.CaseClassification.Confirmed && eidss.model.Core.EidssSiteContext.Instance.CustomizationPackageID != (long) eidss.model.Enums.CustomizationPackage.Georgia);
    ...
    private void _SetupPersonalDataRestrictions(HumanCase obj)
    {
      ...
      if (EidssUserContext.User.ForbiddenPersonalDataGroups.Contains(PersonalDataGroup.Human_PersonName))
      {
            ...
            obj
              .Patient
                  .AddHiddenPersonalData("PersonIDType", c=>true);
                
            obj
              .Patient
                  .AddHiddenPersonalData("strPersonID", c=>true);
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                if (!RequiredByField.ContainsKey("datFinalCaseClassificationDate")) RequiredByField.Add("datFinalCaseClassificationDate", c => c.idfsFinalCaseStatus == (long)eidss.model.Enums.CaseClassification.Confirmed && eidss.model.Core.EidssSiteContext.Instance.CustomizationPackageID != (long) eidss.model.Enums.CustomizationPackage.Georgia);
                if (!RequiredByProperty.ContainsKey("datFinalCaseClassificationDate")) RequiredByProperty.Add("datFinalCaseClassificationDate", c => c.idfsFinalCaseStatus == (long)eidss.model.Enums.CaseClassification.Confirmed && eidss.model.Core.EidssSiteContext.Instance.CustomizationPackageID != (long) eidss.model.Enums.CustomizationPackage.Georgia);
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    null,
                    null,
                    (o1, o2, p, r) => !eidss.model.Core.EidssUserContext.User.HasPermission(PermissionHelper.ExecutePermission(EIDSSPermissionObject.UseSimplifiedHumanCaseReportForm)),
                    false,
                    false,
                    null,
                    false,
