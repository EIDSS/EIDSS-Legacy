      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfFreezer,
                    _str_idfFreezer, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFreezerName,
                    _str_strFreezerName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strNote,
                    "RepositoryScheme.strNote", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_StorageType,
                    _str_StorageType, null, true, true, true, true, null
                    ));
