      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfTransferOut,
                    _str_idfTransferOut, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strBarcode,
                    "LabSampleTransferListItem.strBarcode", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_TransferFrom,
                    _str_TransferFrom, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_TransferTo,
                    _str_TransferTo, null, true, true, true, true, null
                    ));
