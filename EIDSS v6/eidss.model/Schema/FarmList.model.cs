      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    "FarmName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strContactPhone,
                    "FarmListItem.strContactPhone", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strRegion,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strSettlement,
                    "strTownOrVillage", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFarmType,
                    _str_strFarmType, null, true, true, true, true, null
                    ));
