...
namespace eidss.model.Schema
{
    ...
    public abstract partial class ReportDiagnosesGroup : 
        ...
        protected class field_info
        {
            ...
            internal Action<ReportDiagnosesGroup, ReportDiagnosesGroup, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<ReportDiagnosesGroup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                ...
                
        {
            ...
            private delegate void on_action(ReportDiagnosesGroup obj);
            ...
            private List<ReportDiagnosesGroup> _SelectList(DbManagerProxy manager
                , Int64? idfsReportDiagnosesGroup
            ...
            private ReportDiagnosesGroup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    ReportDiagnosesGroup obj = ReportDiagnosesGroup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, ReportDiagnosesGroup obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfsReportDiagnosesGroup, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strName,
                    "RDGE.strName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strTranslatedName,
                    "RDGE.strTranslatedName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_Code,
                    "RDGE.Code", null, true, true, true, true, null
                    ));
