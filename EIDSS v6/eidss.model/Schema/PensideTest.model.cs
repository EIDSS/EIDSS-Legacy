    ...
    public abstract partial class PensideTest : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsPensideTestName != c.idfsPensideTestName || o.IsRIRPropChanged(_str_PensideTestType, c)) {
        ...
        {
            get { return new Func<PensideTest, string>(c => c.SamplesFromCase == null || c.SamplesFromCase.Count == 0 || c.idfMaterial == 0 ? "" : c.SamplesFromCase.Where(a => a.idfMaterial == c.idfMaterial).Single().strSampleName)(this); }
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strSampleName,
                    "SampleName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_Species,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_strPensideTestResultName, null, true, true, true, true, null
                    ));
