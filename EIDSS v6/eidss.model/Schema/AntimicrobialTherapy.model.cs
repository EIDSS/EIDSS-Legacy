      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfAntimicrobialTherapy, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strAntimicrobialTherapyName,
                    _str_strAntimicrobialTherapyName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strDosage,
                    _str_strDosage, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datFirstAdministeredDate,
                    _str_datFirstAdministeredDate, null, true, true, true, true, null
                    ));
