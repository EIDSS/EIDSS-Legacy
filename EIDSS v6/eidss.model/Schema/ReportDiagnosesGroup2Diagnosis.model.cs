...
namespace eidss.model.Schema
{
    ...
    public abstract partial class ReportDiagnosesGroup2Diagnosis : 
        ...
        protected class field_info
        {
            ...
            internal Action<ReportDiagnosesGroup2Diagnosis, ReportDiagnosesGroup2Diagnosis, CompareModel> _compare_func;
        }
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.intIsDeleted != c.intIsDeleted || o.IsRIRPropChanged(_str_YNU, c)) {
    ...
    public void AddHiddenPersonalData(string name, Func<ReportDiagnosesGroup2Diagnosis, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                ...
                
        {
            ...
            private delegate void on_action(ReportDiagnosesGroup2Diagnosis obj);
            ...
            private List<ReportDiagnosesGroup2Diagnosis> _SelectList(DbManagerProxy manager
                , Int64? idfDiagnosisToGroupForReportType
            ...
            private ReportDiagnosesGroup2Diagnosis _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    ReportDiagnosesGroup2Diagnosis obj = ReportDiagnosesGroup2Diagnosis.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            public void LoadLookup_YNU(DbManagerProxy manager, ReportDiagnosesGroup2Diagnosis obj)
            {
                ...
                LookupManager.AddObject("rftYesNoValue", obj, YNUAccessor.GetType(), "rftYesNoValue_SelectList"
                  , "SelectLookupList");
            }
            

            private void _LoadLookups(DbManagerProxy manager, ReportDiagnosesGroup2Diagnosis obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfDiagnosisToGroupForReportType, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfsReportDiagnosisGroup, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsDiagnosis,
                    "strDiagnosisName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strUsingType,
                    _str_strUsingType, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strHACode,
                    _str_strHACode, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strIsDeleted,
                    _str_strIsDeleted, null, true, true, true, true, null
                    ));
