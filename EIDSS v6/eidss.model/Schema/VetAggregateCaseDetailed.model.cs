...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetAggregateCaseDetailed : 
        ...
        protected class field_info
        {
            ...
            internal Action<VetAggregateCaseDetailed, VetAggregateCaseDetailed, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<VetAggregateCaseDetailed, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(VetAggregateCaseDetailed obj);
                ...
                )
            {
                ...
                try
                {
                    ...
                    VetAggregateCaseDetailed obj = objs[0];
                    obj.m_CS = m_CS;
            ...
            private VetAggregateCaseDetailed _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    VetAggregateCaseDetailed obj = VetAggregateCaseDetailed.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, VetAggregateCaseDetailed obj)
            {
