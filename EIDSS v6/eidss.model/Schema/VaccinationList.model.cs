    ...
    new ChainsValidatorDateTime<VaccinationListItem>(obj, "CurrentDate", c => true, 
      ...
      false, listCurrentDate => {
            ...
            public bool Validate(DbManagerProxy manager, VaccinationListItem obj, bool bPostValidation, bool bChangeValidation, bool bDeepValidation, bool bRethrowException = false)
            {
                ...
                (new RequiredValidator( "datVaccinationDate", "datVaccinationDate","",
                false
              )).Validate(c => true, obj, obj.datVaccinationDate);
            ...
            private void _SetupRequired(VaccinationListItem obj)
            {
                ...
                obj
                    .AddRequired("datVaccinationDate", c => true);
    ...
    private static void AddHiddenPersonalData(string name, Func<bool> func)
    {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                if (!RequiredByField.ContainsKey("datVaccinationDate")) RequiredByField.Add("datVaccinationDate", c => true);
                if (!RequiredByProperty.ContainsKey("datVaccinationDate")) RequiredByProperty.Add("datVaccinationDate", c => true);
                
                GridMeta.Add(new GridMetaItem(
                    _str_idfVaccination,
                    _str_idfVaccination, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfSpecies,
                    _str_idfSpecies, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strDiagnosis,
                    "Vaccination.strDiagnosis", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datVaccinationDate,
                    _str_datVaccinationDate, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSpecies,
                    "strAnimalFlockSpecies", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intNumberVaccinated,
                    _str_intNumberVaccinated, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strVaccinationType,
                    _str_strVaccinationType, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strVaccinationRoute,
                    _str_strVaccinationRoute, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strLotNumber,
                    _str_strLotNumber, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strManufacturer,
                    _str_strManufacturer, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strNote,
                    "Vaccination.strNote", null, true, true, true, true, null
                    ));
