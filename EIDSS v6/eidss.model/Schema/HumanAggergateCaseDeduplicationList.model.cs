...
namespace eidss.model.Schema
{
    ...
    public abstract partial class HumanAggregateCaseDeduplicationListItem : 
        ...
        protected class field_info
        {
            ...
            internal Action<HumanAggregateCaseDeduplicationListItem, HumanAggregateCaseDeduplicationListItem, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<HumanAggregateCaseDeduplicationListItem, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(HumanAggregateCaseDeduplicationListItem obj);
            ...
            private List<HumanAggregateCaseDeduplicationListItem> _SelectList(DbManagerProxy manager
            ...
            private HumanAggregateCaseDeduplicationListItem _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    HumanAggregateCaseDeduplicationListItem obj = HumanAggregateCaseDeduplicationListItem.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, HumanAggregateCaseDeduplicationListItem obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfAggrCase,
                    _str_idfAggrCase, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intDuplicateGroup,
                    _str_intDuplicateGroup, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCaseID,
                    "strCaseID", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datStartDate,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strPeriodName,
                    "idfsPeriodType", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strRegion,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strSettlement,
                    "strSettlement", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strInstitutionName,
                    _str_strInstitutionName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datEnteredByDate,
                    _str_datEnteredByDate, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strMatrixName,
                    _str_strMatrixName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strTemplateName,
                    _str_strTemplateName, null, true, true, true, true, null
                    ));
