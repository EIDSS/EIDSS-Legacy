...
namespace eidss.model.Schema
{
    ...
    public abstract partial class InitialCaseClassificationLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<InitialCaseClassificationLookup, InitialCaseClassificationLookup, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<InitialCaseClassificationLookup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
            ...
            
        {
            ...
            private delegate void on_action(InitialCaseClassificationLookup obj);
            ...
            private List<InitialCaseClassificationLookup> _SelectList(DbManagerProxy manager
            ...
            private InitialCaseClassificationLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    InitialCaseClassificationLookup obj = InitialCaseClassificationLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, InitialCaseClassificationLookup obj)
            {
