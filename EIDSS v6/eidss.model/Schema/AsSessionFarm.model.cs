    ...
    public void AddHiddenPersonalData(string name, Func<AsSessionFarm, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                ...
                
        {
            ...
            private List<AsSessionFarm> _SelectList(DbManagerProxy manager
                , Int64? idfMonitoringSession
                , int? HACode
            ...
            private AsSessionFarm _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
              ...
              if (obj.AsSessionDiseases.Count() == 1 && obj.AsSessionDiseases.Count(i => i.idfsSpeciesType.HasValue && i.idfsSpeciesType.Value > 0) == 1)
              {
                  var idfsSpeciesType = obj.AsSessionDiseases.SingleOrDefault(i => i.idfsSpeciesType.HasValue && i.idfsSpeciesType.Value > 0, i => i.idfsSpeciesType);
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfFarm,
                    _str_idfFarm, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strFarmCode,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_strOwnerName,
                    _str_strOwnerName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strNationalName,
                    _str_strNationalName, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strContactPhone,
                    _str_strContactPhone, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strRegion,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_strTownOrVillage, null, true, true, true, true, null
                    ));
