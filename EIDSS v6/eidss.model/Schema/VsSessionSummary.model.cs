...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VsSessionSummary : 
        ...
        protected class field_info
        {
            ...
            internal Action<VsSessionSummary, VsSessionSummary, CompareModel> _compare_func;
        }
        ...
        internal const string _str_VectorSubTypeAll = "VectorSubTypeAll";
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_VectorSubTypeAll, _formname = _str_VectorSubTypeAll, _type = "Lookup",
              _get_func = o => { if (o.VectorSubTypeAll == null) return null; return o.VectorSubTypeAll.idfsBaseReference; },
              _set_func = (o, val) => { o.VectorSubTypeAll = o.VectorSubTypeAllLookup.Where(c => c.idfsBaseReference.ToString() == val).SingleOrDefault(); },
              _compare_func = (o, c, m) => {
                if (o.idfsVectorSubType != c.idfsVectorSubType || o.IsRIRPropChanged(_str_VectorSubTypeAll, c)) {
                  m.Add(_str_VectorSubTypeAll, o.ObjectIdent + _str_VectorSubTypeAll, o.ObjectIdent2 + _str_VectorSubTypeAll, o.ObjectIdent3 + _str_VectorSubTypeAll, "Lookup", o.idfsVectorSubType == null ? "" : o.idfsVectorSubType.ToString(), o.IsReadOnly(_str_VectorSubTypeAll), o.IsInvisible(_str_VectorSubTypeAll), o.IsRequired(_str_VectorSubTypeAll)); 
                  }
                }
              }, 
            new field_info {
              _name = _str_VectorSubTypeAll + "Lookup", _formname = _str_VectorSubTypeAll + "Lookup", _type = "LookupContent",
              _get_func = o => o.VectorSubTypeAllLookup,
              _set_func = (o, val) => { },
              _compare_func = (o, c, m) => { }, 
              }, 
        ...
        [LocalizedDisplayName(_str_VectorSubTypeAll)]
        [Relation(typeof(VectorSubTypeLookup), eidss.model.Schema.VectorSubTypeLookup._str_idfsBaseReference, _str_idfsVectorSubType)]
        public VectorSubTypeLookup VectorSubTypeAll
        {
            get { return _VectorSubTypeAll == null ? null : ((long)_VectorSubTypeAll.Key == 0 ? null : _VectorSubTypeAll); }
            set 
            { 
                var oldVal = _VectorSubTypeAll;
                _VectorSubTypeAll = value == null ? null : ((long) value.Key == 0 ? null : value);
                if (_VectorSubTypeAll != oldVal)
                {
                    if (idfsVectorSubType != (_VectorSubTypeAll == null
                            ? new Int64()
                            : (Int64)_VectorSubTypeAll.idfsBaseReference))
                        idfsVectorSubType = _VectorSubTypeAll == null 
                            ? new Int64()
                            : (Int64)_VectorSubTypeAll.idfsBaseReference; 
                    OnPropertyChanged(_str_VectorSubTypeAll); 
                }
            }
        }
        private VectorSubTypeLookup _VectorSubTypeAll;

        
        public List<VectorSubTypeLookup> VectorSubTypeAllLookup
        {
            get { return _VectorSubTypeAllLookup; }
        }
        private List<VectorSubTypeLookup> _VectorSubTypeAllLookup = new List<VectorSubTypeLookup>();
        ...
        private BvSelectList _getList(string name)
        {
            ...
            switch(name)
            {
                ...
                case _str_VectorSubTypeAll:
                    return new BvSelectList(VectorSubTypeAllLookup, eidss.model.Schema.VectorSubTypeLookup._str_idfsBaseReference, null, VectorSubTypeAll, _str_idfsVectorSubType);
        ...
        public new void RejectChanges()
        {
            ...
            var _prev_idfsVectorSubType_VectorSubTypeAll = idfsVectorSubType;
            ...
            if (_prev_idfsVectorSubType_VectorSubTypeAll != idfsVectorSubType)
            {
                _VectorSubTypeAll = _VectorSubTypeAllLookup.FirstOrDefault(c => c.idfsBaseReference == idfsVectorSubType);
            }
    ...
    public void AddHiddenPersonalData(string name, Func<VsSessionSummary, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
        ...
        public void ReloadLookupItem(DbManagerProxy manager, string lookup_object)
        {
            ...
            if (lookup_object == "VectorSubTypeLookup")
                _getAccessor().LoadLookup_VectorSubTypeAll(manager, this);
                ...
                
        {
            ...
            private delegate void on_action(VsSessionSummary obj);
            ...
            private VectorSubTypeLookup.Accessor VectorSubTypeAllAccessor { get { return eidss.model.Schema.VectorSubTypeLookup.Accessor.Instance(m_CS); } }
            ...
            private List<VsSessionSummary> _SelectList(DbManagerProxy manager
                , Int64? idfVectorSurveillanceSession
            ...
            private VsSessionSummary _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    VsSessionSummary obj = VsSessionSummary.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
                ...
                obj.Location = new Func<VsSessionSummary, GeoLocation>(c => LocationAccessor.CreateWithCountry(manager, obj))(obj);
            ...
            public void LoadLookup_VectorType(DbManagerProxy manager, VsSessionSummary obj)
            {
                ...
                LookupManager.AddObject("VectorTypeLookup", obj, VectorTypeAccessor.GetType(), "SelectLookupList");
            }
            ...
            public void LoadLookup_VectorSubType(DbManagerProxy manager, VsSessionSummary obj)
            {
                ...
                LookupManager.AddObject("VectorSubTypeLookup", obj, VectorSubTypeAccessor.GetType(), "SelectLookupList");
            }
            
            public void LoadLookup_VectorSubTypeAll(DbManagerProxy manager, VsSessionSummary obj)
            {
                
                obj.VectorSubTypeAllLookup.Clear();
                
                obj.VectorSubTypeAllLookup.Add(VectorSubTypeAllAccessor.CreateNewT(manager, null));
                
                obj.VectorSubTypeAllLookup.AddRange(VectorSubTypeAllAccessor.SelectLookupList(manager
                    
                    , new Func<VsSessionSummary, long?>(c => null)(obj)
                ...
                if (obj.idfsVectorSubType != 0)
                {
                    obj.VectorSubTypeAll = obj.VectorSubTypeAllLookup
                        .SingleOrDefault(c => c.idfsBaseReference == obj.idfsVectorSubType);
                    
                }
              
                
                LookupManager.AddObject("VectorSubTypeLookup", obj, VectorSubTypeAllAccessor.GetType(), "SelectLookupList");
            }
            ...
            public void LoadLookup_AnimalGender(DbManagerProxy manager, VsSessionSummary obj)
            {
                ...
                LookupManager.AddObject("rftAnimalSex", obj, AnimalGenderAccessor.GetType(), "rftAnimalSex_SelectList"
                  , "SelectLookupList");
            }
            

            private void _LoadLookups(DbManagerProxy manager, VsSessionSummary obj)
            {
                ...
                LoadLookup_VectorSubTypeAll(manager, obj);
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfsVSSessionSummary, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strVSSessionSummaryID,
                    "VsSessionSummary.RecordID", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strLocation,
                    "LocationDisplayName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datCollectionDateTime,
                    _str_datCollectionDateTime, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsVectorType,
                    _str_idfsVectorType, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsVectorSubType,
                    _str_idfsVectorSubType, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsSex,
                    "idfsAnimalGender", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strVectorType,
                    "idfsVectorType", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strVectorSubType,
                    "idfsVectorSubType", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strSex,
                    "idfsAnimalGender", null, true, true, true, true, null
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_intQuantity,
                    "VsSessionSummary.intQuantity", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strDiagnosesSummary,
                    _str_strDiagnosesSummary, null, true, true, true, true, null
                    ));
