...
namespace eidss.model.Schema
{
    ...
    public abstract partial class BasicSyndromicSurveillanceAggregateDetail : 
        ...
        protected class field_info
        {
            ...
            internal Action<BasicSyndromicSurveillanceAggregateDetail, BasicSyndromicSurveillanceAggregateDetail, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<BasicSyndromicSurveillanceAggregateDetail, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                ...
                
        {
            ...
            private delegate void on_action(BasicSyndromicSurveillanceAggregateDetail obj);
            ...
            private List<BasicSyndromicSurveillanceAggregateDetail> _SelectList(DbManagerProxy manager
                , Int64? idfAggregateHeader
            ...
            private BasicSyndromicSurveillanceAggregateDetail _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    BasicSyndromicSurveillanceAggregateDetail obj = BasicSyndromicSurveillanceAggregateDetail.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, BasicSyndromicSurveillanceAggregateDetail obj)
            {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_idfAggregateDetail, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfHospital,
                    "strHospital", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intAge0_4,
                    _str_intAge0_4, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intAge5_14,
                    _str_intAge5_14, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intAge15_29,
                    _str_intAge15_29, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intAge30_64,
                    _str_intAge30_64, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intAge65,
                    _str_intAge65, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_inTotalILI,
                    _str_inTotalILI, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intTotalAdmissions,
                    _str_intTotalAdmissions, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intILISamples,
                    _str_intILISamples, null, true, true, true, true, null
                    ));
