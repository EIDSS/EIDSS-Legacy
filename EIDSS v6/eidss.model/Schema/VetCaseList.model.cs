...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetCaseListItem : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_finalDiagnosisOnly, _formname = _str_finalDiagnosisOnly, _type = "bool?",
              _get_func = o => o.finalDiagnosisOnly,
              _set_func = (o, val) => { var newval = ParsingHelper.ParseBooleanNullable(val); if (o.finalDiagnosisOnly != newval) o.finalDiagnosisOnly = newval; },
              _compare_func = (o, c, m) => {
              
                if (o.finalDiagnosisOnly != c.finalDiagnosisOnly || o.IsRIRPropChanged(_str_finalDiagnosisOnly, c)) {
                  m.Add(_str_finalDiagnosisOnly, o.ObjectIdent + _str_finalDiagnosisOnly, o.ObjectIdent2 + _str_finalDiagnosisOnly, o.ObjectIdent3 + _str_finalDiagnosisOnly,  "bool?", 
                    o.finalDiagnosisOnly == null ? "" : o.finalDiagnosisOnly.ToString(),                  
                    o.IsReadOnly(_str_finalDiagnosisOnly), o.IsInvisible(_str_finalDiagnosisOnly), o.IsRequired(_str_finalDiagnosisOnly));
                  }
                 }
              }, 
            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.idfsCaseClassification != c.idfsCaseClassification || o.IsRIRPropChanged(_str_CaseClassification, c)) {
      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                SearchPanelMeta.Add(new SearchPanelMetaItem(
                    ...
                    "idfsDiagnosis",
                    null, null, c => false, false, SearchPanelLocation.Main, true, "finalDiagnosisOnly", "DiagnosisLookup", typeof(DiagnosisLookup), (o) => { var c = (DiagnosisLookup)o; return c.idfsDiagnosis; }, (o) => { var c = (DiagnosisLookup)o; return c.name; }, null,false
                    ));
                SearchPanelMeta.Add(new SearchPanelMetaItem(
                    "finalDiagnosisOnly",
                    EditorType.Flag,
                    ...
                    c => false, null, c => false, false, SearchPanelLocation.Main, true, null, null, null, null, null, null,false
                    ));
                SearchPanelMeta.Add(new SearchPanelMetaItem(
                    "datDiagnosisDate",
                    EditorType.Date,
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_datEnteredDate,
                    "datEnteredDateSearchPanel", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datInvestigationDate,
                    _str_datInvestigationDate, null, true, true, true, true, ListSortDirection.Ascending
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_DiagnosisName,
                    "strDiagnoses", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_AddressName,
                    "FarmAddress", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strOwnerLastName,
                    "strOwnerName", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_intTotalAnimalQty,
                    "intTotalAnimalQtyFull", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCaseType,
                    "idfsCaseType", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_CaseClassificationName,
                    "idfsCaseClassificationShort", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_CaseStatusName,
                    "idfsCaseStatusShort", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCaseReportType,
                    "idfsCaseReportType", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_idfsRegion,
