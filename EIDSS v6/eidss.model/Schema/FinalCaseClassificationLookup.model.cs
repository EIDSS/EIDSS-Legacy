...
namespace eidss.model.Schema
{
    ...
    public abstract partial class FinalCaseClassificationLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<FinalCaseClassificationLookup, FinalCaseClassificationLookup, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<FinalCaseClassificationLookup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
            ...
            
        {
            ...
            private delegate void on_action(FinalCaseClassificationLookup obj);
            ...
            private List<FinalCaseClassificationLookup> _SelectList(DbManagerProxy manager
            ...
            private FinalCaseClassificationLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    FinalCaseClassificationLookup obj = FinalCaseClassificationLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, FinalCaseClassificationLookup obj)
            {
