...
namespace eidss.model.Schema
{
    ...
    public abstract partial class FFTemplateLookup : 
        ...
        protected class field_info
        {
            ...
            internal Action<FFTemplateLookup, FFTemplateLookup, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<FFTemplateLookup, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
            ...
            
        {
            ...
            private delegate void on_action(FFTemplateLookup obj);
            ...
            private List<FFTemplateLookup> _SelectList(DbManagerProxy manager
                , Int64? idfsFormTemplate
                , Int64? idfsFormType
            ...
            private FFTemplateLookup _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    FFTemplateLookup obj = FFTemplateLookup.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, FFTemplateLookup obj)
            {
