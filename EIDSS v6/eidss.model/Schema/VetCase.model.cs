...
namespace eidss.model.Schema
{
    ...
    public abstract partial class VetCase : 
        ...
        {
            get { return new Func<VetCase, bool>(c => (c.idfsCaseProgressStatus == (long)CaseStatusEnum.InProgress) || (c.idfsCaseProgressStatus == (long)CaseStatusEnum.Closed && c.IsDirty) || (c.idfsCaseProgressStatus == (long)CaseStatusEnum.Closed && !c.IsDirty && c.GetPermissions().CanExecute("CanReopenClosedCase")))(this); }
        ...
        private static string[] readonly_names6 = "idfsCaseType,CaseType,datEnteredDate,strCaseID,strDiseaseNames,strDiagnosis,idfPersonEnteredBy,idfsSite,strPersonEnteredByName,strTentativeDiagnosisOIECode,strTentativeDiagnosis1OIECode,strTentativeDiagnosis2OIECode,strFinalDiagnosisOIECode".Split(new char[] { ',' });
            ...
            static Meta()
            {
                ...
                Actions.Add(new ActionMetaItem(
                    ...
                    new ActionMetaItem.VisualItem(
                        /*from BvMessages*/"titleVetCaseInvestigationReport",
                        "Report",
                        /*from BvMessages*/"",
                        /*from BvMessages*/"",
                        "",
