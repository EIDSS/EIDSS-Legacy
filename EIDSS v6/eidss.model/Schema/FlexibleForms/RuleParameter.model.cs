...
namespace eidss.model.Schema
{
    ...
    public abstract partial class RuleParameter : 
        ...
        protected class field_info
        {
            ...
            internal Action<RuleParameter, RuleParameter, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<RuleParameter, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(RuleParameter obj);
            ...
            public List<RuleParameter> SelectDetailListT(DbManagerProxy manager, List<object> pars)
            {
                ...
                if (!(pars[0] is Int64?)) 
                    throw new TypeMismatchException("idfRule", typeof(Int64?));
            ...
            public List<RuleParameter> SelectDetailList(DbManagerProxy manager, List<object> pars)
            {
                return SelectDetailListT(manager, pars);
            }
            
            public virtual List<RuleParameter> SelectDetailList(DbManagerProxy manager
                , Int64? idfRule
                )
            {
                return _SelectList(manager
            ...
            private List<RuleParameter> _SelectList(DbManagerProxy manager
                , Int64? idfRule
            ...
            private RuleParameter _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    RuleParameter obj = RuleParameter.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, RuleParameter obj)
            {
