...
namespace eidss.model.Schema
{
    ...
    public abstract partial class SectionTemplate : 
        ...
        private static readonly field_info[] _field_infos =
        {
            ...
            new field_info {
              _name = _str_Section, _formname = _str_Section, _type = "Relation",
              _get_func = o => null,
              _set_func = (o, val) => {},
              _compare_func = (o, c, m) => {
        ...
        public IObject CloneWithSetup(DbManagerProxy manager, bool bRestricted = false)
        {
            ...
            if (_Section != null)
              ret.Section = _Section.CloneWithSetup(manager, bRestricted) as Section;
        ...
        public void DeepRejectChanges()
        {
            ...
            if (Section != null) Section.DeepRejectChanges();
        ...
        { 
            ...
            if (_Section != null) _Section.DeepAcceptChanges();
