...
namespace eidss.model.Schema
{
    ...
    public abstract partial class ParametersDeletedFromTemplate : 
        ...
        protected class field_info
        {
            ...
            internal Action<ParametersDeletedFromTemplate, ParametersDeletedFromTemplate, CompareModel> _compare_func;
        }
    ...
    public void AddHiddenPersonalData(string name, Func<ParametersDeletedFromTemplate, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            private delegate void on_action(ParametersDeletedFromTemplate obj);
            ...
            private List<ParametersDeletedFromTemplate> _SelectList(DbManagerProxy manager
                , Int64? idfObservation
            ...
            private void _SetupAddChildHandlerSelectList(ParametersDeletedFromTemplate obj)
            {
            ...
            internal void _LoadSelectList(ParametersDeletedFromTemplate obj)
            {
                using (DbManagerProxy manager = DbManagerFactory.Factory.Create(ModelUserContext.Instance))
                {
            ...
            internal void _LoadSelectList(DbManagerProxy manager, ParametersDeletedFromTemplate obj)
            {
                
                obj.SelectList.Clear();
                obj.SelectList.AddRange(SelectListAccessor.SelectDetailList(manager
                    
                    , new Func<ParametersDeletedFromTemplate, Int64?>(c => c.idfsParameter)(obj)
                    
                    , new Func<ParametersDeletedFromTemplate, Int64?>(c => c.idfsParameterType)(obj)
            ...
            internal void _SetupLoad(DbManagerProxy manager, ParametersDeletedFromTemplate obj, bool bCloning = false)
            {
                ...
                obj.SelectList.Insert(0, new Func<ParametersDeletedFromTemplate, ParameterSelect>(c => SelectListAccessor.CreateDefault(manager, c, c.idfsParameter, c.idfsParameterType, c.intHACode))(obj));
            ...
            private ParametersDeletedFromTemplate _CreateNew(DbManagerProxy manager, IObject Parent, int? HACode, on_action creating, on_action created, bool isFake = false)
            {
                try
                {
                    ParametersDeletedFromTemplate obj = ParametersDeletedFromTemplate.CreateInstance();
                    obj.m_CS = m_CS;
                    obj.m_IsNew = true;
                    obj.Parent = Parent;
            ...
            private void _LoadLookups(DbManagerProxy manager, ParametersDeletedFromTemplate obj)
            {
