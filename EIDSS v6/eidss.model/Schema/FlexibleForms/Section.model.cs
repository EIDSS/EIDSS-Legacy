            ...
            new field_info {
              ...
              _compare_func = (o, c, m) => {
                if (o.Parameters.Count != c.Parameters.Count || o.IsReadOnly(_str_Parameters) != c.IsReadOnly(_str_Parameters) || o.IsInvisible(_str_Parameters) != c.IsInvisible(_str_Parameters) || o.IsRequired(_str_Parameters) != c._isRequired(o.m_isRequired, _str_Parameters)) {
                  m.Add(_str_Parameters, o.ObjectIdent + _str_Parameters, o.ObjectIdent2 + _str_Parameters, o.ObjectIdent3 + _str_Parameters, "Child", o.idfsSection == null ? "" : o.idfsSection.ToString(), o.IsReadOnly(_str_Parameters), o.IsInvisible(_str_Parameters), o.IsRequired(_str_Parameters)); 
                  }
                }
              }, 
    ...
    public void AddHiddenPersonalData(string name, Func<Section, bool> func)
    {
      ...
      if (!m_isHiddenPersonalData.ContainsKey(name))
                    ...
                    
        {
            ...
            public virtual Section SelectDetailT(DbManagerProxy manager, object ident, int? HACode = null)
            {
                if (ident == null)
                {
