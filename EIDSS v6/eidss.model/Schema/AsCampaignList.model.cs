      ...
      m_isHiddenPersonalData[name].Add(func);
            ...
            static Meta()
            {
                ...
                GridMeta.Add(new GridMetaItem(
                    _str_idfCampaign,
                    _str_idfCampaign, null, false, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCampaignID,
                ...
                GridMeta.Add(new GridMetaItem(
                    ...
                    _str_strCampaignType, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCampaignStatus,
                    _str_strCampaignStatus, null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datCampaignDateStart,
                    "datStartDate", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_datCampaignDateEnd,
                    "datFinishDate", null, true, true, true, true, null
                    ));
                GridMeta.Add(new GridMetaItem(
                    _str_strCampaignAdministrator,
                    "strASAdministrator", null, true, true, true, true, null
                    ));
