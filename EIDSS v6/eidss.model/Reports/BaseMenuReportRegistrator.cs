    ...
    public abstract class BaseMenuReportRegistrator
    {
        ...
        protected IMenuAction LabCategory
        {
            get
            {
                ...
                {
                    m_LabCategory = RegisterSubMenu(StandardReportsCategory, "MenuLaboratoryReports", EIDSSPermissionObject.Sample, 25000);
        ...
        protected IMenuAction AdminCategory
        {
            get
            {
                ...
                {
                    m_AdminCategory =
                        RegisterSubMenu(StandardReportsCategory, "MenuAdministrativeReports", EIDSSPermissionObject.Report, 30000);
