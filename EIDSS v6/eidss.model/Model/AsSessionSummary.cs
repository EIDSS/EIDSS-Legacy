        ...
        public static bool ValidateDateInRange(AsSessionSummary obj)
        {
            if (obj.datCollectionDate.HasValue)
            {
                if (((AsSession)obj.Parent).datStartDate.HasValue && obj.datCollectionDate < ((AsSession)obj.Parent).datStartDate)
                    throw new ValidationModelException("AsSession.SummaryItem.datCollectionDate_msgId", "datCollectionDate", "datCollectionDate", new object[] { obj.datCollectionDate, ((AsSession)obj.Parent).datStartDate, ((AsSession)obj.Parent).datEndDate }, typeof(PredicateValidator), false, obj);
