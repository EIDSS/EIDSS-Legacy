...
namespace bv.common.Resources.TranslationTool
{
    public class TranslationToolHelper
    {
        ...
        public static string TranslationsDirectoryName { get { return RootPath + "Translations\\Resources"; } }
        public static string ResourceUsageDirectoryName { get { return RootPath + "Translations\\ResourceUsage"; } }
        public static string ExclusionsDirectoryName { get { return RootPath + "Translations\\Exclusions"; } }
        ...
        /// <summary>
        /// Полный путь к корневой папке, где хранятся resx файлы
        /// </summary>
        public static string TranslationsDir { get; set; }
        ...
        public static string GetFullPathToResX(string resName, string cultureCode)
        {
            ...
            var files = Directory.GetFiles(TranslationsDir, resfilename, SearchOption.AllDirectories);
            if (files.Length > 0)
            {
        ...
        private static void ReadEnglishCaptions(string viewName, Dictionary<string, ResourceValue> dict, Dictionary<string, ResourceValue> defaultDict)
        {
            ...
            foreach (var resourceValue in dict)
            {
                ...
                {
                    resourceValue.Value.EnglishText = enDict[resourceValue.Key].Value.ToString();
                }
            }
