var flexForms = {
    ...
    AddParameterEditWindow: function () {
        var key = $("#FFKey").val();
        var ffpresenterId = $("#FFpresenterId").val();
        var url = bvUrls.getShowAddFFParameter() + "?key=" + key + "&ffpresenterId=" + ffpresenterId;
        bvPopup.showDefault(url, EIDSS.BvMessages['titleAddParameter'], 800, 700);
    },
