    ...
    return {
        ...
        onSearchPickerSelectSuccess: function (name) {
            ...
            if ($("input[type='hidden'][name='Address']").length > 0) {
                ...
                comboBoxFacade.reloadReferenceComboBoxWithoutClearValue("Address_" + id + "_*", 'Region');
                comboBoxFacade.reloadReferenceComboBoxWithoutClearValue("Address_" + id + "_*", 'Rayon');
                comboBoxFacade.reloadReferenceComboBoxWithoutClearValue("Address_" + id + "_*", 'Settlement');
            }
        },
