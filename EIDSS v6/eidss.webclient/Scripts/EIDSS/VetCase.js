var vetCase = {
    ...
    showVaccinationGridEditWindow: function(id, listKey, gridName) {
        ...
        bvGrid.showEditWindow(url, 730, 320, EIDSS.BvMessages['titleVaccination']);
    },

    showAnimalsGridEditWindow: function(id, listKey, gridName) {
        var url = bvUrls.getAnimalPickerUrl() + "?key=" + listKey + "&name=" + gridName + "&id=" + id;
        bvGrid.showEditWindow(url, 730, 320, EIDSS.BvMessages['titleAnimals']);
    },
    ...
    showAnimalsGridRowTestDetails: function (gridName) {
        ...
        bvGrid.showEditWindowAnyWidth(path, 380, 320, EIDSS.BvMessages['titleClinicalSigns']);
    },

    showSearchPicker: function(objectId, functionName, isMultiSelection, showInInternalWindow) {
        var pickerUrl = bvUrls.getVetCasePickerUrl() + "?objectId=" + objectId + "&functionName=" + functionName + "&isMultiSelection=" + isMultiSelection + "&showInInternalWindow=" + showInInternalWindow;
    ...
    showSpeciesGridEditWindow: function(id, listKey, gridName) {
        ...
        var idfCase = $("#idfCase").val();
        var path = bvUrls.getEditSpeciesDetailUrl() + "?listKey=" + idfCase + "&gridName=" + gridName
            + "&idfSpecies=" + id + "&idfHerdParty=" + idfHerdParty + "&idfCase=" + idfCase;
    ...
    showSpeciesClinicalInvestigation: function (gridName) {
        ...
        bvGrid.showEditWindow(path, 730, 460, EIDSS.BvMessages['titleClinicalInvestigation']);
    },
    ...
    showVetCaseLogGridEditWindow: function (id, listKey, gridName) {
        ...
        bvGrid.showEditWindow(path, 730, 280, EIDSS.BvMessages['titleVetCaseLog']);
    },

    saveAndCloseVetCaseLogGridEditWindow: function (gridName) {
        var ident = gridName.substring(0, gridName.lastIndexOf("_") + 1);
        var gridId = ident + 'VetCaseLog';
