var asCampaign = {
    ...
    RedirectToSession: function (id, listKey) {
        asCampaign.onShowReportClick(function () { asCampaign.RedirectToForm(bvUrls.getAsSessionDetailsUrl() + "?id=" + id + "&idfCampaign=" + listKey + "&fromCampaign=true"); });
    },
    ...
    showASCampaignSearchPicker: function (objectId, idfsASCampaignPropertyName, strASCampaignPropertyName, strASCampaignIdPropertyName, showInInternalWindow) {
        var pickerUrl = bvUrls.getASCampaignPickerUrl() + "?objectId=" + objectId + "&idfsASCampaignPropertyName=" + idfsASCampaignPropertyName +
            "&strASCampaignPropertyName=" + strASCampaignPropertyName + "&strASCampaignIdPropertyName=" + strASCampaignIdPropertyName +
