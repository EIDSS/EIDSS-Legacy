var outbreak = (function () {
    ...
    return {
        ...
        showSearchPicker: function (objectId, idfsOutbreakPropertyName, strOutbreakPropertyName, showInInternalWindow) {
            var pickerUrl = bvUrls.getOutbreakPickerUrl() + "?objectId=" + objectId + "&idfsOutbreakPropertyName=" + idfsOutbreakPropertyName +
                "&strOutbreakPropertyName=" + strOutbreakPropertyName + "&showInInternalWindow=" + showInInternalWindow;
        ...
        showHumanCaseSearchPicker: function (objectId, functionName, isMultiSelection, showInInternalWindow) {
            var pickerUrl = bvUrls.getHumanCasePickerForOutbreakUrl() + "?objectId=" + objectId + "&functionName=" + functionName + "&isMultiSelection=" + isMultiSelection + "&showInInternalWindow=" + showInInternalWindow;
        ...
        showVetCaseSearchPicker: function (objectId, functionName, isMultiSelection, showInInternalWindow) {
            var pickerUrl = bvUrls.getVetCasePickerForOutbreakUrl() + "?objectId=" + objectId + "&functionName=" + functionName + "&isMultiSelection=" + isMultiSelection + "&showInInternalWindow=" + showInInternalWindow;
        ...
        showVsSessionSearchPicker: function (objectId, functionName, isMultiSelection, showInInternalWindow) {
            var pickerUrl = bvUrls.getVsSessionPickerForOutbreakUrl() + "?objectId=" + objectId + "&functionName=" + functionName + "&isMultiSelection=" + isMultiSelection + "&showInInternalWindow=" + showInInternalWindow;
        ...
        showOutbreakNote: function (id, listKey, gridName) {
            ...
            bvGrid.showEditWindow(url, 730, 220, EIDSS.BvMessages['titleOutbreakNote']);
        },
