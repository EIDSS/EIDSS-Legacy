...
var bvPopup = {
    ...
    showDefaultAnyWidth: function (url, title, width, heigth) {
        bvCheckSession.check(function () {
            if (heigth < bvPopup.minHeight) {
                heigth = bvPopup.minHeight;
            }
    ...
    initAndShowModal: function (id, url, title, width, heigth) {
        bvCheckSession.check(function () {
            windowFacade.initAndShowModal(id, url, title, width, heigth);
        });
    },
...
var bvTranslation = (function () {
    function internalOpenTranslationWindow(iClassName) {
        ...
        windowFacade.initAndShowModal("TranslationWindow", url, "Translations", 1024, 580);
    }

    function openSplitWindow(id) {
        var lang = GetSiteLanguage();
        var url = "/" + lang + "/Account/ResourceUsage?id=" + id;
        windowFacade.initAndShowModal("SplitWindow", url, "Resource Usage", 1024, 580);
    }
