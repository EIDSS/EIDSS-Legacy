var bvGrid = (function () {
    ...
    return {
        ...
        fixDateTime: function (date, format) {
            if (date) {
                if (format == "{0:d}") {
                    return globalizationFacade.toFormatString(format, date);
                } else {
                    ...
                    return globalizationFacade.toFormatString(format, serverTime);
                }
            } else {
                date = "";
            }
        ...
        */
        ...
        showEditWindow: function (path, windowWidth, windowHeigth, title, formNumber) {
            ...
            bvPopup.showDefault(path, title, windowWidth, windowHeigth, false);
            if (formNumber) {
                windowFacade.addFormNumber(bvPopup.defaultName, formNumber);
            }
        },
        showEditWindowAnyWidth: function (path, windowWidth, windowHeigth, title) {
            bvPopup.showDefaultAnyWidth(path, title, windowWidth, windowHeigth, false);
        },
