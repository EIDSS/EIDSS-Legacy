var sample = {
    ...
    showCaseTestValidationGridEditWindow: function (id, listKey, gridName) {
        ...
        bvGrid.showEditWindow(path, 730, 320, EIDSS.BvMessages['titleResultSummary']);
    },
    ...
    showVetCaseSampleGridEditWindow: function (id, listKey, gridName) {
        ...
        bvGrid.showEditWindow(url, 730, 420, EIDSS.BvMessages['titleSampleDetails']);
    },
    ...
    showCaseTestGridEditWindow: function (id, listKey, gridName) {
        ...
        bvGrid.showEditWindow(path, 730, 460, EIDSS.BvMessages['titleTestResultDetails']);
    },
    ...
    showCaseTestGridRowTestDetails: function (gridName, root) {
        ...
        bvGrid.showEditWindow(url, 730, 460, EIDSS.BvMessages['titleTestDetails']);
    },
    ...
    showPensideTestGridEditWindow: function (id, listKey, gridName) {
        ...
        bvGrid.showEditWindow(path, 730, 280, EIDSS.BvMessages['titlePensideTest']);
    },
