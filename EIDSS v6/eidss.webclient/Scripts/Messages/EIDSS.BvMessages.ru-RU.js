var EIDSS = {
	BvMessages: {
		...
		'msgUnsavedRecordsPrompt': 'Некоторые измененные записи не сохранены. Сохранить изменения? Если вы этого не сделаете, все несохраненные изменения будут потеряны.',
		...
		'titleAccessionInComment': 'Комментарий по приёму пробы',
		'titleSampleDetails': 'Дополнительная информация о пробах',
		'titleSummaryInfo': 'Данные обобщенного отчета',
		'titleOutbreakNote': 'Примечание',
		...
		'titleVsSessionList': 'Сессии надзора за переносчиками заболеваний',
		'titlePensideTest': 'Полевой тест',
		'titleVetCaseLog': 'Необходимое действие',
		...
		'titleCreateAliquot': 'Создать аликвоты',
		'titleCreateDerivative': 'Создать дериваты',
		'menuTransferOutSample': 'Передать пробу в другую лабораторию',
		'titleTransferOutSample': 'Передача пробы во внешнюю организацию',
		...
		'titleAnimals': 'Животные',
		'titleCreateSample': 'Регистрация новой пробы',
		'titleGroupAccessionIn': 'Групповой прием проб',
		'tabTitleSampleTest': 'Проба / подробные сведения',
		'noEmployeeSelectedErrorMessage': 'Пожалуйста, выберите сотрудника',
		'Species': 'Вид',
		'titleClinicalInvestigation': 'Эпидемиологическое и клиническое исследование видов животных',
		'titleAddDisease': 'Добавить заболевание и вид животного',
		'titleListDetectedDiseases': 'Список из обнаруженных заболеваний',
		'titleDetectedDisease': 'titleDetectedDisease',
		'Active Surveillance Session': 'Сессия активного надзора',
		'titleAction': 'Действие',
		'titleHumanAggregateCasesList': 'Агрегированные данные по заболеваниям человека',
		'titleVetAggregateCasesList': 'Агрегированные данные по заболеваниям животных',
		'titleVetAggregateActionsList': 'Агрегированные данные по ветеринарным мероприятиям',
		'titleCopyVector': 'titleCopyVector',
		'msgTooBigRecordsCount': 'Количество возвращенных записей слишком велико. На форме отображены не все записи. Пожалуйста измените критерий поиска и повторите запрос.',
		'titleCopySample': 'Копировать ферму / животное / пробу',
		'titleAnimalSampleInfo': 'Информация о животном / пробе',
		'titleAnimalsSamplesInfo': 'Информация о животных / пробах',
		'titleDiagnosisHistory': 'История изменения диагноза',
		'strMap': 'Карта',
		'ErrAllMandatoryFieldsRequired': 'Вы должны ввести данные во все обязательные поля.',
		'msgTooManyDiagnosis': 'Вы выбрали слишком много диагнозов. В отчете будут выведены первые 0.'
