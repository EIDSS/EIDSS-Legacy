var EIDSS = {
	BvMessages: {
		...
		'msgUnsavedRecordsPrompt': 'لديك بعض سجلات غير محفوظة. هل تريد حفظ التغييرات قبل تطبيق بحث جديد (سيتم التراجع عن التغييرات التي لم تُحفَظ)؟',
		...
		'titleAccessionInComment': 'تعليق حول الإضافة',
		'titleSampleDetails': 'تفاصيل العينة',
		'titleSummaryInfo': 'معلومات تلخيصية',
		'titleOutbreakNote': 'ملاحظة',
		...
		'titleVsSessionList': 'قائمة جلسات مراقبة الناقل',
		'titlePensideTest': 'اختبار سريع',
		'titleVetCaseLog': 'الاجراء المطلوب',
		...
		'titleCreateAliquot': 'إنشاء جزء من كل',
		'titleCreateDerivative': 'إنشاء مشتقات',
		'menuTransferOutSample': 'نقل عينة للخارج',
		'titleTransferOutSample': 'النقل للخارج',
		...
		'titleAnimals': 'حيوانات',
		'titleCreateSample': 'تسجيل عينة جديدة',
		'titleGroupAccessionIn': 'إضافة مجموعة',
		'tabTitleSampleTest': 'تفاصيل الاختبار/العينة',
		'noEmployeeSelectedErrorMessage': 'يرجى تحديد موظف',
		'Species': 'نوع الحيوان',
		'titleClinicalInvestigation': 'التحقيق في الأنواع الوبائية والسريرية',
		'titleAddDisease': 'إضافة مرض ونوع',
		'titleListDetectedDiseases': 'لائحة بالأمراض المكتشفة',
		'titleDetectedDisease': 'titleDetectedDisease',
		'Active Surveillance Session': 'جلسة مراقبة نشطة',
		'titleAction': 'الإجراء',
		'titleHumanAggregateCasesList': 'قائمة مجموع الحالات البشرية',
		'titleVetAggregateCasesList': 'قائمة الحالات الإجمالية البيطرية',
		'titleVetAggregateActionsList': 'قائمة الإجراءات البيطرية الإجمالية',
		'titleCopyVector': 'titleCopyVector',
		'msgTooBigRecordsCount': 'عدد السجلات التي يتم إرجاعها كبير جدا. ولا تظهر كل السجلات على النموذج. يرجى تغيير معايير البحث والمحاولة مرة أخرى',
		'titleCopySample': 'نسخ مزرعة/حيوان/عينة',
		'titleAnimalSampleInfo': 'حيوان / معلومات العينة',
		'titleAnimalsSamplesInfo': 'حيوانات / معلومات العينات',
		'titleDiagnosisHistory': 'تاريخ التشخيص',
		'strMap': 'Map',
		'ErrAllMandatoryFieldsRequired': 'يجب عليك إدخال البيانات في كافة الحقول الإلزامية.'
	}
}
