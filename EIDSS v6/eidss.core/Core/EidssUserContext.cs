...
namespace eidss.model.Core
{
    ...
    public class EidssUserContext : ModelUserContext
    {
        ...
        private static readonly IsStartReplicationQuestionDelegate g_defaultIsStartReplicationQuestion = () => false;
        private static readonly StartReplicationDelegate g_defaultStartReplication = () => { };
            ...
            (IsStartReplicationQuestionDelegate isStartReplicationQuestion = null, StartReplicationDelegate startReplication = null)
        {
            Creator =
                () =>
                    new EidssUserContext(isStartReplicationQuestion ?? g_defaultIsStartReplicationQuestion,
                        startReplication ?? g_defaultStartReplication);
        }
