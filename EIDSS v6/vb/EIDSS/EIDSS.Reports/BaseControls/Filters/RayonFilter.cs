...
{
    public sealed partial class RayonFilter : BaseLookupFilter
    {
        ...
        protected override DataView CreateDataSource()
        {
            ...
            DataView rayons = ShowTransportCHE?LookupCache.Get(LookupTables.RayonForAggregate):LookupCache.Get(LookupTables.Rayon);
