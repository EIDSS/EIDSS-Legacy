...
namespace EIDSS.Reports.Parameterized.Human.GG.Report
{
    ...
    public sealed partial class RBEReport : BaseIntervalReport
    {
        ...
        public void SetParameters(DbManagerProxy manager, RBESurrogateModel model)
        {
            ...
            Action<SqlConnection> casesAction = (connection =>
            {
                m_CasesAdapter.Connection = connection;
                m_CasesAdapter.CommandTimeout = CommandTimeout;
                m_CasesAdapter.Transaction = (SqlTransaction) manager.Transaction;
            ...
            Action<SqlConnection> animalsAction = (connection =>
            {
                m_AnimalsAdapter.Connection = connection;
                m_AnimalsAdapter.CommandTimeout = CommandTimeout;
                m_AnimalsAdapter.Transaction = (SqlTransaction) manager.Transaction;
            ...
            CasesDetailReport.DataAdapter = null;
            AnimalsDetailReport.DataAdapter = null;
            DataAdapter = null;
