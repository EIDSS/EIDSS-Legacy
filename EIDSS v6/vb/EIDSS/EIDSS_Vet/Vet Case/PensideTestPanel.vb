...
Public Class PensideTestPanel
    ...
    Private Function GetErrorText(rowHandle As Integer) As String
        ...
        If row("idfsPensideTestName") Is DBNull.Value Then
            ...
            Return String.Format(BvMessages.Get("ErrMandatoryFieldRequired", "The field {0} is mandatory. You must enter data to this field before form saving"), TestGridView.Columns("idfsPensideTestName").Caption)
        End If
        If row("idfMaterial") Is DBNull.Value Then
            TestGridView.FocusedColumn = TestGridView.Columns("idfMaterial")
            Return String.Format(BvMessages.Get("ErrMandatoryFieldRequired", "The field {0} is mandatory. You must enter data to this field before form saving"), TestGridView.Columns("idfMaterial").Caption)
        End If
        Return String.Empty
    End Function
