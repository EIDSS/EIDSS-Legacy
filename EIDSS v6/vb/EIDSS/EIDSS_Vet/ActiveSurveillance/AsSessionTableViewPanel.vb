...
Namespace ActiveSurveillance
    ...
    Public Class AsSessionTableViewPanel
        ...
        Protected Overrides Sub DefineBinding()
            ...
            'eventManager.AttachDataHandler(AsSessionTableVew_DB.TableFarmTableView + ".idfsSampleType", AddressOf UpdateTotals)
            ...
            cbFilteredSampleTypeEditor = CType(cbSampleType.Clone(), DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit)
            SetFarmPermissions()
        End Sub
        ...
        Private Sub UpdateTotals()
            ...
            txtAnimalsQtyTotal.EditValue = baseDataSet.Tables(AsSessionTableVew_DB.TableAnimals).Select("", Nothing, DataViewRowState.CurrentRows).Length '.Compute("count(idfAnimal)", Nothing)
        End Sub
        ...
        Private Sub txtFarmCode_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles txtFarmID.ButtonClick
            ...
            If e.Button.Kind = DevExpress.XtraEditors.Controls.ButtonPredefines.Ellipsis Then
                ...
                If BaseFormManager.ShowModal(farmDetail, FindForm(), id, Nothing, AsSession.CreateStartupParameters) Then
...
SelectFarm:
        ...
        Private Sub TableViewView_ShowingEditor(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TableView.ShowingEditor
            ...
            If (Not row Is Nothing AndAlso True.Equals(row("Used"))) AndAlso _
                (TableView.FocusedColumn Is colFarmID OrElse TableView.FocusedColumn Is colSpecies OrElse TableView.FocusedColumn Is colAnimalID OrElse TableView.FocusedColumn Is colCollectionDate OrElse TableView.FocusedColumn Is colFieldSampleID OrElse TableView.FocusedColumn Is colSampleType OrElse TableView.FocusedColumn Is colSentToOffice) Then
                e.Cancel = True
            End If
        ...
        Private Function IsRowValid(row As DataRow, ByRef errMsg As String) As Boolean
            ...
            Else
                ...
                If (EidssSiteContext.Instance.CustomMandatoryFields.Contains(CustomMandatoryField.AsSessionSample_SentTo) AndAlso _
                    ...
                    errMsg = String.Format(EidssMessages.Get("ErrMandatoryFieldRequired"), colSentToOffice.Caption)
                    Return False
                End If
            End If
            Return True
        ...
        Private Sub TableView_CustomRowCellEditForEditing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.CustomRowCellEditEventArgs) Handles TableView.CustomRowCellEditForEditing
            ...
            If cbFilteredSampleTypeEditor Is Nothing OrElse m_FilteredSamplesDataset Is Nothing OrElse FilterSamplesBydiagnosis = False Then Exit Sub
