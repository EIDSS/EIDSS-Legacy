...
#Region " Windows Form Designer generated code "
    Public Sub New()
        ...
        AuditObject = New AuditObject(EIDSSAuditObject.daoFarm, AuditTable.tlbParty)
...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        ...
        If EidssSiteContext.Instance.CustomizationPackageID = CLng(CustomizationPackage.Georgia) Then
