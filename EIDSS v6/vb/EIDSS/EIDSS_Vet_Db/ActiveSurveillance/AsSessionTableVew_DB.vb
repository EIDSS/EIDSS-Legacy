...
Public Class AsSessionTableVew_DB
    ...
    Public Overrides Function PostDetail(ByVal ds As System.Data.DataSet, ByVal postType As Integer, Optional ByVal transaction As System.Data.IDbTransaction = Nothing) As Boolean
        ...
        Try
            ...
            Dim animalRows As DataRow() = ds.Tables(AsSessionTableVew_DB.TableAnimals).Select()
            For Each animalRow As DataRow In animalRows
                ...
                End If
            Next
            animalRows = ds.Tables(AsSessionTableVew_DB.TableAnimals).Select("", Nothing, DataViewRowState.Deleted)
            For Each animalRow As DataRow In animalRows
