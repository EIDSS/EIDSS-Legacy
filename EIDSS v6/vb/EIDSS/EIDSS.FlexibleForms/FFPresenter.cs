...
namespace EIDSS.FlexibleForms
{
    ...
    public partial class FFPresenter : BaseDetailPanel
    {
        ...
        public void ShowFlexibleForm(long idfsFormTemplate, List<long> observations, FFType aformType, long? idfVersion, bool runImmediatly, bool bufferingUserData, bool isSummary, bool isGroupEditing)
        {
