...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Core.LookupBinder.BindBaseLookup(cbSpeciesType, baseDataSet, "SpeciesType.idfsSpeciesType", db.BaseReferenceType.rftSpeciesList, HACode.Livestock, AddressOf Core.LookupBinder.AddSpecies)
