...
Public Class BatchDetail
    ...
    Protected Overrides Sub DefineBinding()
        ...
        Core.LookupBinder.BindBaseLookup(cbTestType, baseDataSet, Batches_DB.TableBatchDetail + ".idfsTestName", bv.common.db.BaseReferenceType.rftTestName)
        ...
        Core.LookupBinder.BindBaseRepositoryLookup(cbTestCategory, bv.common.db.BaseReferenceType.rftTestCategory, False)
    ...
    Private Sub btAddTests_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btAddTests.Click
        ...
        Dim SelectTestsForBatchForm As IBaseListPanel = GetTestsForm(BatchID, Me.cbTestType.EditValue)
    ...
    Function GetTestsForm(ByVal BatchID As Long, ByVal testNameId As Object) As IBaseListPanel
        ...
        '            String.Format(" idfsTestName={0} " + _
...
#End Region
    ...
    Private Sub ShowBatchFF()
        ...
        If Not (Me.cbTestResult.DataSource Is Nothing) Then
            ...
            CType(Me.cbTestResult.DataSource, DataView).RowFilter = String.Format("idfsTestName = {0} and intRowStatus = 0", type)
        End If
    End Sub
    ...
    Private Sub SearchByBarcode(ByVal barcode As String)
        ...
        If ds.Tables(Batches_DB.TestsList).Rows.Count > 0 Then
            ...
            If CLng(sourceRow("idfTesting")) = -1 Then
                ...
                testRow("idfMaterial") = sourceRow("idfMaterial")
                testRow("idfsTestName") = sourceRow("idfsTestName")
                testRow("idfsTestCategory") = DBNull.Value
    ...
    Private Sub GridView1_ShowingEditor(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TestsView.ShowingEditor
        ...
        If (Utils.IsEmpty(row("idfMaterial")) OrElse CLng(row("idfMaterial")) <= 0) Then
            ...
            If (TestsView.FocusedColumn Is colDiagnosis AndAlso Utils.IsEmpty(row("idfsDiagnosis"))) Then
                Return
            End If
            If (TestsView.FocusedColumn Is colCategory AndAlso Utils.IsEmpty(row("idfsTestCategory"))) Then
                Return
            End If
