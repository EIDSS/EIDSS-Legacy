...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtNote.UseOptimizedRendering = True
        '
        'Label1
        '
        ...
        Me.dtDateTestStarted.CalendarTimeProperties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {New DevExpress.XtraEditors.Controls.EditorButton(CType(resources.GetObject("RepositoryItemDateEdit1.CalendarTimeProperties.Buttons"), DevExpress.XtraEditors.Controls.ButtonPredefines))})
...
#End Region
    ...
    Protected Overrides Sub DefineBinding()
        Try
            ...
            LookupBinder.BindDepartmentLookup(cbDepartment, baseDataSet, Sample_DB.TableSample + ".idfInDepartment")
            ...
            cbCaseCurrentDiagnosis.DataSource = baseDataSet.Tables(Sample_DB.TableDiagnosis)
            ...
            LookupBinder.BindPersonLookup(cbCollectedByPerson, baseDataSet, Sample_DB.TableSample + ".idfFieldCollectedByPerson")
            ...
            End If
            'm_CanDeleteTest = m_CanDeleteTest AndAlso Not (CLng(SampleStatus.Destroyed).Equals(status) OrElse CLng(ContainerStatus.Destroy).Equals(status))
    ...
    Private Sub TestGridView_ShowingEditor(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles TestGridView.ShowingEditor
        ...
        Select Case status
            Case TestStatus.NotStarted
                If TestGridView.FocusedColumn Is colTestName OrElse TestGridView.FocusedColumn Is colCategory OrElse TestGridView.FocusedColumn Is colDiagnosis Then
                    e.Cancel = Not isNewRow
                ElseIf Not TestGridView.FocusedColumn Is colStatus Then
                    e.Cancel = True
                End If
            Case TestStatus.InProcess
            ...
            Case TestStatus.Preliminary
                e.Cancel = Not (TestGridView.FocusedColumn Is colStatus _
                    ...
                    OrElse TestGridView.FocusedColumn Is colDateTestStarted _
                    OrElse TestGridView.FocusedColumn Is colTestedBy _
                    OrElse TestGridView.FocusedColumn Is colComments _
            ...
            Case TestStatus.Finalized
                If True.Equals(row("blnExternalTest")) Then
                    e.Cancel = Not isNewRow OrElse (TestGridView.FocusedColumn Is colStatus _
                        ...
                        OrElse TestGridView.FocusedColumn Is colResultEnteredBy)
                Else
                    e.Cancel = Not (TestGridView.FocusedColumn Is colComments _
                        OrElse TestGridView.FocusedColumn Is colResultEnteredBy)
