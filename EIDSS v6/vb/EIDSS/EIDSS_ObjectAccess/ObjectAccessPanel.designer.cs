...
namespace EIDSS
{
    public partial  class ObjectAccessPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkboxImageList = new System.Windows.Forms.ImageList();
            this.lblSite = new System.Windows.Forms.Label();
            this.cbSite = new DevExpress.XtraEditors.LookUpEdit();
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(((DevExpress.XtraEditors.Controls.ButtonPredefines)(resources.GetObject("cbSite.Properties.Buttons"))))});
            this.cbSite.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo(resources.GetString("cbSite.Properties.Columns"), resources.GetString("cbSite.Properties.Columns1"))});
            this.cbSite.Properties.DisplayMember = "strSiteID";
            this.cbSite.Properties.NullText = resources.GetString("cbSite.Properties.NullText");
            this.cbSite.Properties.ShowHeader = false;
            this.cbSite.Properties.ValueMember = "idfsSite";
            this.cbSite.Tag = "{alwayseditable}";
            this.cbSite.EditValueChanged += new System.EventHandler(this.cbSite_EditValueChanged);
            // 
            // gridActors
            // 
