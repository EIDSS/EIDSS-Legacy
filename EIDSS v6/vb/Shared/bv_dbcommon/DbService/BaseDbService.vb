...
#Region "Shared methods"
  ...
  ''' -----------------------------------------------------------------------------
    ...
    Public Shared Sub CorrectModificationDateForArchive(DataTable As DataTable)
...
#Region "Overridable methods"
    ...
    ''' </history>
    ''' -----------------------------------------------------------------------------
    Public Function Delete(ByVal ID As Object, Optional ByVal alterObjectName As String = Nothing) As Boolean
        ...
        SyncLock Connection
            Try
                ...
                If Delete(ID, transaction, alterObjectName) Then
...
#End If
    ...
    End Function
    Public Sub AddEvent(ByVal eventType As [Enum], Optional ByVal ID As Object = Nothing, Optional startReplication As Boolean = True)
        If m_EventTypesToRaise Is Nothing Then
            m_EventTypesToRaise = New List(Of EventInfo)
        End If
        If m_EventTypesToRaise.Find(Function(c) c.Type.Equals(eventType) AndAlso ((c.ID Is Nothing AndAlso ID Is Nothing) Or c.ID.Equals(ID))) Is Nothing Then
            m_EventTypesToRaise.Add(New EventInfo(eventType, ID, 0, startReplication))
        End If
    End Sub
