...
public class ASSessionListActivity extends EidssBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("");
        getSupportActionBar().setIcon(R.drawable.eidss_ic_search_as_big);
    ...
    private Fragment StartFragment()
    {
        ...
        if (fragment == null) {
            fragment = ASSessionListFragment.newInstance();
    ...
    protected void SetToolbarSpinner() {
        ...
        spinnerCaseStatusFilter.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
                ASSessionListFragment fragment = (ASSessionListFragment)StartFragment();
    ...
    public void onDone(int idDialog, boolean isPositive) {
        switch (idDialog) {
            case DELETE_DIALOG_ID:
                if (isPositive) {
                    ((ASSessionListFragment)fragment).DeleteCases();
                }
                break;
        }
    }
