...
public class HumanCaseSamplesListAdapter extends ArrayAdapter<HumanCaseSample> {
    private final FragmentActivity context;
    private final HumanCase mCase;
    private Menu menu;
    private HumanCaseSamplesFragment fragment;

    public HumanCaseSamplesListAdapter(HumanCaseSamplesFragment fragment, HumanCase cs)
    {
    ...
    @Override
    public HumanCaseSample getItem(int position) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        final HumanCaseSample item = mCase.samples.get(position);
        ...
        if (convertView == null){
            ...
            View.OnClickListener cl = new View.OnClickListener() {
                public void onClick(View v) {
                    Intent intent = new Intent(context, HumanCaseSampleActivity.class);
                    Resources res = fragment.getResources();
                    HumanCaseSample it = getItem(position);
            ...
            View.OnClickListener unSelectListener = new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    for (HumanCaseSample s:mCase.samples) {
                        s.setChecked(false);
                    }
                    updateMenuVisibility();
