...
public class CampaignsProvider extends ContentProvider{

    static final String PROVIDER_NAME = "com.bv.eidss.campaignsprovider";
    ...
    static{
        ...
        public Cursor query(Uri uri, String[] projection, String selection,
            ...
            switch (uriMatcher.match(uri)) {
                case CAMPAIGNS:
                    return db.rawQuery(EidssDatabase.select_sql_campaigns, selectionArgs);
                case CAMPAIGN_ID:
                    return db.rawQuery(EidssDatabase.select_sql_campaign, selectionArgs);
                default:
