...
public class LoadListsActivity extends EidssBaseBlockTimeoutActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.TitleLoadLists);
    ...
    private Fragment StartFragment()
    {
        ...
        if (fragment == null) {
            fragment = new LoadListsFragment();
            fm.beginTransaction()
        ...
        switch (idDialog) {
            ...
            case AppVersionTask.ASKFORDOWNLOAD_DIALOG_ID:
                if(isPositive)
                {
                    ...
                    LoadListsFragment fragment = (LoadListsFragment)StartFragment();
                    fragment.StartLoadLists();
                }
                break;
