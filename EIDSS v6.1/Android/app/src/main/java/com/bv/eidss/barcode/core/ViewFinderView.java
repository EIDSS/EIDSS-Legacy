package com.bv.eidss.barcode.core;
...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(R.integer.ViewFinderBorderWidth);
    private final int mDefaultBorderLineLength = getResources().getInteger(R.integer.ViewFinderBorderLength);
