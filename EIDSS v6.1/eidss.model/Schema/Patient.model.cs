...
namespace eidss.model.Schema
{
    ...
    public abstract partial class Patient : 
        ...
        private static string[] readonly_names6 = "datEnteredDate,datModificationDate,strEnteredDate,strModificationDate".Split(new char[] { ',' });
        ...
        private bool _isReadOnly(string name)
        {
            ...
            if (readonly_names4.Where(c => c == name).Count() > 0)
                return ReadOnly || new Func<Patient, bool>(c => c.bPINMode || c.IsReadOnlyParent || c.datDateofBirth != null)(this);
