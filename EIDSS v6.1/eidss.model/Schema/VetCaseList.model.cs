                    ...
                    
        {
          ...
          ");
                ...
                if (filters.Contains("idfsDiagnosis"))
                {
                    ...
                    {
                        sql.AppendFormat("idfsTentativeDiagnosis = @idfsDiagnosis OR idfsTentativeDiagnosis1 = @idfsDiagnosis OR idfsTentativeDiagnosis2 = @idfsDiagnosis", filters.Operation("idfsDiagnosis"));
                    }
                    else
                    {
                        for (int i = 0; i < filters.Count("idfsDiagnosis"); i++)
                        {
                            ...
                            sql.AppendFormat("idfsTentativeDiagnosis = @idfsDiagnosis_{1} OR idfsTentativeDiagnosis1 = @idfsDiagnosis OR idfsTentativeDiagnosis2 = @idfsDiagnosis", filters.Operation("idfsDiagnosis", i), i);
                        }
                    }
